---
title: cancel-a-scheduled-recurring-batch-キャンペーン — 実行
description: 定期バッチキャンペーンの実行の取消
...
これ以上必要のない定期バッチキャンペーンがある場合は、今後の実行をキャンセルできます。
