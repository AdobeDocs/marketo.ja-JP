...
1月のリリースでは、 **参照オファーを含むソーシャルオファーが拡張されます**。 さらに、マーケティング担当者のリード管理ユーザーは、タイムゾーン、言語およびロケールの環境設定を設定できます。 *の付いた機能は、Select Editionでのみ利用できます。
...
## タイムゾーンの設定 {#time-zone-preference}
...
## マーケティング担当者のリード管理言語の選択 {#select-your-marketo-lead-management-language}
...
## Sales Insight言語の選択（Salesforceのみ） {#select-your-sales-insight-language-salesforce-only}
