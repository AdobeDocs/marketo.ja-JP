...
* **[スマートキャンペーンアセット API](https://experienceleague.adobe.com/jp/docs/marketo-developer/marketo/rest/assets/smart-campaigns)**：更新された日付と ID によってスマートキャンペーンレコードを取得して、Marketo 外で分析をエンリッチメントします。
