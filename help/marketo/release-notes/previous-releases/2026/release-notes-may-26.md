...
<table style="table-layout:auto">
 ...
 <tr>
  ...
  <tr>
   ...
   <td>オープンベータ</td>
   <td><a href="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/marketo-ai/overview" target="_blank">Marketo AIの概要</a></td>
  </tr>
  <tr>
   <td> </td>
   <td> </td>
  ...
  <tr>
   ...
   <td>リリース</td>
   <td><a href="/help/marketo/product-docs/administration/field-management/picklist-management.md" target="_blank">選択リストの管理</a></td>
  </tr>
  <tr>
   <td> </td>
   <td> </td>
  ...
  <tr>
   <td><strong>Dynamic Chat - チャットの欠落ステータス </strong>：担当者がチャットを受け入れない場合、チャットを行った人物の人物レコードのアクティビティの詳細に、新しい「チャットの欠落」ステータスが表示されます。
   </td>
   <td>リリース</td>
   <td>該当なし</td>
  </tr>
