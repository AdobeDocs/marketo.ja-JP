...
* **Dynamic Chatの推測属性**：推測済みIP データ（市区町村、州、国など）を確実に取得します。 Dynamic Chatによって取得された新しい人物の個人レコードに書き込まれます。
...
* **_製品リリースウェビナー_**: [2023年3月および5月Marketo Engage リリースウェビナー](https://engage.marketo.com/2023_March_May_Release_Webinar_OnDemandPage.html){target="_blank"}
