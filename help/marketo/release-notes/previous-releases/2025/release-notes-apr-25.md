---
description: リリースノート - 2025年4月 – Marketo ドキュメント – 製品ドキュメント
...
<table style="table-layout:auto">
 <tbody>
  ...
  <tr>
   ...
   <td>リリース</td>
   <td><a href="/help/marketo/product-docs/demand-generation/landing-pages/personalizing-landing-pages/add-ssl-to-your-landing-pages.md">ランディングページへのSSLの追加</a></td>
  </tr>
 </tbody>
</table>
<br/>
