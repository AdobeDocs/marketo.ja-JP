---
description: リリースノート - 2025年9月 – Marketo Docs – 製品ドキュメント
...
<table style="table-layout:auto">
 ...
 <tr>
  ...
  <tr>
   ...
   <td>リリース</td>
   <td><a href="/help/marketo/product-docs/email-marketing/email-designer/generate-content.md#set-up-permissions">権限の設定</a></td>
  </tr>
  <tr>
   <td> </td>
   <td> </td>
...
* **従来のリード アクティビティ データ ストリームの非推奨化**:2026年6月末までに、ユーザーは従来のリード アクティビティ データ ストリームから新しいAdobe I/O リード アクティビティ データ ストリーム（LADS）に移行する必要があります。 この非推奨化は、Adobe I/O Eventsと統合される前にリードアクティビティデータストリームにオンボーディングされた一部のユーザーにのみ影響します。 新しいデータストリームユーザーであるか、I/O イベントを介してリードアクティビティデータストリームを既に管理している場合、これは影響を与えません。 移行の詳細については、[この記事](https://developer.adobe.com/events/docs/guides/using/marketo/marketo-lead-activity-data-stream-migration){target="_blank"}を参照してください。
