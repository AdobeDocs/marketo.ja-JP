---
description: リリースノート - 2025年7月 – Marketo ドキュメント – 製品ドキュメント
...
<table style="table-layout:auto">
 ...
 <tr>
  ...
  <tr>
   <td><strong> メール Designer - SpamAssassinでスパムを検出</strong>: Marketo EngageでSpamAssassinを使用すると、メールの内容をテストし、ISP/メールプロバイダーがスパムとしてマークする可能性を確認できます。</td>
   <td>リリース</td>
