...
## フィールドマッピングの読み込み {#import-field-mapping}
...
## ランディングページ目盛線 {#landing-page-gridlines}
...
5月のリリースで、待機フロー手順に高度なオプションを追加しました。 これらの変更により、稼働日、日付および時刻を指定できます。 このリリースでは、待機手順でトークンを使用する機能が追加されました。 例えば、誕生日に電子メールを送信す `{{lead.Birthday}}` る場合や、を使用して最終的なウェビナーリマインダー `{{my.Event Date}}` を送信する場合があります。

![](assets/image2014-9-23-10-3a25-3a57.png)

## Design Studioでのサムネールとしての表示 {#view-as-thumbnails-in-design-studio}
...
## Marketing Revenue Cycle Analyticsの機能強化 {#marketo-revenue-cycle-analytics-enhancements}
