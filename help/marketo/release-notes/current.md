...
<table style="table-layout:auto">
 ...
 <tr>
  ...
  <tr>
   ...
   <td>リリース</td>
   <td><a href="https://experienceleague.adobe.com/ja/docs/marketo/using/product-docs/core-marketo-concepts/miscellaneous/understanding-folders#disable-smart-campaigns-archive" target="_blank">アーカイブでのキャンペーンの無効化</a></td>
  </tr>
    <tr>
   <td> </td>
   <td> </td>
