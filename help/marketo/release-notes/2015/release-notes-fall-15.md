...
スマートリスト上に複数の購読を作成できます。 1購読あたり100,000のリードを持つ購読は、Marketoインスタンスあたり、ワークスペース間で100,000のリードまでに制限されます。
...
* 販売員は、開封済みやクリック済みの電子メール、オンラインや個人参加イベント、訪問済みのWebページ、ダウンロード済みのeBookなど、チャネル間で見込み客がどのようなコンテンツに関与しているかをリアルタイムで確認できます。
* Googleメールを通じて送信された電子メールはMarketorにログインされ、リアルタイムで追跡されます。 これにより、販売員は見込み客が電子メールを見ているときを確認でき、適切なタイミングでフォローアップを行うことができます。 また、Marketo Sales Insight for Google Mailを使用すると、販売員は、美しい招待やオファーなどのタイプのコンテンツを送信するために、マーケティングによって作成されたテンプレートを活用しやすくなります。
