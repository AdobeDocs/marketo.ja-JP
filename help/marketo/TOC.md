...
+ Marketo の概要{#getting-started-with-marketo}
   ...
   + [Adobe Marketo は、どのような機能を持っていますか。](getting-started/what-is-adobe-marketo-engage.md)
   ...
   + クイックウィン {#quick-wins}
      + [人物の設定と追加を取得します。](getting-started/quick-wins/get-set-up-and-add-a-person.md)
...
+ 製品ドキュメント {#product-docs}
   ...
   + 管理 {#administration}
      + セットアップ {#setup}
         ...
         + [グローバルフォームの検証ルール](product-docs/administration/setup-administration/global-form-validation-rule.md)
      ...
      + Marketo Adobe Id を使用した操作 {#marketo-with-adobe-identity}
   ...
   + Marketo の中心概念 {#core-marketo-concepts}
      + スマートキャンペーン {#smart-campaigns}
         ...
         + フローアクション {#flow-actions}
            ...
            + [個人詳細ページからの1つのフローアクション](product-docs/core-marketo-concepts/smart-campaigns/flow-actions/single-flow-actions-from-person-detail-page.md)
      ...
      + スマートリストと静的リスト{#smart-lists-and-static-lists}
         ...
         + 静的リスト {#static-lists}
            ...
            + [Adobe エクスペリエンスプラットフォームセグメントを Marketo スタティックリストにプッシュする](product-docs/core-marketo-concepts/smart-lists-and-static-lists/static-lists/push-an-adobe-experience-platform-segment-to-a-marketo-static-list.md)
      ...
      + モバイルアプリ {#mobile-apps}
         + イベントチェックイン {#event-check-in}
            ...
            + [IPad または Android タブレットの設定](product-docs/core-marketo-concepts/mobile-apps/event-check-in/set-up-the-ipad-or-android-tablet.md)
      ...
      + その他 {#miscellaneous}
         ...
         + [Adobe エクスペリエンスクラウドの共有を設定します。](product-docs/core-marketo-concepts/miscellaneous/set-up-adobe-experience-cloud-audience-sharing.md)
      ...
      + Microsoft Dynamics 同期 {#microsoft-dynamics}
         ...
         + 同期の設定 {#sync-setup}
            ...
            + Microsoft Dynamics 2011 オンプレミス {#microsoft-dynamics-2011-on-premises}
               ...
               + [手順 2/3: Dynamics の Marketo Sync ユーザーの設定 (2011 On-On-premises)](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2011-on-premises/step-2-of-3-set-up.md)
            ...
            + Microsoft Dynamics 2015 オンプレミス／2016 Dynamics 365 オンプレミス {#microsoft-dynamics-2015-on-premises-2016-dynamics-365-on-premises}
               ...
               + [手順 2/2: Dynamics 2015 での Marketo Sync ユーザーの設定 On On-premises/2016 Dynamics 365 オンプレミス](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2015-on-premises-2016-dynamics-365-on-premises/step-2-of-3-set-up.md)
            ...
            + Microsoft Dynamics 365 {#microsoft-dynamics-365}
               ...
               + [手順 2 / 3：Dynamics での Marketo 同期ユーザーのセットアップ](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-365/step-2-of-3-set-up.md)
               + [手順 3 / 3：Microsoft Dynamics と Marketo（オンライン）の接続](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-365/step-3-of-3-connect.md)
            + Dynamics 向け OAuth 認証の設定 {#set-up-oauth-authentication-for-dynamics}
               ...
               + [オンライン用 Microsoft Dynamics CRM アプリの設定](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/set-up-oauth-authentication-for-dynamics/set-up-microsoft-dynamics-crm-app-for-online.md)
               + [オンプレミス用 Microsoft Dynamics CRM アプリの設定](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/set-up-oauth-authentication-for-dynamics/set-up-microsoft-dynamics-crm-app-for-on-prem.md)
         ...
         + Microsoft Dynamics 同期の詳細 {#microsoft-dynamics-sync-details}
            ...
            + [Microsoft Dynamics 同期：カスタムエンティティの同期](product-docs/crm-sync/microsoft-dynamics-sync/microsoft-dynamics-sync-details/microsoft-dynamics-sync-custom-entity-sync.md)
   ...
   + 需要創出 {#demand-generation}
      ...
      + ダイナミックチャット {#dynamic-chat}
         ...
         + [ダイナミックチャットを Marketo に接続します。](product-docs/demand-generation/dynamic-chat/connect-dynamic-chat-to-marketo.md)
         ...
         + [「?」](product-docs/demand-generation/dynamic-chat/dialogues.md)
      ...
      + Facebook {#facebook}
         ...
         + [Facebook 潜在顧客広告の設定](product-docs/demand-generation/facebook/set-up-facebook-lead-ads.md)
         ...
         + [Facebook オフライン変換の設定](product-docs/demand-generation/facebook/set-up-facebook-offline-conversions.md)
      ...
      + ランディングページ {#landing-pages}
         ...
         + ランディングページテンプレート {#landing-page-templates}
            ...
            + ガイド付きランディングページテンプレート {#guided-landing-page-templates}
               ...
               + [テンプレート 1 3D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-13d.md)
               + [テンプレート 13 e](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-13e.md)
               ...
               + [テンプレート 15 e](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-15e.md)
               ...
               + [テンプレート17A-4](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-17a.md)
               ...
               + [テンプレート 19 a](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-19a.md)
               + [テンプレート 19 b](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-19b.md)
               ...
               + [テンプレート 19 d](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-19d.md)
               + [テンプレート 19 e](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-19e.md)
      ...
      + ソーシャル {#social}
         + ソーシャルアクションの設定{#configuring-social-actions}
            ...
            + [電子広告キャンペーンの収益属性の設定](product-docs/demand-generation/social/configuring-social-actions/set-up-revenue-attribution-for-digital-advertising-campaigns.md)
         ...
         + ソーシャル機能 {#social-functions}
            ...
            + [LinkedIn リードジェネレーションフォームを設定します。](product-docs/demand-generation/social/social-functions/set-up-linkedin-lead-gen-forms.md)
   ...
   + Marketo セールスの連携 {#marketo-sales-connect}
      ...
      + Marketo {#marketo}
         ...
         + [セールスコネクトのおもしろい瞬間](product-docs/marketo-sales-connect/marketo/interesting-moments-in-sales-connect.md)
         ...
         + [営業活動のトリガーとフィルター](product-docs/marketo-sales-connect/marketo/sales-activity-triggers-and-filters.md)
      + リード {#people}
      ...
      + Microsoft Dynamics 用 MSI {#msi-for-microsoft-dynamics}
         + 機能 {#features}
            ...
            + Marketo タブ{#marketo-tab}
               ...
               + [電子メール活動](product-docs/marketo-sales-insight/msi-for-microsoft-dynamics/features/marketo-tab/email-activities.md)
   ...
   + モバイルマーケティング {#mobile-marketing}
      ...
      + アプリ内メッセージ {#in-app-messages}
         ...
         + アプリ内メッセージの作成 {#creating-in-app-messages}
            ...
            + [「閉じる」ボタンを設定し、メッセージを承認します](product-docs/mobile-marketing/in-app-messages/creating-in-app-messages/set-up-the-dismiss-button-and-approve-the-message.md)
   ...
   + 予測コンテンツ {#predictive-content}
      ...
      + はじめに {#getting-started}
         ...
         + [カテゴリを設定します。](product-docs/predictive-content/getting-started/set-up-categories.md)
...
+ リリースノート {#release-notes}
   ...
   + 以前のリリース {#previous-releases}
      + 2021年 {#2021}
         ...
         + [リリースノート: 8 月21日](release-notes/previous-releases/2021/release-notes-aug-21.md)
      + 2020年 {#2020}
