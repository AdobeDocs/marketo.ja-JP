...
+ Marketoの概要{#getting-started-with-marketo}
   ...
   + クイック勝ち{#quick-wins}
      ...
      + [ランディングページへのリダイレクト](getting-started/quick-wins/redirect-a-landing-page.md)
...
+ 製品文書 {#product-docs}
   + ターゲットアカウント管理 {#target-account-management}
      ...
      + ターゲット {#target}
         + 特定顧客 {#named-accounts}
            ...
            + [重点顧客にユーザーを追加](product-docs/target-account-management/target/named-accounts/add-people-to-a-named-account.md)
            + [アカウントの検出](product-docs/target-account-management/target/named-accounts/discover-accounts.md)
            + [リードとアカウントのマッチング](product-docs/target-account-management/target/named-accounts/lead-to-account-matching.md)
            + [名前付きアカウントでのフィルタリング](product-docs/target-account-management/target/named-accounts/filtering-in-named-accounts.md)
            + [特定顧客の削除](product-docs/target-account-management/target/named-accounts/delete-a-named-account.md)
   ...
   + 管理 {#administration}
      ...
      + ユーザーとロール{#users-and-roles}
         ...
         + [ユーザーと役割のリストの書き出し](product-docs/administration/users-and-roles/export-a-list-of-users-and-roles.md)
      ...
      + Workspaces とユーザーパーティション {#workspaces-and-person-partitions}
         + [Workspaces とユーザーパーティションについて](product-docs/administration/workspaces-and-person-partitions/understanding-workspaces-and-person-partitions.md)
   ...
   + Marketoの中心概念{#core-marketo-concepts}
      + スマート キャンペーン {#smart-campaigns}
         ...
         + スマートキャンペーンデータ{#smart-campaign-data}
            ...
            + [スマートキャンペーンメンバーシップの表示](product-docs/core-marketo-concepts/smart-campaigns/smart-campaign-data/view-smart-campaign-members.md)
      ...
      + その他{#miscellaneous}
         ...
         + [新規 Campaign フォルダーの作成](product-docs/core-marketo-concepts/miscellaneous/create-new-campaign-folder.md)
   ...
   + 需要生成{#demand-generation}
      ...
      + フォーム {#forms}
         ...
         + フォーム アクション {#form-actions}
            ...
            + [無効にするソーシャルフォームの入力](product-docs/demand-generation/forms/form-actions/disable-social-form-fill.md)
      ...
      + ランディングページ {#landing-pages}
         + ランディングページについて{#understanding-landing-pages}
            ...
            + [ランディングページのパフォーマンスレポート](product-docs/demand-generation/landing-pages/understanding-landing-pages/landing-page-performance-report.md)
   ...
   + メールマーケティング {#email-marketing}
      + 到達率 {#deliverability}
         ...
         + [メールの到達率用に SPF と DKIM を設定する](product-docs/email-marketing/deliverability/set-up-spf-and-dkim-for-your-email-deliverability.md)
      ...
      + メールプログラム {#email-programs}
         ...
         + 電子メールプログラムデータ{#email-program-data}
            ...
            + [メールプログラムの結果の表示](product-docs/email-marketing/email-programs/email-program-data/view-email-program-results.md)
   ...
   + Marketo セールスの連携 {#marketo-sales-connect}
      ...
      + 電話 {#phone}
         ...
         + [Salesforce にログが記録されない](product-docs/marketo-sales-connect/phone/didnt-log-to-salesforce.md)
   ...
   + Marketoセールスインサイト {#marketo-sales-insight}
      ...
      + MSI Chromeプラグイン{#msi-chrome-plugin}
         + [Google Chrome 用 Marketo Insights のインストール](product-docs/marketo-sales-insight/msi-chrome-plugin/install-marketo-insights-for-google-chrome.md)
      ...
      + Salesforce用MSI {#msi-for-salesforce}
         ...
         + モバイル用MSI {#msi-for-mobile}
            ...
            + [Salesforce1 での Marketo Sales Insight のインストールと設定](product-docs/marketo-sales-insight/msi-for-salesforce/msi-for-mobile/install-and-configure-marketo-sales-insight-in-salesforce1.md)
   ...
   + レポート {#reporting}
      + 基本レポート{#basic-reporting}
         + レポートの作成{#creating-reports}
            ...
            + [Analytics ホームページの操作](product-docs/reporting/basic-reporting/creating-reports/navigating-the-analytics-home-page.md)
         ...
         + レポートのタイプ {#report-types}
            ...
            + [Campaign メールパフォーマンスレポート](product-docs/reporting/basic-reporting/report-types/campaign-email-performance-report.md)
            + [ 企業のウェブアクティビティレポート](product-docs/reporting/basic-reporting/report-types/company-web-activity-report.md)
            + [ステータス別顧客レポート](product-docs/reporting/basic-reporting/report-types/people-by-status-report.md)
      ...
      + 収益サイクルアナリティクス {#revenue-cycle-analytics}
         ...
         + 商談の影響アナライザ {#opportunity-influence-analyzer}
            ...
            + [商談の影響アナライザーのデータの書き出し](product-docs/reporting/revenue-cycle-analytics/opportunity-influence-analyzer/export-opportunity-influence-analyzer-data.md)
         ...
         + 収益サイクルモデル {#revenue-cycle-models}
            ...
            + [新規収益モデルの作成](product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/create-a-new-revenue-model.md)
         ...
         + 収益エクスプローラ {#revenue-explorer}
            ...
            + [収益エクスプローラーレポートの作成](product-docs/reporting/revenue-cycle-analytics/revenue-explorer/create-a-revenue-explorer-report.md)
            ...
            + [収益エクスプローラーレポートのタイプ](product-docs/reporting/revenue-cycle-analytics/revenue-explorer/revenue-explorer-report-types.md)
         ...
         + 売上高ツール{#revenue-tools}
            ...
            + [収益ステージ別の個人レポート](product-docs/reporting/revenue-cycle-analytics/revenue-tools/people-by-revenue-stage-report.md)
            + 属性 {#attribution}
...
+ リリースノート{#release-notes}
   ...
   + 以前のリリース {#previous-releases}
      ...
      + 2020 {#2020}
         + [リリースノート：20年1月](release-notes/previous-releases/2020/release-notes-jan-20.md)
         + [リリースノート：20年2月](release-notes/previous-releases/2020/release-notes-feb-20.md)
         + [リリースノート：20年6月](release-notes/previous-releases/2020/release-notes-june-20.md)
         + [リリースノート：20年7月](release-notes/previous-releases/2020/release-notes-july-20.md)
         + [リリースノート：20年10月](release-notes/previous-releases/2020/release-notes-oct-20.md)
      + 2019 {#2019}
         ...
         + [リリースノート：19年春](release-notes/previous-releases/2019/release-notes-spring-19.md)
         + [リリースノート：19年冬](release-notes/previous-releases/2019/release-notes-winter-19.md)
      + 2018 {#2018}
         + [リリースノート：18年秋](release-notes/previous-releases/2018/release-notes-fall-18.md)
         + [リリースノート：春18](release-notes/previous-releases/2018/release-notes-spring-18.md)
         + [リリースノート：18年冬](release-notes/previous-releases/2018/release-notes-winter-18.md)
      + 2017 {#2017}
         + [リリースノート：2017年4月ABMの機能強化](release-notes/previous-releases/2017/release-notes-april-17-abm-enhancements.md)
         + [リリースノート：2017年8月ABMの機能強化](release-notes/previous-releases/2017/release-notes-august-17-abm-enhancements.md)
         + [リリースノート：17年秋](release-notes/previous-releases/2017/release-notes-fall-17.md)
         + [リリースノート：春17](release-notes/previous-releases/2017/release-notes-spring-17.md)
         + [リリースノート：17年夏](release-notes/previous-releases/2017/release-notes-summer-17.md)
         + [リリースノート：17年冬](release-notes/previous-releases/2017/release-notes-winter-17.md)
      + 2016 {#2016}
         + [リリースノート：16年秋](release-notes/previous-releases/2016/release-notes-fall-16.md)
         + [リリースノート：春&#39;16](release-notes/previous-releases/2016/release-notes-spring-16.md)
         + [リリースノート：16年夏](release-notes/previous-releases/2016/release-notes-summer-16.md)
         + [リリースノート：16年冬](release-notes/previous-releases/2016/release-notes-winter-16.md)
      + 2015 {#2015}
         + [リリースノート：2015年4月](release-notes/previous-releases/2015/release-notes-april-2015.md)
         + [リリースノート：15年秋](release-notes/previous-releases/2015/release-notes-fall-15.md)
