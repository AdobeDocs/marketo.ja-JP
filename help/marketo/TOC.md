...
+ Marketo Engage の概要 {#getting-started}
  ...
  + 新しい Marketo Engage インスタンスの実装 {#implementing-a-new-marketo-engage-instance}
    ...
    + [新しいインスタンスのベストプラクティス：設定内容のドキュメント化](getting-started/implementing-a-new-marketo-engage-instance/document-your-setup.md)
  + 留意事項 {#things-to-know}
  ...
  + クイックウィン {#quick-wins}
    + [セットアップして人物を追加](getting-started/quick-wins/get-set-up-and-add-a-person.md)
  ...
  + Marketo Engage インスタンスの継承 {#inheriting-a-marketo-engage-instance}
    ...
    + [継承インスタンス：「管理」セクションのチェックリスト](getting-started/inheriting-a-marketo-engage-instance/admin-section-checklist.md)
    ...
    + [継承インスタンス：設定内容のドキュメント化](getting-started/inheriting-a-marketo-engage-instance/document-your-setup.md)
...
+ 製品ドキュメント {#product-docs}
  ...
  + 管理 {#administration}
    ...
    + 追加的な統合 {#additional-integrations}
      ...
      + [マネージャーアカウントを使用して Google AdWords を LaunchPoint サービスとして追加](product-docs/administration/additional-integrations/add-google-adwords-as-a-launchpoint-service-with-a-manager-account.md)
      ...
      + {hide-from-toc}[次世代Munchkin トラッキングに関するFAQ](product-docs/administration/additional-integrations/add-munchkin-tracking-code-to-your-website/next-generation-munchkin-tracking-faq.md)
      ...
      + {hide-from-toc}[SOAP API設定の設定](product-docs/administration/additional-integrations/configuring-your-soap-api-settings.md)
    ...
    + メール設定 {#email-setup}
      ...
      + [購読解除メッセージを言語に応じて動的に設定](product-docs/administration/email-setup/edit-the-unsubscribe-message/make-your-unsubscribe-message-dynamic-for-languages.md)
    ...
    + フィールド管理 {#field-management}
      ...
      + [フィールドの「使用先」データの書き出し](product-docs/administration/field-management/export-used-by-data-for-a-field.md)
      ...
      + [フィールドを機微情報としてマーク](product-docs/administration/field-management/mark-a-field-as-sensitive.md)
    ...
    + Marketo と Adobe ID {#marketo-with-adobe-identity}
      ...
      + [Adobe ID を使用したユーザのログイン](product-docs/administration/marketo-with-adobe-identity/user-sign-in-with-adobe-id.md)
    + 設定 {#settings}
      ...
      + [アカウントでパーソナライズされた URL の有効化](product-docs/administration/settings/enable-personalized-urls-for-your-account.md)
      ...
      + [デフォルト通貨の設定](product-docs/administration/settings/set-default-currency.md)
    ...
    + タグ {#tags}
      ...
      + [プログラムチャネルからプログラムステータスの削除](product-docs/administration/tags/delete-a-program-status-from-a-program-channel.md)
    ...
    + ユーザ＆ロール {#users-and-roles}
      ...
      + [ユーザロールの作成、削除、編集、変更](product-docs/administration/users-and-roles/create-delete-edit-and-change-a-user-role.md)
    ...
    + ワークスペースと人物パーティション {#workspaces-and-person-partitions}
  ...
  + Adobe Experience Cloud 連携 {#adobe-experience-cloud-integrations}
  ...
  + Marketo の中心概念 {#core-marketo-concepts}
    + スマートキャンペーン {#smart-campaigns}
      ...
      + スマートキャンペーンの使用 {#using-smart-campaigns}
        ...
        + [キャンペーンアクション：スマートキャンペーンの複製](product-docs/core-marketo-concepts/smart-campaigns/using-smart-campaigns/campaign-actions-clone-a-smart-campaign.md)
        + [キャンペーンアクション：スマートキャンペーンの削除](product-docs/core-marketo-concepts/smart-campaigns/using-smart-campaigns/campaign-actions-delete-a-smart-campaign.md)
      ...
      + プログラムフローアクション {#program-flow-actions}
        ...
        + [プログラムメンバーのデータの変更](product-docs/core-marketo-concepts/smart-campaigns/program-flow-actions/change-program-member-data.md)
      ...
      + Salesforce フローアクション {#salesforce-flow-actions}
        ...
        + [SFDC からの人物の削除](product-docs/core-marketo-concepts/smart-campaigns/salesforce-flow-actions/delete-person-from-sfdc.md)
      ...
      + スマートキャンペーンデータ {#smart-campaign-data}
        + [スマートキャンペーンの結果の Excel への書き出し](product-docs/core-marketo-concepts/smart-campaigns/smart-campaign-data/export-smart-campaign-results-to-excel.md)
        ...
        + [スマートキャンペーンでブロックされた人物の表示](product-docs/core-marketo-concepts/smart-campaigns/smart-campaign-data/view-blocked-people-in-a-smart-campaign.md)
        + [スマートキャンペーンで条件を満たす人物の表示](product-docs/core-marketo-concepts/smart-campaigns/smart-campaign-data/view-qualified-people-in-a-smart-campaign.md)
        + [スマートキャンペーンのキャンペーンメンバーの表示](product-docs/core-marketo-concepts/smart-campaigns/smart-campaign-data/view-smart-campaign-members.md)
    ...
    + スマートリストと静的リスト {#smart-lists-and-static-lists}
      ...
      + スマートリストの使用 {#using-smart-lists}
        ...
        + [ワークスペース間でのリストおよびスマートリストの参照](product-docs/core-marketo-concepts/smart-lists-and-static-lists/using-smart-lists/reference-a-list-or-smart-list-across-workspaces.md)
        ...
        + [スマートリストからの単一のフローステップの実行](product-docs/core-marketo-concepts/smart-lists-and-static-lists/using-smart-lists/run-a-single-flow-step-from-a-smart-list.md)
        ...
        + [スマートリストでのデータ値変更フィルターの使用](product-docs/core-marketo-concepts/smart-lists-and-static-lists/using-smart-lists/use-the-data-value-changed-filter-in-a-smart-list.md)
      ...
      + スマートリスト内の人物の管理 {#managing-people-in-smart-lists}
        + [人物のブロックリストへの追加](product-docs/core-marketo-concepts/smart-lists-and-static-lists/managing-people-in-smart-lists/add-person-to-blocklist.md)
        ...
        + [リストまたはスマートリストからの人物の Excel への書き出し](product-docs/core-marketo-concepts/smart-lists-and-static-lists/managing-people-in-smart-lists/export-people-to-excel-from-a-list-or-smart-list.md)
        ...
        + [収益ステージ内のすべての人物の検索](product-docs/core-marketo-concepts/smart-lists-and-static-lists/managing-people-in-smart-lists/find-all-people-in-a-revenue-stage.md)
        + [重複する人物の検索と結合](product-docs/core-marketo-concepts/smart-lists-and-static-lists/managing-people-in-smart-lists/find-and-merge-duplicate-people.md)
        + [カスタムロジックを使用した重複する人物の検索](product-docs/core-marketo-concepts/smart-lists-and-static-lists/managing-people-in-smart-lists/find-duplicate-people-with-custom-logic.md)
        ...
        + [匿名アクティビティと人物について](product-docs/core-marketo-concepts/smart-lists-and-static-lists/managing-people-in-smart-lists/understanding-anonymous-activity-and-people.md)
    ...
    + プログラム {#programs}
      ...
      + プログラムライブラリ {#program-library}
        ...
        + [CT-YYYY-MM-Marketo ランディングページ上のコンテンツ](/help/marketo/product-docs/core-marketo-concepts/programs/program-library/ct-yyyy-mm-content-on-marketo-landing-page.md)
        ...
        + [OA-YYYY-MM-オンライン広告用 Marketo ランディングページ](/help/marketo/product-docs/core-marketo-concepts/programs/program-library/oa-yyyy-mm-online-advertising-marketo-landing-page.md)
    ...
    + モバイルアプリ {#mobile-apps}
      + イベントチェックイン {#event-check-in}
        ...
        + [ユーザへのチェックインアプリのアクセス権の付与](product-docs/core-marketo-concepts/mobile-apps/event-check-in/grant-users-access-to-the-check-in-app.md)
  ...
  + CRM 同期 {#crm-sync}
    + Microsoft Dynamics 同期 {#microsoft-dynamics}
      ...
      + Microsoft Dynamics 同期の詳細 {#microsoft-dynamics-sync-details}
        ...
        + [Microsoft Dynamics 同期：アカウント同期](product-docs/crm-sync/microsoft-dynamics-sync/microsoft-dynamics-sync-details/microsoft-dynamics-sync-account-sync.md)
        ...
        + [カスタムエンティティの同期を有効にする](product-docs/crm-sync/microsoft-dynamics-sync/microsoft-dynamics-sync-details/enable-sync-for-a-custom-entity.md)
        + [Microsoft Dynamics 同期：フィールド同期](product-docs/crm-sync/microsoft-dynamics-sync/microsoft-dynamics-sync-details/microsoft-dynamics-sync-field-sync.md)
        + [Microsoft Dynamics のクイック同期を使用した新しいカスタムフィールドの同期](product-docs/crm-sync/microsoft-dynamics-sync/microsoft-dynamics-sync-details/microsoft-dynamics-sync-field-sync/use-quick-sync-with-microsoft-dynamics-for-a-new-custom-field.md)
        ...
        + [Microsoft Dynamics での取引先責任者の作成](product-docs/crm-sync/microsoft-dynamics-sync/microsoft-dynamics-sync-details/microsoft-dynamics-sync-lead-sync/create-a-contact-in-microsoft-dynamics.md)
      ...
      + カスタム Dynamics 同期フィルターの詳細 {#custom-dynamics-sync-filter-details}
        ...
        + [メールアドレス用カスタム同期フィルタールール](product-docs/crm-sync/microsoft-dynamics-sync/create-a-custom-dynamics-sync-filter/custom-sync-filter-rules-for-an-email-address.md)
        ...
        + [Microsoft Dynamics 同期フィルター：選定](product-docs/crm-sync/microsoft-dynamics-sync/create-a-custom-dynamics-sync-filter/microsoft-dynamics-sync-filter-qualify.md)
    ...
    + Salesforce 同期 {#salesforce-sync}
      ...
      + 設定 {#setup}
        ...
        + オプションの手順 {#optional-steps}
          + [スマートリスト／トリガー制約としてのカスタムオブジェクトフィールドの追加／削除](product-docs/crm-sync/salesforce-sync/setup/optional-steps/add-remove-custom-object-field-as-smart-list-trigger-constraints.md)
          ...
          + [英語以外のカスタムオブジェクト同期を有効にする](product-docs/crm-sync/salesforce-sync/setup/optional-steps/enable-non-english-custom-object-sync.md)
    ...
    + Veeva CRM 同期 {#veeva-crm-sync}
      ...
      + 同期の詳細 {#sync-details}
        + [スマートリスト／トリガー制約としてのカスタムオブジェクトフィールドの追加／削除](product-docs/crm-sync/veeva-crm-sync/sync-details/add-remove-custom-object-field-as-smart-list-trigger-constraints.md)
        ...
        + [通話と通話キーメッセージの同期](product-docs/crm-sync/veeva-crm-sync/sync-details/syncing-call-and-call-key-messages.md)
  ...
  + デマンドジェネレーション {#demand-generation}
    + 広告ネットワーク統合 {#ad-network-integrations}
      ...
      + [LinkedIn Matched Audiences の LaunchPoint サービスとしての追加](product-docs/demand-generation/ad-network-integrations/add-linkedin-matched-audiences-as-a-launchpoint-service.md)
    ...
    + イベント {#events}
      ...
      + インタラクティブウェビナー {#interactive-webinars}
        ...
        + [ルーム管理](product-docs/demand-generation/events/interactive-webinars/room-management.md)
    ...
    + Facebook {#facebook}
      ...
      + {hide-from-toc}[Facebook リッチ投稿設定の編集](product-docs/demand-generation/facebook/edit-facebook-rich-post-settings.md)
      + [ランディングページの Facebook への公開](product-docs/demand-generation/facebook/publish-landing-pages-to-facebook.md)
      + [Facebook リード広告の設定](product-docs/demand-generation/facebook/set-up-facebook-lead-ads.md)
      ...
      + [Facebook オフラインコンバージョンの設定](product-docs/demand-generation/facebook/set-up-facebook-offline-conversions.md)
    ...
    + フォーム {#forms}
      ...
      + フォームアクション {#form-actions}
        ...
        + [既知の人物へのカスタム HTML フォームの表示](product-docs/demand-generation/forms/form-actions/show-custom-html-form-for-known-people.md)
      ...
      + フォームフィールド {#form-fields}
        ...
        + [フォームフィールドの非表示に設定](product-docs/demand-generation/forms/form-fields/set-a-form-field-as-hidden.md)
    ...
    + 画像とファイル {#images-and-files}
      ...
      + [Marketo EngageのC2PA メタデータ](product-docs/demand-generation/images-and-files/c2pa-metadata.md)
      ...
      + [画像エディター](product-docs/demand-generation/images-and-files/image-editor.md)
    ...
    + ランディングページ {#landing-pages}
      ...
      + フリーフォームランディングページ {#free-form-landing-pages}
        ...
        + [フリーフォームランディングページ内の画像へのリンクの追加](product-docs/demand-generation/landing-pages/free-form-landing-pages/add-a-link-to-an-image-in-a-free-form-landing-page.md)
        + [フリーフォームランディングページへのモバイル表示の追加](product-docs/demand-generation/landing-pages/free-form-landing-pages/add-a-mobile-view-for-your-free-form-landing-page.md)
        ...
        + [ガイドを使用したフリーフォームランディングページのデザイン](product-docs/demand-generation/landing-pages/free-form-landing-pages/use-guides-for-free-form-landing-page-design.md)
      ...
      + ランディングページのテンプレート {#landing-page-templates}
        ...
        + [既存のフリーフォームランディングページテンプレートのモバイル対応化](product-docs/demand-generation/landing-pages/landing-page-templates/make-an-existing-free-form-landing-page-template-mobile-compatible.md)
      ...
      + ランディングページのパーソナライズ {#personalizing-landing-pages}
        ...
        + [ランディングページ用 CNAME の追加](product-docs/demand-generation/landing-pages/personalizing-landing-pages/add-additional-landing-page-cnames.md)
    ...
    + ソーシャル {#social}
      + ソーシャル機能 {#social-functions}
        + [LinkedIn Lead Gen フォームの設定](product-docs/demand-generation/social/social-functions/set-up-linkedin-lead-gen-forms.md)
  ...
  + メールマーケティング {#email-marketing}
    + 配信品質 {#deliverability}
      ...
      + [メール配信品質パワーパック - シードリストの読み込み方法](product-docs/email-marketing/deliverability/email-deliverability-power-pack-how-to-import-a-seed-list.md)
      ...
      + インボックストラッカー {#inbox-tracker}
        + [インボックストラッカーのチュートリアル](product-docs/email-marketing/deliverability/inbox-tracker/inbox-tracker-tutorials.md)
    + ドリップナーチャリング {#drip-nurturing}
      + エンゲージメントプログラムの作成 {#creating-an-engagement-program}
        ...
        + [エンゲージメントプログラムのストリームへのプログラムの追加](product-docs/email-marketing/drip-nurturing/creating-an-engagement-program/adding-a-program-to-an-engagement-program-stream.md)
      ...
      + エンゲージメントプログラムストリーム {#engagement-program-streams}
        ...
        + [エンゲージメントストリーム間での人物のトランジション](product-docs/email-marketing/drip-nurturing/engagement-program-streams/transition-people-between-engagement-streams.md)
      + エンゲージメントプログラムの使用 {#using-engagement-programs}
        ...
        + [コンテンツ消費済みの人物](product-docs/email-marketing/drip-nurturing/using-engagement-programs/people-who-have-exhausted-content.md)
      ...
      + ストリームコンテンツの使用 {#using-stream-content}
        + [ストリームコンテンツのアクティブ化および非アクティブ化](product-docs/email-marketing/drip-nurturing/using-stream-content/activate-and-deactivate-stream-content.md)
    ...
    + E メールデザイナー {#email-designer}
      ...
      + [メールテンプレートの高度なHTMLエディター](product-docs/email-marketing/email-designer/advanced-html-mode.md)
    ...
    + メールプログラム {#email-programs}
      ...
      + メールプログラムアクション {#email-program-actions}
        ...
        + 受信者タイムゾーンを使用したスケジュール設定 {#scheduling-with-recipient-time-zone}
    ...
    + 一般 {#general}
      ...
      + エディターの機能 {#functions-in-the-editor}
        ...
        + [メールへの「Web ページとして表示」リンクの追加](product-docs/email-marketing/general/functions-in-the-editor/add-a-view-as-web-page-link-to-an-email.md)
        ...
        + [テキストメールへのトラッキングリンクの追加](product-docs/email-marketing/general/functions-in-the-editor/add-tracked-links-to-a-text-email.md)
        ...
        + [メールの HTML ダウンロード](product-docs/email-marketing/general/functions-in-the-editor/download-an-emails-html.md)
        + [メールの HTML 編集](product-docs/email-marketing/general/functions-in-the-editor/edit-an-emails-html.md)
      ...
      + トークンの使用 {#using-tokens}
        + [システムトークンのメールのリンクとしての追加](product-docs/email-marketing/general/using-tokens/add-a-system-token-as-a-link-in-an-email.md)
  ...
  + Marketo AI {#marketo-ai}
    + {hide-from-toc}[概要](product-docs/marketo-ai/overview.md)
    + {hide-from-toc}[設定と設定](product-docs/marketo-ai/settings-setup.md)
    + {hide-from-toc}[Marketo AI データ インフォメーション シート ](product-docs/marketo-ai/data-information.md)
    + スキル {#skills}
      + {hide-from-toc}[製品ナレッジ ](product-docs/marketo-ai/skills/product-knowledge.md)
      ...
      + {hide-from-toc}[ リードの調査](product-docs/marketo-ai/skills/investigate-leads.md)
      + {hide-from-toc}[ リードの読み込み](product-docs/marketo-ai/skills/import-leads.md)
      + {hide-from-toc}[ プログラムの検証](product-docs/marketo-ai/skills/validate-programs.md)
  ...
  + Marketo セールスコネクト {#marketo-sales-connect}
    + はじめに {#getting-started}
      ...
      + メール設定 {#email-settings}
        ...
        + [メール署名の追加](product-docs/marketo-sales-connect/getting-started/email-settings/add-your-email-signature.md)
        + [確認用メールを受信していない](product-docs/marketo-sales-connect/getting-started/email-settings/never-received-a-verification-email.md)
        + [メールの認証](product-docs/marketo-sales-connect/getting-started/email-settings/verify-your-email.md)
    + 管理 {#admin}
    ...
    + キャンペーン {#campaigns}
      + [キャンペーンに人物を追加](product-docs/marketo-sales-connect/campaigns/add-people-to-your-campaign.md)
      ...
      + [キャンペーンから人物を削除](product-docs/marketo-sales-connect/campaigns/remove-people-from-a-campaign.md)
    ...
    + CRM {#crm}
      + Salesforce のカスタマイズ {#salesforce-customization}
        ...
        + [Salesforce Classic からの Marketo セールスコネクトのアンインストール](product-docs/marketo-sales-connect/crm/salesforce-customization/uninstall-marketo-sales-connect-from-salesforce-classic.md)
        + [Salesforce Lightning からの Marketo セールスコネクトのアンインストール](product-docs/marketo-sales-connect/crm/salesforce-customization/uninstall-marketo-sales-connect-from-salesforce-lightning.md)
      + Salesforce 統合 {#salesforce-integration}
        ...
        + [Salesforce に接続する際に表示される「リクエストを認証できませんでした」エラーの対処方法](product-docs/marketo-sales-connect/crm/salesforce-integration/how-to-fix-we-were-unable-to-authenticate-your-request-when-connecting-to-salesforce.md)
    ...
    + メールプラグイン {#email-plugins}
      ...
      + Outlook 用 MSC {#msc-for-outlook}
        + [Outlook ユーザのメール接続](product-docs/marketo-sales-connect/email-plugins/msc-for-outlook/email-connection-for-outlook-users.md)
    ...
    + メール {#email}
      ...
      + トラッキングに関するよくある質問 {#common-tracking-questions}
        ...
        + [メールの添付ファイルのトラッキング方法](product-docs/marketo-sales-connect/email/common-tracking-questions/how-to-track-your-email-attachments.md)
        ...
        + [テストメールが表示済みとして記録されない](product-docs/marketo-sales-connect/email/common-tracking-questions/test-email-not-showed-as-viewed.md)
      ...
      + セールスメールの送信 {#send-a-sales-email}
        ...
        + [スパムに分類されたメール](product-docs/marketo-sales-connect/email/send-a-sales-email/email-marked-as-spam.md)
      ...
      + 登録解除 {#unsubscribes}
        + [登録解除メッセージの自動追加設定](product-docs/marketo-sales-connect/email/unsubscribes/auto-append-unsubscribe-message-setting.md)
        + [登録解除リンクメッセージのカスタマイズ](product-docs/marketo-sales-connect/email/unsubscribes/customize-unsubscribe-link-message.md)
        + [Marketo 登録解除チェック](product-docs/marketo-sales-connect/email/unsubscribes/marketo-unsubscribe-check.md)
        + [登録解除の再登録](product-docs/marketo-sales-connect/email/unsubscribes/resubscribing-an-unsubscribe.md)
        ...
        + [登録解除リンクのランディングページ](product-docs/marketo-sales-connect/email/unsubscribes/unsubscribe-link-landing-page.md)
        + [登録解除の概要](product-docs/marketo-sales-connect/email/unsubscribes/unsubscribe-overview.md)
      + 作成ウィンドウの使用 {#using-the-compose-window}
        + [メールへの添付ファイルまたはトラッキング可能コンテンツの追加](product-docs/marketo-sales-connect/email/using-the-compose-window/add-an-attachment-or-trackable-content-to-your-email.md)
        ...
        + [グループメールによるメールの送信](product-docs/marketo-sales-connect/email/using-the-compose-window/sending-emails-via-group-email.md)
    ...
    + よくある質問 {#faq}
      + [削除した取引先責任者またはグループを復元できますか？](product-docs/marketo-sales-connect/faq/can-i-recover-a-contact-or-group-i-deleted.md)
      ...
      + [アカウントにアクセスできない どうすればいいですか？](product-docs/marketo-sales-connect/faq/i-got-locked-out-of-my-account-what-do-i-do.md)
      ...
      + [Sales Connect では、どのブラウザーとメールクライアントがサポートされていますか？](product-docs/marketo-sales-connect/faq/which-browsers-and-email-clients-are-supported-with-sales-connect.md)
      + [セールスコネクトに取引先責任者がプッシュされないのはなぜですか？](product-docs/marketo-sales-connect/faq/why-arent-any-of-my-contacts-getting-pushed-to-sales-connect.md)
      + [取引先責任者を削除できないのはなぜですか？](product-docs/marketo-sales-connect/faq/why-cant-i-delete-a-contact.md)
      + [すべての取引先責任者がセールスコネクトにプッシュされなかったのはなぜですか？](product-docs/marketo-sales-connect/faq/why-didnt-all-of-my-contacts-get-pushed-to-sales-connect.md)
    + 統合 {#integrations}
      + [他の CRM へのメールを記録する方法](product-docs/marketo-sales-connect/integrations/how-to-log-emails-to-other-crms.md)
    + Marketo {#marketo}
      ...
      + [Sales Connect の注目のアクション](product-docs/marketo-sales-connect/marketo/interesting-moments-in-sales-connect.md)
      ...
      + [セールスアクティビティ用語集](product-docs/marketo-sales-connect/marketo/sales-activity-glossary.md)
      + [セールスアクティビティのトリガーとフィルター](product-docs/marketo-sales-connect/marketo/sales-activity-triggers-and-filters.md)
    + 人物 {#people}
      ...
      + 取引先責任者の管理 {#managing-contacts}
        ...
        + [CSV を使用した取引先責任者のインポート](product-docs/marketo-sales-connect/people/managing-contacts/import-contacts-via-csv.md)
    ...
    + 電話 {#phone}
      + [通話が Salesforce にログとして記録されない](product-docs/marketo-sales-connect/phone/calls-arent-logging-to-salesforce.md)
      ...
      + [セールス電話の国際電話機能](product-docs/marketo-sales-connect/phone/sales-phone-international-calling.md)
      ...
      + [チームとの通話録音の共有](product-docs/marketo-sales-connect/phone/share-call-recordings-with-your-team.md)
  ...
  + Marketo セールスインサイト {#marketo-sales-insight}
    + アクション {#actions}
      ...
      + はじめに {#getting-started}
        ...
        + メール設定 {#email-settings}
          + [メールの認証](product-docs/marketo-sales-insight/actions/getting-started/email-settings/verify-your-email.md)
      ...
      + 管理 {#admin}
        ...
        + [セールスアクションデータの Marketo および Salesforce との同期](product-docs/marketo-sales-insight/actions/admin/sync-sales-action-data-with-marketo-and-salesforce.md)
      ...
      + CRM {#crm}
        ...
        + Salesforce 統合 {#salesforce-integration}
          ...
          + [セールスインサイトアクションアカウントの Salesforce への接続](product-docs/marketo-sales-insight/actions/crm/salesforce-integration/connect-your-sales-insight-actions-account-to-salesforce.md)
        ...
        + Salesforce パッケージ設定 {#salesforce-package-configuration}
          ...
          + [セールスアクティビティ属性の Salesforce へのログ記録](product-docs/marketo-sales-insight/actions/crm/salesforce-package-configuration/logging-sales-activity-attributes-to-salesforce.md)
          ...
          + [Salesforce にアクティビティをログする際のアクティビティタイプフィールドの更新](product-docs/marketo-sales-insight/actions/crm/salesforce-package-configuration/update-activity-type-field-when-logging-activities-to-salesforce.md)
        + Salesforce でのアクション {#actions-in-salesforce}
          + [Salesforce でのセールスメール一括送信の使用](product-docs/marketo-sales-insight/actions/crm/actions-in-salesforce/using-bulk-send-sales-email-in-salesforce.md)
          + [Salesforce でのセールスキャンペーンへの一括追加の方法](product-docs/marketo-sales-insight/actions/crm/actions-in-salesforce/using-bulk-add-to-sales-campaign-in-salesforce.md)
      + メール {#email}
        + コマンドセンター {#command-center}
        ...
        + メール配信 {#email-delivery}
          ...
          + [チーム向けカスタム配信チャネルの設定](product-docs/marketo-sales-insight/actions/email/email-delivery/set-up-a-custom-delivery-channel-for-your-team.md)
        + 登録解除 {#unsubscribes}
          + [登録解除の概要](product-docs/marketo-sales-insight/actions/email/unsubscribes/unsubscribe-overview.md)
          + [登録解除メッセージの自動追加設定](product-docs/marketo-sales-insight/actions/email/unsubscribes/auto-append-unsubscribe-message-setting.md)
        ...
        + 作成ウィンドウの使用 {#using-the-compose-window}
          + [メールへの添付ファイルまたはトラッキング対象コンテンツの追加](product-docs/marketo-sales-insight/actions/email/using-the-compose-window/add-an-attachment-or-trackable-content-to-your-email.md)
          + [一括メール送信オプション](product-docs/marketo-sales-insight/actions/email/using-the-compose-window/bulk-emailing-options.md)
          + {hide-from-toc}[「選択して送信」による一括メールの作成](product-docs/marketo-sales-insight/actions/email/using-the-compose-window/composing-bulk-emails-with-select-and-send.md)
      ...
      + メール統合 {#email-integrations}
        + Gmail {#gmail}
          + [Gmail への接続](product-docs/marketo-sales-insight/actions/email-integrations/gmail/connect-to-gmail.md)
        + Outlook {#outlook}
          + [Outlook への接続](product-docs/marketo-sales-insight/actions/email-integrations/outlook/connect-to-outlook.md)
      + よくある質問 {#faq}
        ...
        + [セールスインサイトアクションに iPhone または Android アプリはありますか？](product-docs/marketo-sales-insight/actions/faq/does-sales-insight-actions-have-an-iphone-or-android-app.md)
        ...
        + {hide-from-toc}[Sales Insight ActionsはSalesforce Lightningと互換性がありますか？](product-docs/marketo-sales-insight/actions/faq/is-sales-insight-actions-compatible-with-salesforce-lightning.md)
        ...
        + [セールスインサイトアクションの利用規約は何ですか？](product-docs/marketo-sales-insight/actions/faq/what-are-the-sales-insight-actions-terms-of-service.md)
        + [取引先責任者がセールスインサイトアクションにプッシュされないのはなぜですか？](product-docs/marketo-sales-insight/actions/faq/why-arent-any-of-my-contacts-getting-pushed-to-sales-insight-actions.md)
        + [動的フィールドに入力されないのはなぜですか？](product-docs/marketo-sales-insight/actions/faq/why-arent-my-dynamic-fields-filling-out.md)
        + [セールスアクティビティおよびアクティビティフィールドが Salesforce に同期されないのはなぜですか？](product-docs/marketo-sales-insight/actions/faq/why-arent-my-sales-activities-and-activity-fields-syncing-to-salesforce.md)
        + [取引先責任者を削除できないのはなぜですか？](product-docs/marketo-sales-insight/actions/faq/why-cant-i-delete-a-contact.md)
        + [すべての取引先責任者がセールスインサイトアクションにプッシュされなかったのはなぜですか？](product-docs/marketo-sales-insight/actions/faq/why-didnt-all-of-my-contacts-get-pushed-to-sales-insight-actions.md)
        + [メールがスパムとしてマークされる理由](product-docs/marketo-sales-insight/actions/faq/why-do-my-emails-get-marked-as-spam.md)
        + [キャンペーンが終了したのはなぜですか？](product-docs/marketo-sales-insight/actions/faq/why-has-my-campaign-ended.md)
      ...
      + Marketo {#marketo}
        ...
        + {hide-from-toc}[Marketo Connectionの設定](product-docs/marketo-sales-insight/actions/marketo/set-up-your-marketo-connection.md)
      + 人物 {#people}
        + {hide-from-toc}[人物の詳細ビュー](product-docs/marketo-sales-insight/actions/people/person-detail-view.md)
        ...
        + 取引先責任者の管理 {#managing-contacts}
          ...
          + {hide-from-toc}[人物ページ列](product-docs/marketo-sales-insight/actions/people/managing-contacts/people-page-columns.md)
      + 電話 {#phone}
    ...
    + MSI Chrome プラグイン {#msi-chrome-plugin}
      ...
      + [Google Chrome での Marketo インサイトの使用](product-docs/marketo-sales-insight/msi-chrome-plugin/using-marketo-insights-for-google-chrome.md)
      + [Google メールでの人物とアカウントの情報およびアクティビティの表示](product-docs/marketo-sales-insight/msi-chrome-plugin/view-person-and-account-information-and-activities-in-google-mail.md)
    + Microsoft Dynamics 用 MSI {#msi-for-microsoft-dynamics}
      ...
      + 設定と使用 {#setting-up-and-using}
        ...
        + [リード／取引先責任者レコードの星と炎の設定](product-docs/marketo-sales-insight/msi-for-microsoft-dynamics/setting-up-and-using/setting-up-stars-and-flames-for-lead-contact-records.md)
      ...
      + 更新しています {#updating}
        + [Microsoft Dynamics 用 Marketo セールスインサイトソリューションのアップグレード](product-docs/marketo-sales-insight/msi-for-microsoft-dynamics/updating/upgrade-the-marketo-sales-insight-solution-for-microsoft-dynamics.md)
    + Salesforce 用 MSI {#msi-for-salesforce}
      ...
      + 機能 {#features}
        ...
        + MSI 設定タブ {#msi-configuration-tab}
          + [セールスインサイトの RSS を有効にする](product-docs/marketo-sales-insight/msi-for-salesforce/features/msi-configuration-tab/enable-rss-for-sales-insight.md)
        + パフォーマンスレポート {#performance-reports}
          + [セールスインサイトのメールパフォーマンスレポート](product-docs/marketo-sales-insight/msi-for-salesforce/features/performance-reports/sales-insight-email-performance-report.md)
        + 星と炎 {#stars-and-flames}
          ...
          + [優先度、緊急度、相対スコア、最有力候補](product-docs/marketo-sales-insight/msi-for-salesforce/features/stars-and-flames/priority-urgency-relative-score-and-best-bets.md)
        ...
        + MSI パネルのタブ {#tabs-in-the-msi-panel}
          ...
          + 注目のアクション {#interesting-moments}
            ...
            + [注目のアクション用トリガートークン](product-docs/marketo-sales-insight/msi-for-salesforce/features/tabs-in-the-msi-panel/interesting-moments/trigger-tokens-for-interesting-moments.md)
    ...
    + [非ネイティブ Salesforce 統合向けセールスインサイト](product-docs/marketo-sales-insight/sales-insight-for-non-native-salesforce-integrations.md)
  + Marketo Sky {#marketo-sky}
    + {hide-from-toc}[期待される動作](product-docs/marketo-sky/expected-behavior.md)
  + モバイルマーケティング {#mobile-marketing}
    ...
    + アプリ内メッセージ {#in-app-messages}
      ...
      + アプリ内メッセージの作成 {#creating-in-app-messages}
        ...
        + [アプリ内メッセージのボタンの設定](product-docs/mobile-marketing/in-app-messages/creating-in-app-messages/set-up-the-in-app-message-button.md)
    ...
    + プッシュ通知 {#push-notifications}
      ...
      + [サンプルのプッシュ通知の送信](product-docs/mobile-marketing/push-notifications/send-a-push-notification-sample.md)
  ...
  + 予測コンテンツ {#predictive-content}
    ...
    + すべてのコンテンツの使用 {#working-with-all-content}
    ...
    + 予測コンテンツの有効化 {#enabling-predictive-content}
      ...
      + [メールの予測コンテンツを有効にする](product-docs/predictive-content/enabling-predictive-content/enable-predictive-content-in-emails.md)
  ...
  + レポート {#reporting}
    ...
    + 基本レポート {#basic-reporting}
      ...
      + レポートの編集 {#editing-reports}
        ...
        + [スマートリストを使用したレポート内の人物のフィルター](product-docs/reporting/basic-reporting/editing-reports/filter-people-in-a-report-with-a-smart-list.md)
        ...
        + [レポートを列で並べ替え](product-docs/reporting/basic-reporting/editing-reports/sort-report-on-columns.md)
      + レポートアクティビティ {#report-activity}
        + [モバイルプラットフォーム列を含む人物パフォーマンスレポートの作成](product-docs/reporting/basic-reporting/report-activity/build-a-people-performance-report-with-mobile-platform-columns.md)
        ...
        + [レポートを複製してレポートグループへ追加](product-docs/reporting/basic-reporting/report-activity/clone-a-report-to-group-reports.md)
        ...
        + [人物レポートの属性別のグループ化](product-docs/reporting/basic-reporting/report-activity/group-person-reports-by-attribute.md)
        ...
        + [匿名アクティビティと人物のトラッキング](product-docs/reporting/basic-reporting/report-activity/tracking-anonymous-activity-and-people.md)
      ...
      + レポートタイプ {#report-types}
        ...
        + [ステータス別人物レポート](product-docs/reporting/basic-reporting/report-types/people-by-status-report.md)
    ...
    + メールインサイト {#email-insights}
      ...
      + [メールインサイトでのフィルタリング](product-docs/reporting/email-insights/filtering-in-email-insights.md)
    + パフォーマンスインサイト {#performance-insights}
      ...
      + [パフォーマンスインサイトの貢献度概要](product-docs/reporting/performance-insights/performance-insights-contribution-overview.md)
    ...
    + 収益サイクル分析 {#revenue-cycle-analytics}
      ...
      + プログラム分析 {#program-analytics}
        ...
        + [プログラムコスト分析領域について](product-docs/reporting/revenue-cycle-analytics/program-analytics/understanding-the-program-cost-analysis-area.md)
      ...
      + 収益サイクルモデル {#revenue-cycle-models}
        + [収益モデルの承認／承認解除](product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/approve-unapprove-a-revenue-model.md)
        ...
        + [Marketo のサンプル収益モデルの複製](product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/cloning-a-marketo-example-revenue-model.md)
        + [新しい収益モデルの作成](product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/create-a-new-revenue-model.md)
        ...
        + [収益モデルに関するレポート](product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/report-on-your-revenue-model.md)
        + [マネージャーアカウントを使用した収益モデルでの Google AdWords コンバージョンを設定](product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/set-google-adwords-conversions-in-the-revenue-model-with-a-manager-account.md)
        + [収益モデルでの Google AdWords コンバージョンを設定](product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/set-google-adwords-conversions-in-the-revenue-model.md)
        ...
        + [収益モデルのゲートステージの使用](product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/using-revenue-model-gate-stages.md)
        + [収益モデルの在庫ステージの使用](product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/using-revenue-model-inventory-stages.md)
        + [収益モデルの SLA ステージの使用](product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/using-revenue-model-sla-stages.md)
        + [収益モデルのトランジションの使用](product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/using-revenue-model-transitions.md)
  ...
  + ターゲットアカウント管理 {#target-account-management}
    + 設定 {#setup}
      ...
      + [アカウントインサイトにアクセスするユーザの招待](product-docs/target-account-management/setup-tam/invite-users-to-access-account-insight.md)
    + ターゲット {#target}
      + 重点顧客 {#named-accounts}
        ...
        + [重点アカウントへの人物の追加](product-docs/target-account-management/target/named-accounts/add-people-to-a-named-account.md)
  ...
  + Web パーソナライゼーション {#web-personalization}
    ...
    + はじめに {#getting-started}
      ...
      + [トラッキング拒否のための web パーソナライゼーションの設定](product-docs/web-personalization/getting-started/setting-web-personalization-to-do-not-track.md)
    ...
    + Web パーソナライゼーションのレポート {#reporting-for-web-personalization}
      ...
      + [特定の IP のトラッキングからの除外](product-docs/web-personalization/reporting-for-web-personalization/exclude-specific-ips-from-being-tracked.md)
      ...
      + Web 分析の統合 {#web-analytics-integrations}
        ...
        + [RTP の Google Analytics への連携](product-docs/web-personalization/reporting-for-web-personalization/web-analytics-integrations/integrate-rtp-with-google-analytics.md)
        + [RTP の Google ユニバーサルアナリティクスへの連携](product-docs/web-personalization/reporting-for-web-personalization/web-analytics-integrations/integrate-rtp-with-google-universal-analytics.md)
    ...
    + Web キャンペーンの操作 {#working-with-web-campaigns}
      ...
      + [Web キャンペーンの複製](product-docs/web-personalization/working-with-web-campaigns/clone-a-web-campaign.md)
      + [新しいダイアログ web キャンペーンの作成](product-docs/web-personalization/working-with-web-campaigns/create-a-new-dialog-web-campaign.md)
      + [新しいゾーン内 web キャンペーンの作成](product-docs/web-personalization/working-with-web-campaigns/create-a-new-in-zone-web-campaign.md)
      + [新しいウィジェット web キャンペーンの作成](product-docs/web-personalization/working-with-web-campaigns/create-a-new-widget-web-campaign.md)
      ...
      + [Web キャンペーンデータの書き出し](product-docs/web-personalization/working-with-web-campaigns/export-web-campaign-data.md)
...
+ リリースノート {#release-notes}
  ...
  + 以前の{hide-from-toc}件のリリース {#previous-releases}
    + 2026 {#2026}
      ...
      + [リリースノート：2026年3月](release-notes/previous-releases/2026/release-notes-mar-26.md)
      + [リリースノート：2026年5月](release-notes/previous-releases/2026/release-notes-may-26.md)
      + [リリースノート：2026年7月](release-notes/previous-releases/2026/release-notes-july-26.md)
    + 2025年 {#2025}
      ...
      + [リリースノート：2025年9月](release-notes/previous-releases/2025/release-notes-sep-25.md)
      + [リリースノート：10月25日](release-notes/previous-releases/2025/release-notes-oct-25.md)
    + 2024年 {#2024}
    ...
    + 2023年 {#2023}
      ...
      + [リリースノート：2023年5月](release-notes/previous-releases/2023/release-notes-may-23.md)
