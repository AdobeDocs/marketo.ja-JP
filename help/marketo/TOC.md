...
+ 製品ドキュメント {#product-docs}
   ...
   + Marketo の中心概念 {#core-marketo-concepts}
      ...
      + スマートリストと静的リスト {#smart-lists-and-static-lists}
         ...
         + スマートリストの人物の管理 {#managing-people-in-smart-lists}
      ...
      + その他 {#miscellaneous}
         ...
         + {hide-from-toc}[共同作業者ビルドキャンペーン ](product-docs/core-marketo-concepts/miscellaneous/coworker-build-campaigns.md)
   ...
   + Marketo Engage の最新 UX {#marketo-engage-modern-ux}
      ...
      + {hide-from-toc}[切り替え](product-docs/marketo-engage-modern-ux/toggle-switch.md)
