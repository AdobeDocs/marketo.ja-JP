...
+ Marketoの概要 {#getting-started-with-marketo}
   ...
   + セットアップ {#setup}
      ...
      + [Marketoプロトコルの設定](getting-started/setup-steps/configure-protocols-for-marketo.md)
   + クイック勝利 {#quick-wins}
      ...
      + [単純なスコア](getting-started/quick-wins/simple-scoring.md)
      ...
      + [E メールのパーソナライズ](getting-started/quick-wins/personalize-an-email.md)
      ...
      + [重複する可能性のあるユーザーに対するアラートの自動化](getting-started/quick-wins/advanced-solutions/automate-an-alert-for-possible-duplicate-people.md)
   + Marketoインスタンスの継承 {#inheriting-a-marketo-instance}
      + [ヘルプ! 既存のMarketoインスタンスを継承](getting-started/inheriting-a-marketo-instance/help-ive-inherited-an-existing-marketo-instance.md)
...
+ 製品ドキュメント {#product-docs}
   + ターゲットアカウント管理 {#target-account-management}
      + セットアップ {#setup}
         + [Target アカウント管理の概要](product-docs/target-account-management/setup-tam/target-account-management-overview.md)
         ...
         + [アカウント Insight の設定](product-docs/target-account-management/setup-tam/set-up-account-insight.md)
         + [アカウント Insight プラグインの概要](product-docs/target-account-management/setup-tam/account-insight-plug-in-overview.md)
         + [ユーザーのアカウント Insight へのアクセスへの招待](product-docs/target-account-management/setup-tam/invite-users-to-access-account-insight.md)
      + ターゲット {#target}
         + 特定顧客 {#named-accounts}
            ...
            + [取引先企業との照合](product-docs/target-account-management/target/named-accounts/lead-to-account-matching.md)
      ...
      + 測定 {#measure}
         ...
         + [TAM 販売レポート](product-docs/target-account-management/measure/tam-sales-report.md)
         + [アカウントリストインサイト](product-docs/target-account-management/measure/account-list-insights.md)
         + [RCA の名前付きアカウントDimension](product-docs/target-account-management/measure/named-account-dimension-in-rca.md)
   ...
   + その他のアプリ {#additional-apps}
      + SEO {#seo}
         + SEO の理解 {#understanding-seo}
            + [検索エンジンの最適化について](product-docs/additional-apps/seo/understanding-seo/understanding-search-engine-optimization.md)
            + [SEO ダッシュボードについて：SEORecommendations](product-docs/additional-apps/seo/understanding-seo/understanding-the-seo-dashboard-seo-recommendations.md)
         ...
         + キーワード {#keywords}
            ...
            + [SEO - CSV を使用したキーワードの読み込み](product-docs/additional-apps/seo/keywords/seo-importing-keywords-with-a-csv.md)
         ...
         + ページ数 {#pages}
            ...
            + [SEO — 問題を CSV に書き出す](product-docs/additional-apps/seo/pages/seo-export-issues-to-csv.md)
            + [SEO — ページの問題の削除または削除](product-docs/additional-apps/seo/pages/seo-remove-delete-a-page-issue.md)
            + [SEO — ページの削除/削除](product-docs/additional-apps/seo/pages/seo-remove-delete-a-page.md)
         ...
         + インバウンドリンク {#inbound-links}
            + [SEO — インバウンドリンク URL の手動での追加](product-docs/additional-apps/seo/inbound-links/seo-add-an-inbound-link-url-manually.md)
            + [SEO — リストのインバウンドリンク URL の追加/削除](product-docs/additional-apps/seo/inbound-links/seo-add-remove-an-inbound-link-url-from-a-list.md)
            + [SEO - インバウンドリンク候補の取得](product-docs/additional-apps/seo/inbound-links/seo-get-inbound-link-suggestions.md)
            + [SEO — インバウンドリンク URL の削除または削除](product-docs/additional-apps/seo/inbound-links/seo-remove-delete-an-inbound-link-url.md)
            + [SEO — インバウンドリンクについて](product-docs/additional-apps/seo/inbound-links/seo-understanding-inbound-links.md)
         + レポート {#reports}
            + [SEO — 競合相手 KW トレンドレポートの使用](product-docs/additional-apps/seo/reports/seo-use-the-competitor-kw-trends-report.md)
   ...
   + 管理 {#administration}
      ...
      + 追加の統合 {#additional-integrations}
         ...
         + [次世代マンチキントラッキングに関する FAQ](product-docs/administration/additional-integrations/add-munchkin-tracking-code-to-your-website/next-generation-munchkin-tracking-faq.md)
         ...
         + [facebookによる LaunchPoint サービスとしての Workplace の追加](product-docs/administration/additional-integrations/add-workplace-by-facebook-as-a-launchpoint-service.md)
         ...
         + [BrightTALK をMarketoに接続](product-docs/administration/additional-integrations/connect-brighttalk-to-marketo.md)
         ...
         + [IP ベ許可リストース API アクセス用のの作成](product-docs/administration/additional-integrations/create-an-allowlist-for-ip-based-api-access.md)
      ...
      + 電子メールの設定 {#email-setup}
         + 複数のブランディングドメインの追加 {#add-multiple-branding-domains}
            + [Workspaces を使用した追加のブランディングドメインの追加](product-docs/administration/email-setup/add-multiple-branding-domains/add-an-additional-branding-domain-with-workspaces.md)
         ...
         + [Velocity スクリプティングでのカスタム・オブジェクト取得制限の変更](product-docs/administration/email-setup/change-custom-object-retrieval-limits-in-velocity-scripting.md)
         ...
         + [購読解除メッセージを言語に合わせて動的に設定](product-docs/administration/email-setup/edit-the-unsubscribe-message/make-your-unsubscribe-message-dynamic-for-languages.md)
         + [「Web ページとして表示」メッセージを編集](product-docs/administration/email-setup/edit-the-view-as-web-page-message.md)
         ...
         + [「管理者/電子メール」セクションから登録解除テキストを削除します。](product-docs/administration/email-setup/remove-unsubscribe-text-from-the-admin-email-section.md)
      + フィールド管理 {#field-management}
         + [信頼できないソースからのリストの読み込み中にフィールドの更新をブロックする](product-docs/administration/field-management/block-field-updates-during-list-import-from-untrusted-sources.md)
         ...
         + [リストインポートのフィールド別名の編集](product-docs/administration/field-management/edit-field-aliases-for-list-import.md)
         + [すべてのオブジェクトメタデータを書き出し](product-docs/administration/field-management/export-all-object-metadata.md)
         + [すべてのMarketo API フィールド名のリストの書き出し](product-docs/administration/field-management/export-a-list-of-all-marketo-api-field-names.md)
         ...
         + [フィールドを機密フィールドとしてマーク](product-docs/administration/field-management/mark-a-field-as-sensitive.md)
         ...
         + [Marketoと Salesforce の間のフィールドマッピングの表示](product-docs/administration/field-management/view-field-mappings-between-marketo-and-salesforce.md)
      ...
      + 設定 {#settings}
         + [Analytics のアトリビューション設定の変更](product-docs/administration/settings/change-attribution-settings-for-analytics.md)
         ...
         + [CNAME によるランディングページ URL のカスタマイズ（管理）](product-docs/administration/settings/customize-your-landing-page-urls-with-a-cname-administration.md)
         ...
         + [アカウントのパーソナライズされた URL の有効化（管理）](product-docs/administration/settings/enable-personalized-urls-for-your-account-administration.md)
         + [スパムフォームの送信をブロックする方法](product-docs/administration/settings/how-to-block-spam-form-submissions.md)
         + [IP に基づくMarketoログインの制限](product-docs/administration/settings/restrict-marketo-logins-based-on-ip.md)
      ...
      + ワークスペースとユーザーパーティション {#workspaces-and-person-partitions}
         ...
         + [ワークスペースへの個人パーティションの割り当て](product-docs/administration/workspaces-and-person-partitions/assign-person-partitions-to-workspaces.md)
         ...
         + [ワークスペースおよびパーティション間でのセグメント化の共有](product-docs/administration/workspaces-and-person-partitions/share-segmentations-across-workspaces-and-partitions.md)
   + Marketo の中心概念 {#core-marketo-concepts}
      + スマートキャンペーン {#smart-campaigns}
         ...
         + スマートキャンペーンの使用 {#using-smart-campaigns}
            ...
            + [スマートキャンペーンの名前の変更](product-docs/core-marketo-concepts/smart-campaigns/using-smart-campaigns/rename-a-smart-campaign.md)
         ...
         + Salesforce のフローアクション {#salesforce-flow-actions}
         ...
         + スマートキャンペーンデータ {#smart-campaign-data}
            + [スマートキャンペーンの結果の Excel へのエクスポート](product-docs/core-marketo-concepts/smart-campaigns/smart-campaign-data/export-smart-campaign-results-to-excel.md)
            ...
            + [スマートキャンペーンでのブロックされたユーザーの表示](product-docs/core-marketo-concepts/smart-campaigns/smart-campaign-data/view-blocked-people-in-a-smart-campaign.md)
            + [スマートキャンペーンでの認定ユーザーの表示](product-docs/core-marketo-concepts/smart-campaigns/smart-campaign-data/view-qualified-people-in-a-smart-campaign.md)
      ...
      + スマート・リストと静的リスト {#smart-lists-and-static-lists}
         ...
         + スマートリストの作成 {#creating-a-smart-list}
            + [スマート・リストのベスト・プラクティス](product-docs/core-marketo-concepts/smart-lists-and-static-lists/creating-a-smart-list/best-practices-for-smart-lists.md)
         ...
         + スマート・リストの使用 {#using-smart-lists}
            ...
            + [ワークスペース全体でのリストまたはスマートリストの参照](product-docs/core-marketo-concepts/smart-lists-and-static-lists/using-smart-lists/reference-a-list-or-smart-list-across-workspaces.md)
         ...
         + スマートリストでのユーザーの管理 {#managing-people-in-smart-lists}
            ...
            + [スマートリストまたはリスト内の人物の削除](product-docs/core-marketo-concepts/smart-lists-and-static-lists/managing-people-in-smart-lists/delete-people-in-a-smart-list-or-list.md)
         ...
         + 静的リスト {#static-lists}
            ...
            + [リストのAdobe Experience Cloudへの送信](product-docs/core-marketo-concepts/smart-lists-and-static-lists/static-lists/send-a-list-to-adobe-experience-cloud.md)
      ...
      + プログラム {#programs}
         + プログラムの作成 {#creating-programs}
            ...
            + [「プログラムのホーム」タブの使用](product-docs/core-marketo-concepts/programs/creating-programs/using-the-program-home-tab.md)
         + プログラムの操作 {#working-with-programs}
            ...
            + [スプレッドシートからプログラムにメンバーをインポート](product-docs/core-marketo-concepts/programs/working-with-programs/import-members-from-a-spreadsheet-into-a-program.md)
         ...
         + プログラムスケジュールビュー {#program-schedule-view}
            ...
            + [カスタム・エントリ・タイプの非表示および非表示](product-docs/core-marketo-concepts/programs/program-schedule-view/hiding-and-unhiding-custom-entry-types.md)
            ...
            + [プログラム・スケジュール・ビューのナビゲーション](product-docs/core-marketo-concepts/programs/program-schedule-view/navigating-the-program-schedule-view.md)
            + [プログラム・スケジュール・ビュー・エントリ・タイプ](product-docs/core-marketo-concepts/programs/program-schedule-view/program-schedule-view-entry-types.md)
         ...
         + トークン {#tokens}
            ...
            + [プログラムメンバーのカスタムフィールドトークン](product-docs/core-marketo-concepts/programs/tokens/program-member-custom-field-tokens.md)
      + マーケティングカレンダー {#marketing-calendar}
         ...
         + カレンダーの操作 {#working-with-the-calendar}
            ...
            + [マーケティングカレンダー内のエントリの直接削除](product-docs/core-marketo-concepts/marketing-calendar/working-with-the-calendar/delete-entries-directly-in-the-marketing-calendar.md)
            ...
            + [Workspace によるマーケティングカレンダーのフィルタリング](product-docs/core-marketo-concepts/marketing-calendar/working-with-the-calendar/filtering-the-marketing-calendar-by-workspace.md)
      ...
      + モバイルアプリ {#mobile-apps}
         ...
         + Marketo注目の出来事 {#marketo-moments}
            ...
            + モーメントの操作 {#working-with-moments}
               ...
               + [Marketo Moments のパーソナライズ](product-docs/core-marketo-concepts/mobile-apps/marketo-moments/working-with-moments/personalizing-marketo-moments.md)
               ...
               + [F.一瞬を共有する](product-docs/core-marketo-concepts/mobile-apps/marketo-moments/working-with-moments/sharing-a-moment.md)
      + その他 {#miscellaneous}
         ...
         + [Marketo Asset の名前の変更](product-docs/core-marketo-concepts/miscellaneous/rename-a-marketo-asset.md)
   ...
   + CRM 同期 {#crm-sync}
      + Microsoft Dynamics Sync {#microsoft-dynamics}
         ...
         + 同期設定 {#sync-setup}
            ...
            + [Microsoft Dynamics 用Marketoソリューションの更新](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/update-the-marketo-solution-for-microsoft-dynamics.md)
            + [Microsoft Dynamics Sync の検証](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/validate-microsoft-dynamics-sync.md)
            ...
            + Microsoft Dynamics 365 {#microsoft-dynamics-365}
               + [手順 1/3:Marketoソリューションのインストール（オンライン）](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-365/step-1-of-3-install.md)
               + [手順 2 / 3:Dynamics でのMarketo Sync ユーザーの設定](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-365/step-2-of-3-set-up.md)
         ...
         + カスタム Dynamics 同期フィルタの詳細 {#custom-dynmaics-sync-filter-details}
         ...
         + [Azure でのアプリの登録でクライアント ID/アプリ ID を取得する](product-docs/crm-sync/microsoft-dynamics-sync/register-an-app-with-azure-to-acquire-your-client-id-app-id.md)
      ...
      + Salesforce 同期 {#salesforce-sync}
         ...
         + セットアップ {#setup}
            ...
            + Professional Edition {#professional-edition}
               + [手順 1/3:Salesforce(Professional) へのMarketoフィールドの追加](product-docs/crm-sync/salesforce-sync/setup/professional-edition/step-1-of-3-add-marketo-fields-to-salesforce-professional.md)
               + [手順 2 / 3:Marketo(Professional) 用 Salesforce ユーザーの作成](product-docs/crm-sync/salesforce-sync/setup/professional-edition/step-2-of-3-create-a-salesforce-user-for-marketo-professional.md)
               + [手順 3/3:Marketoと Salesforce(Professional) の接続](product-docs/crm-sync/salesforce-sync/setup/professional-edition/step-3-of-3-connect-marketo-and-salesforce-professional.md)
            + オプションの手順 {#optional-steps}
               + [スマートリスト/制約としてのカスタムオブジェクトフィールドの追加/削除トリガー](product-docs/crm-sync/salesforce-sync/setup/optional-steps/add-remove-custom-object-field-as-smart-list-trigger-constraints.md)
               ...
               + [Marketo同期ユーザーをマーケティングユーザーにする](product-docs/crm-sync/salesforce-sync/setup/optional-steps/enable-disable-campaign-sync/make-marketo-sync-user-a-marketing-user.md)
         ...
         + SFDC 同期の詳細 {#sfdc-sync-details}
            + [既存の Salesforce フィールドのMarketo Sync への追加](product-docs/crm-sync/salesforce-sync/sfdc-sync-details/add-an-existing-salesforce-field-to-the-marketo-sync.md)
            + [デフォルトの Salesforce フィールドマッピング](product-docs/crm-sync/salesforce-sync/sfdc-sync-details/default-salesforce-field-mapping.md)
            + [Marketo Sync に対する Salesforce フィールドの非表示](product-docs/crm-sync/salesforce-sync/sfdc-sync-details/hide-a-salesforce-field-from-the-marketo-sync.md)
            ...
            + [SFDC 同期：Salesforce でのリードの連絡先への変換](product-docs/crm-sync/salesforce-sync/sfdc-sync-details/sfdc-sync-converting-a-lead-into-a-contact-in-salesforce.md)
            + [SFDC 同期：カスタムオブジェクト同期](product-docs/crm-sync/salesforce-sync/sfdc-sync-details/sfdc-sync-custom-object-sync.md)
            + [SFDC 同期：リード/連絡先の削除](product-docs/crm-sync/salesforce-sync/sfdc-sync-details/sfdc-sync-deleting-a-lead-contact.md)
            + [SFDC 同期：フィールド同期](product-docs/crm-sync/salesforce-sync/sfdc-sync-details/sfdc-sync-field-sync.md)
            ...
            + [SFDC 同期：リード同期](product-docs/crm-sync/salesforce-sync/sfdc-sync-details/sfdc-sync-lead-sync.md)
            + [SFDC 同期：リード/連絡先/個人のマージ](product-docs/crm-sync/salesforce-sync/sfdc-sync-details/sfdc-sync-merging-a-lead-contact-person.md)
            + [SFDC 同期：オポチュニティ同期](product-docs/crm-sync/salesforce-sync/sfdc-sync-details/sfdc-sync-opportunity-sync.md)
         ...
         + [暗黙の Salesforce アクション](product-docs/crm-sync/salesforce-sync/implied-salesforce-actions.md)
   ...
   + 需要生成 {#demand-generation}
      ...
      + イベント {#events}
         ...
         + イベントの作成 {#create-an-event}
            ...
            + [GotoWeb セミナーでのイベントの作成](product-docs/demand-generation/events/create-an-event/create-an-event-with-gotowebinar.md)
            + [レベル 3 の Web 会議でイベントを作成する](product-docs/demand-generation/events/create-an-event/create-an-event-with-level-3-web-meeting.md)
            ...
            + Marketo ON24 アダプターを使用したイベントの作成 {#create-an-event-with-the-marketo-on24-adapter}
               ...
               + [Marketoでの ON24 資格情報の入力](product-docs/demand-generation/events/create-an-event/create-an-event-with-the-marketo-on24-adapter/enter-your-on24-credentials-in-marketo.md)
      ...
      + Facebook {#facebook}
         ...
         + [facebookとMarketoの統合のための Lead Ads のテスト](product-docs/demand-generation/facebook/test-facebook-lead-ads-for-desktop-integration-with-marketo.md)
         + [facebook Lead Ads をMarketoとのモバイル統合用にテスト](product-docs/demand-generation/facebook/test-facebook-lead-ads-for-mobile-integration-with-marketo.md)
         + [facebook Offline Conversions について](product-docs/demand-generation/facebook/understanding-facebook-offline-conversions.md)
      ...
      + Forms {#forms}
         + フォームの作成 {#creating-a-form}
            ...
            + [フォームのフィールドラベルの編集](product-docs/demand-generation/forms/creating-a-form/edit-a-field-label-in-a-form.md)
         ...
         + フォーム アクション {#form-actions}
            ...
            + [フォーム内のラジオフィールドまたは選択フィールドの値の定義](product-docs/demand-generation/forms/form-actions/define-values-in-a-radio-or-selected-field-in-a-form.md)
      ...
      + ランディングページ {#landing-pages}
         ...
         + 自由形式のランディングページ {#free-form-landing-pages}
            ...
            + [自由形式のランディングページでの画像へのリンクの追加](product-docs/demand-generation/landing-pages/free-form-landing-pages/add-a-link-to-an-image-in-a-free-form-landing-page.md)
            ...
            + [自由形式のランディングページへの Social ボタンの追加](product-docs/demand-generation/landing-pages/free-form-landing-pages/add-a-social-button-to-a-free-form-landing-page.md)
         ...
         + ランディングページのアクション {#landing-page-actions}
            + [複数のランディングページの一度の承認](product-docs/demand-generation/landing-pages/landing-page-actions/approve-multiple-landing-pages-at-once.md)
            ...
            + [CNAME によるランディングページ URL のカスタマイズ](product-docs/demand-generation/landing-pages/landing-page-actions/customize-your-landing-page-urls-with-a-cname.md)
         ...
         + ランディングページ テンプレート {#landing-page-templates}
            ...
            + [既存の自由形式ランディングページテンプレートのモバイルとの互換性の設定](product-docs/demand-generation/landing-pages/landing-page-templates/make-an-existing-free-form-landing-page-template-mobile-compatible.md)
         ...
         + ランディングページのパーソナライズ {#personalizing-landing-pages}
            ...
            + [ランディングページ CNAME の追加](product-docs/demand-generation/landing-pages/personalizing-landing-pages/add-additional-landing-page-cnames.md)
            ...
            + [パーソナライズされた URL を含むリストの書き出し](product-docs/demand-generation/landing-pages/personalizing-landing-pages/export-a-list-with-personalized-urls.md)
      ...
      + ソーシャル {#social}
         + ソーシャルアクションの設定 {#configuring-social-actions}
            ...
            + [電子メールの再共有の設定とソーシャルアプリの入力を求める](product-docs/demand-generation/social/configuring-social-actions/configure-re-share-email-and-prompt-for-a-social-app.md)
            + [Social の推奨フローの設定](product-docs/demand-generation/social/configuring-social-actions/configure-social-recommend-flow.md)
            ...
            + [紹介オファーの進捗状況フローの追跡の設定](product-docs/demand-generation/social/configuring-social-actions/configure-track-progress-flow-for-a-referral-offer.md)
            + [Social ボタンを開くタイミングの設定](product-docs/demand-generation/social/configuring-social-actions/configure-when-social-button-opens.md)
         ...
         + ポーリングの作成 {#creating-a-poll}
            ...
            + [投票の投票数の確認](product-docs/demand-generation/social/creating-a-poll/review-votes-cast-in-poll.md)
         + 紹介オファー {#referral-offers}
            ...
            + [紹介オファーの受け渡し電子メールの送信](product-docs/demand-generation/social/referral-offers/send-referral-offer-fulfillment-email.md)
   ...
   + メールマーケティング {#email-marketing}
      + 到達率 {#deliverability}
         ...
         + [E メール配信品質パワーパック：シードリストのインポート方法](product-docs/email-marketing/deliverability/email-deliverability-power-pack-how-to-import-a-seedlist.md)
         + [E メール配信品質ツール](product-docs/email-marketing/deliverability/email-deliverability-tool.md)
         ...
         + [E メール配信品質の SPF と DKIM の設定](product-docs/email-marketing/deliverability/set-up-spf-and-dkim-for-your-email-deliverability.md)
      ...
      + 点滴育成 {#drip-nurturing}
         ...
         + エンゲージメントプログラムストリーム {#engagement-program-streams}
            ...
            + [受信者のタイムゾーンに基づくエンゲージメントプログラムのスケジュール](product-docs/email-marketing/drip-nurturing/engagement-program-streams/set-stream-cadence/schedule-engagement-programs-with-recipient-time-zone.md)
         ...
         + エンゲージメントプログラムの使用 {#using-engagement-programs}
            ...
            + [エンゲージメントプログラムでのユーザーの一時停止](product-docs/email-marketing/drip-nurturing/using-engagement-programs/pause-people-in-an-engagement-program.md)
      ...
      + メールプログラム {#email-programs}
         ...
         + 電子メールプログラムのアクション {#email-program-actions}
            ...
            + 電子メールテスト — A/B テスト {#email-test-a-b-test}
               ...
               + [「日付/時刻」A/B テストの使用](product-docs/email-marketing/email-programs/email-program-actions/email-test-a-b-test/use-date-time-a-b-testing.md)
            ...
            + [E メールの移動](product-docs/email-marketing/email-programs/email-program-actions/move-an-email.md)
      ...
      + 一般 {#general}
         + E メールエディタについて {#understanding-the-email-editor}
         ...
         + E メールエディタ 2 {#email-editor-2}
            ...
            + [電子メールの要素の編集](product-docs/email-marketing/general/email-editor-2/edit-elements-in-an-email.md)
            ...
            + [E メールエディター 2.0 への移行](product-docs/email-marketing/general/email-editor-2/transitioning-to-email-editor-2-0.md)
         + エディタの機能 {#functions-in-the-editor}
            + [電子メール内の友達リンクへの転送](product-docs/email-marketing/general/functions-in-the-editor/forward-to-a-friend-link-in-emails.md)
            ...
            + [E メールでの動的コンテンツの使用](product-docs/email-marketing/general/functions-in-the-editor/using-dynamic-content-in-an-email.md)
            + [電子メールへのスニペットの追加](product-docs/email-marketing/general/functions-in-the-editor/add-a-snippet-to-an-email.md)
            + [電子メールへの Web ページリンクとしての表示の追加](product-docs/email-marketing/general/functions-in-the-editor/add-a-view-as-web-page-link-to-an-email.md)
            + [電子メールテンプレート v1.0 への編集可能なセクションの追加](product-docs/email-marketing/general/functions-in-the-editor/add-editable-sections-to-email-templates-v1-0.md)
         ...
         + トークン {#using-tokens} の使用
            + [システムトークンを電子メール内のリンクとして追加](product-docs/email-marketing/general/using-tokens/add-a-system-token-as-a-link-in-an-email.md)
   ...
   + Marketo セールスの連携 {#marketo-sales-connect}
      + 開始方法 {#getting-started}
         ...
         + メール設定 {#email-settings}
            ...
            + [確認電子メールを受信しない](product-docs/marketo-sales-connect/getting-started/email-settings/never-received-a-verification-email.md)
      ...
      + 管理 {#admin}
         ...
         + [Sales Connect での SAML 2.0 を使用した SSO の設定](product-docs/marketo-sales-connect/admin/setting-up-sso-through-saml-2-0-in-sales-connect.md)
      ...
      + CRM {#crm}
         + Salesforce のカスタマイズ {#salesforce-customization}
            ...
            + [Sales Connect データを使用した Salesforce 優先度呼び出しレポートの作成](product-docs/marketo-sales-connect/crm/salesforce-customization/create-a-salesforce-priority-call-report-with-sales-connect-data.md)
            ...
            + [Professional Edition のお客様向け Salesforce カスタマイズのインストール](product-docs/marketo-sales-connect/crm/salesforce-customization/install-salesforce-customization-for-professional-edition-customers.md)
            ...
            + [Salesforce Classic でのバルクアクションの使用](product-docs/marketo-sales-connect/crm/salesforce-customization/using-bulk-actions-in-salesforce-classic.md)
            + [Salesforce Lightning でのバルクアクションの使用](product-docs/marketo-sales-connect/crm/salesforce-customization/using-bulk-actions-in-salesforce-lightning.md)
      ...
      + 電子メールプラグイン {#email-plugins}
         + Gmail {#gmail}
            + [Salesforce への電子メールの追加](product-docs/marketo-sales-connect/email-plugins/gmail/add-email-to-salesforce.md)
            + [コンテンツのアタッチ](product-docs/marketo-sales-connect/email-plugins/gmail/attaching-a-piece-of-content.md)
            ...
            + [ToutApp ブラウザー拡張機能のインストール方法](product-docs/marketo-sales-connect/email-plugins/gmail/how-to-install-the-toutapp-browser-extension.md)
            + [Gmail からの電子メールの送信方法](product-docs/marketo-sales-connect/email-plugins/gmail/how-to-send-an-email-from-gmail.md)
            + [Gmail から Sales Connect をアンインストールする方法](product-docs/marketo-sales-connect/email-plugins/gmail/how-to-uninstall-sales-connect-from-gmail.md)
         ...
         + Outlook 用 MSC {#msc-for-outlook}
            ...
            + .NET レガシーアドイン {#net-legacy-add-in}
      ...
      + メール {#email}
         + コマンドセンター {#command-center}
            ...
            + [チーム・メンバーへのタスクの割当](product-docs/marketo-sales-connect/email/command-center/assigning-tasks-to-team-members.md)
            + [E メール列と E メールページレイアウト](product-docs/marketo-sales-connect/email/command-center/email-columns-and-email-page-layout.md)
         ...
         + トラッキングに関するよくある質問 {#common-tracking-questions}
            ...
            + [表示されていない電子メールをテスト](product-docs/marketo-sales-connect/email/common-tracking-questions/test-email-not-showed-as-viewed.md)
         ...
         + 配信停止 {#unsubscribes}
            ...
            + [Salesforce との購読解除の同期](product-docs/marketo-sales-connect/email/unsubscribes/syncing-unsubscribes-with-salesforce.md)
         ...
         + 構成ウィンドウの使用 {#using-the-compose-window}
            + [電子メールへの添付ファイルまたは追跡可能なコンテンツの追加](product-docs/marketo-sales-connect/email/using-the-compose-window/add-an-attachment-or-trackable-content-to-your-email.md)
            + [E メールへのハイスポットコンテンツの追加](product-docs/marketo-sales-connect/email/using-the-compose-window/adding-highspot-content-to-your-email.md)
      ...
      + FAQ {#faq}
         ...
         + [Sales Connect のサービス利用条件は何ですか？](product-docs/marketo-sales-connect/faq/what-are-the-sales-connect-terms-of-service.md)
         + [Sales Connect と Highspot の統合とは](product-docs/marketo-sales-connect/faq/what-is-the-sales-connect-and-highspot-integration.md)
         + [Sales Connect に連絡先がプッシュされないのはなぜですか。](product-docs/marketo-sales-connect/faq/why-arent-any-of-my-contacts-getting-pushed-to-sales-connect.md)
         + [連絡先を削除できないのはなぜですか？](product-docs/marketo-sales-connect/faq/why-cant-i-delete-a-contact.md)
         + [すべての連絡先が Sales Connect にプッシュされないのはなぜですか。](product-docs/marketo-sales-connect/faq/why-didnt-all-of-my-contacts-get-pushed-to-sales-connect.md)
      + 統合 {#integrations}
         + [他の CRM に電子メールを記録する方法](product-docs/marketo-sales-connect/integrations/how-to-log-emails-to-other-crms.md)
      + Marketo {#marketo}
      ...
      + 電話 {#phone}
         + [呼び出しが Salesforce にログに記録されない](product-docs/marketo-sales-connect/phone/calls-arent-logging-to-salesforce.md)
         + [アクティビティ履歴にログを記録しなかった](product-docs/marketo-sales-connect/phone/didnt-log-to-activity-history.md)
         + [Salesforce にログインしなかった](product-docs/marketo-sales-connect/phone/didnt-log-to-salesforce.md)
         + [通話記録の有効化](product-docs/marketo-sales-connect/phone/enable-call-recording.md)
         + [営業電話での通話の結果をカスタマイズする方法](product-docs/marketo-sales-connect/phone/how-to-customize-the-call-outcome-in-sales-phone.md)
         ...
         + [営業電話の概要](product-docs/marketo-sales-connect/phone/sales-phone-overview.md)
   ...
   + Marketoセールスインサイト {#marketo-sales-insight}
      ...
      + MSI Chrome プラグイン {#msi-chrome-plugin}
         + [Google Chrome 用Marketo Insights のインストール](product-docs/marketo-sales-insight/msi-chrome-plugin/install-marketo-insights-for-google-chrome.md)
      ...
      + Microsoft Dynamics 用 MSI {#msi-for-microsoft-dynamics}
         ...
         + インストール中 {#installing}
            + [Microsoft Dynamics 用Marketo Sales Insight Solution のダウンロード](product-docs/marketo-sales-insight/msi-for-microsoft-dynamics/installing/download-the-marketo-sales-insight-solution-for-microsoft-dynamics.md)
         ...
         + {#setting-up-and-using} の設定と使用
            ...
            + [Marketoと Dynamics を同期するための必須フィールド](product-docs/marketo-sales-insight/msi-for-microsoft-dynamics/setting-up-and-using/required-fields-for-syncing-marketo-with-dynamics.md)
            + [Microsoft Dynamics からのMarketoの販売の電子メールの送信](product-docs/marketo-sales-insight/msi-for-microsoft-dynamics/setting-up-and-using/send-a-marketo-sales-email-from-microsoft-dynamics.md)
         ...
         + 更新しています {#updating}
            + [Microsoft Dynamics 用Marketo Sales Insight ソリューションのアップグレード](product-docs/marketo-sales-insight/msi-for-microsoft-dynamics/updating/upgrade-the-marketo-sales-insight-solution-for-microsoft-dynamics.md)
      + Salesforce 用 MSI {#msi-for-salesforce}
         + インストール {#installation}
         ...
         + 構成 {#configuration}
            ...
            + [Salesforce の「Marketo Sales Insight Configuration」タブ](product-docs/marketo-sales-insight/msi-for-salesforce/configuration/marketo-sales-insight-configuration-tab-in-salesforce.md)
            + [Marketo管理者向けの Sales Insight ページ](product-docs/marketo-sales-insight/msi-for-salesforce/configuration/sales-insight-page-for-marketo-admins.md)
         ...
         + 機能 {#features}
            ...
            + MSI パネルの操作 {#actions-in-the-msi-panel}
               ...
               + [Marketo Sales Insight での購読解除フッターの設定](product-docs/marketo-sales-insight/msi-for-salesforce/features/actions-in-the-msi-panel/send-marketo-email/configure-unsubscribe-footers-in-marketo-sales-insight.md)
            ...
            + バルクアクション {#bulk-actions}
               ...
               + [Salesforce Lightning のバルクアクション](product-docs/marketo-sales-insight/msi-for-salesforce/features/bulk-actions/bulk-actions-in-salesforce-lightning.md)
               + [Marketo Sales Insight での複数レコードへの電子メールの送信](product-docs/marketo-sales-insight/msi-for-salesforce/features/bulk-actions/send-an-email-to-multiple-records-in-marketo-sales-insight.md)
            ...
            + MSI 構成タブ {#msi-configuration-tab}
            ...
            + MSI パネルのタブ {#tabs-in-the-msi-panel}
               + [「E メール」タブ](product-docs/marketo-sales-insight/msi-for-salesforce/features/tabs-in-the-msi-panel/email-tab.md)
         ...
         + モバイル用 MSI {#msi-for-mobile}
            ...
            + [Salesforce1 でのMarketo Sales Insight のインストールと設定](product-docs/marketo-sales-insight/msi-for-salesforce/msi-for-mobile/install-and-configure-marketo-sales-insight-in-salesforce1.md)
      ...
      + MSI Outlook プラグイン {#msi-outlook-plugin}
         ...
         + [エンタープライズキーを使用した Outlook 用Marketoアドインのインストール](product-docs/marketo-sales-insight/msi-outlook-plugin/install-the-marketo-add-in-for-outlook-with-an-enterprise-key.md)
         + [登録コードを使用した Outlook 用Marketo電子メールアドインのインストール](product-docs/marketo-sales-insight/msi-outlook-plugin/install-the-marketo-email-add-in-for-outlook-with-a-registration-code.md)
         + [Marketo E メールアドインのライセンスの発行](product-docs/marketo-sales-insight/msi-outlook-plugin/issue-a-marketo-email-add-in-license.md)
         + [IT によるMarketo Outlook プラグインのインストール](product-docs/marketo-sales-insight/msi-outlook-plugin/marketo-outlook-plugin-installation-by-it.md)
         + [Marketo Outlook プラグインの IT によるアンインストール](product-docs/marketo-sales-insight/msi-outlook-plugin/marketo-outlook-plugin-uninstall-by-it.md)
      ...
      + [ネイティブ以外の Salesforce 統合に関するセールス・インサイト](product-docs/marketo-sales-insight/sales-insight-for-non-native-salesforce-integrations.md)
   ...
   + モバイルマーケティング {#mobile-marketing}
      + 管理 {#admin}
         ...
         + [LaunchPoint サービスとしての Vibe の追加](product-docs/mobile-marketing/admin/add-vibes-as-a-launchpoint-service.md)
      ...
      + Vibes SMS メッセージ {#vibes-sms-messages}
         ...
         + [スマートリストのメッセージとフィルターでの Vibes SMSトリガーの使用](product-docs/mobile-marketing/vibes-sms-messages/use-vibes-sms-messages-in-smart-list-triggers-and-filters.md)
   + パーソナライゼーション {#personalization}
      + セグメント化とスニペット {#segmentation-and-snippets}
         + セグメンテーション {#segmentation}
            ...
            + [セグメント化の優先順位](product-docs/personalization/segmentation-and-snippets/segmentation/segmentation-order-priority.md)
   ...
   + 予測コンテンツ {#predictive-content}
      ...
      + [Predictive Content Analytics の概要](product-docs/predictive-content/predictive-content-analytics-overview.md)
      + 開始方法 {#getting-started}
      ...
      + 予測コンテンツの有効化 {#enabling-predictive-content}
         ...
         + [E メールでの予測コンテンツの有効化](product-docs/predictive-content/enabling-predictive-content/enable-predictive-content-in-emails.md)
   ...
   + レポート {#reporting}
      + 基本レポート {#basic-reporting}
         + レポートの作成 {#creating-reports}
            ...
            + [Analytics ホームページへの移動](product-docs/reporting/basic-reporting/creating-reports/navigating-the-analytics-home-page.md)
         ...
         + レポートアクティビティ {#report-activity}
            ...
            + [レポート電子メールの URL の有効期限の変更](product-docs/reporting/basic-reporting/report-activity/change-the-expiration-time-for-urls-in-report-emails.md)
            ...
            + [Web レポートでのユーザーまたは匿名訪問者の表示](product-docs/reporting/basic-reporting/report-activity/display-people-or-anonymous-visitors-in-web-reports.md)
            + [「個人実績」レポートのドリル・ダウン](product-docs/reporting/basic-reporting/report-activity/drill-down-in-a-people-performance-report.md)
            ...
            + [ワークスペース全体での電子メールのレポート、キャンペーンのパフォーマンス](product-docs/reporting/basic-reporting/report-activity/report-email-campaign-performance-across-workspaces.md)
         ...
         + 購読のレポート {#report-subscriptions}
            + [スマートリストサブスクリプションの編集](product-docs/reporting/basic-reporting/report-subscriptions/edit-a-smart-list-subscription.md)
         ...
         + レポートのタイプ {#report-types}
            ...
            + [表示された Web ページ、Web ページアクティビティレポート](product-docs/reporting/basic-reporting/report-types/web-page-activity-report/web-pages-viewed-web-page-activity-report.md)
      + メールインサイト {#email-insights}
         ...
         + [電子メールインサイトに関する FAQ](product-docs/reporting/email-insights/email-insights-faq.md)
      ...
      + 売上高サイクル分析 {#revenue-cycle-analytics}
         ...
         + プログラム分析 {#program-analytics}
            ...
            + [リードをリストするプログラムメンバーシップ分析レポートの作成](product-docs/reporting/revenue-cycle-analytics/program-analytics/build-a-program-membership-analysis-report-that-lists-leads.md)
            ...
            + [期間コストなしでプログラムを収益エクスプローラおよびアナライザーで使用できるようにする](product-docs/reporting/revenue-cycle-analytics/program-analytics/make-a-program-without-a-period-cost-available-in-revenue-explorer-and-analyzers.md)
            + [プログラムレベルでの Analytics の動作の上書き](product-docs/reporting/revenue-cycle-analytics/program-analytics/override-analytics-behavior-at-the-program-level.md)
            + [プログラム・コスト分析領域の理解](product-docs/reporting/revenue-cycle-analytics/program-analytics/understanding-the-program-cost-analysis-area.md)
         ...
         + 収益サイクルモデル {#revenue-cycle-models}
            ...
            + [収益モデルの SLA ステージの使用](product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/using-revenue-model-sla-stages.md)
         ...
         + 収益エクスプローラ {#revenue-explorer}
            ...
            + [収益エクスプローラ・レポートの保存](product-docs/reporting/revenue-cycle-analytics/revenue-explorer/saving-a-revenue-explorer-report.md)
         ...
         + 収益ツール {#revenue-tools}
            ...
            + [「収益ステージ別ユーザー」レポート](product-docs/reporting/revenue-cycle-analytics/revenue-tools/people-by-revenue-stage-report.md)
            + 属性 {#attribution}
   ...
   + Web パーソナライゼーション {#web-personalization}
      ...
      + 開始方法 {#getting-started}
         ...
         + [追跡しない Web パーソナライゼーションの設定](product-docs/web-personalization/getting-started/setting-web-personalization-to-do-not-track.md)
      ...
      + RTP タグ実装 {#rtp-tag-implementation}
         ...
         + [Marketoランディングページでの RTP の実装](product-docs/web-personalization/rtp-tag-implementation/implementing-rtp-on-marketo-landing-pages.md)
         ...
         + [Adobe Tag Managerを使用した RTP の実装](product-docs/web-personalization/rtp-tag-implementation/implementing-rtp-using-adobe-tag-manager.md)
         + [Google Tag Manager を使用した RTP の実装](product-docs/web-personalization/rtp-tag-implementation/implementing-rtp-using-google-tag-manager.md)
      ...
      + Web パーソナライゼーションのレポート {#reporting-for-web-personalization}
         ...
         + [特定の IP を追跡から除外](product-docs/web-personalization/reporting-for-web-personalization/exclude-specific-ips-from-being-tracked.md)
      ...
      + Web パーソナライゼーションについて {#understanding-web-personalization}
         ...
         + [Web パーソナライゼーションの用語集](product-docs/web-personalization/understanding-web-personalization/web-personalization-glossary.md)
      ...
      + Web キャンペーンの操作 {#working-with-web-campaigns}
         ...
         + [Web キャンペーンのスケジュール](product-docs/web-personalization/working-with-web-campaigns/schedule-a-web-campaign.md)
         + [Web キャンペーンの表示方法の設定](product-docs/web-personalization/working-with-web-campaigns/set-how-your-web-campaign-displays.md)
         + [最新または最高のパフォーマンスで Web キャンペーンを並べ替える](product-docs/web-personalization/working-with-web-campaigns/sort-web-campaigns-by-latest-or-top-performing.md)
...
+ リリースノート {#release-notes}
   ...
   + 以前のリリース {#previous-releases}
      + 2021 {#2021}
         ...
         + [リリースノート：2021 年 5 月](release-notes/previous-releases/2021/release-notes-may-21.md)
         + [リリースノート：21 年 8 月](release-notes/previous-releases/2021/release-notes-aug-21.md)
      + 2020 {#2020}
         + [リリースノート：20 年 1 月](release-notes/previous-releases/2020/release-notes-jan-20.md)
         + [リリースノート：2020 年 2 月](release-notes/previous-releases/2020/release-notes-feb-20.md)
         + [リリースノート：20 年 6 月](release-notes/previous-releases/2020/release-notes-june-20.md)
      ...
      + 2019 {#2019}
         ...
         + [リリースノート：2019 年 6 月](release-notes/previous-releases/2019/release-notes-june-19.md)
         + [リリースノート：19 年春](release-notes/previous-releases/2019/release-notes-spring-19.md)
         + [リリースノート：19年冬](release-notes/previous-releases/2019/release-notes-winter-19.md)
      + 2018 {#2018}
         + [リリースノート：18 年秋](release-notes/previous-releases/2018/release-notes-fall-18.md)
         + [リリースノート：春&#39;18](release-notes/previous-releases/2018/release-notes-spring-18.md)
         + [リリースノート：18年冬](release-notes/previous-releases/2018/release-notes-winter-18.md)
      + 2017 {#2017}
         + [リリースノート：2017 年 4 月 ABM の機能強化](release-notes/previous-releases/2017/release-notes-april-17-abm-enhancements.md)
         + [リリースノート：2017年8月 ABM の機能強化](release-notes/previous-releases/2017/release-notes-august-17-abm-enhancements.md)
         + [リリースノート：2017 年秋](release-notes/previous-releases/2017/release-notes-fall-17.md)
         + [リリースノート：Spring &#39;17](release-notes/previous-releases/2017/release-notes-spring-17.md)
         + [リリースノート：2017 年夏](release-notes/previous-releases/2017/release-notes-summer-17.md)
         + [リリースノート：17年冬](release-notes/previous-releases/2017/release-notes-winter-17.md)
      + 2016 {#2016}
         + [リリースノート：2016 年秋](release-notes/previous-releases/2016/release-notes-fall-16.md)
         + [リリースノート：春&#39;16](release-notes/previous-releases/2016/release-notes-spring-16.md)
         + [リリースノート：2016 年夏](release-notes/previous-releases/2016/release-notes-summer-16.md)
      ...
      + 2015 {#2015}
         ...
         + [リリースノート：2015 年秋](release-notes/previous-releases/2015/release-notes-fall-15.md)
