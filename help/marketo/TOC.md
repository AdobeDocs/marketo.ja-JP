   ...
   + 管理 {#administration}
      ...
      + Marketo と Adobe ID {#marketo-with-adobe-identity}
         ...
         + サブスクリプションとユーザの移行 {#subscription-and-user-migration}
            ...
            + [Marketo Engageサポートの移行](product-docs/administration/marketo-with-adobe-identity/subscription-and-user-migration/support-migration.md)
      + 設定 {#settings}
   ...
   + 需要創出 {#demand-generation}
      ...
      + Dynamic Chat {#dynamic-chat}
         ...
         + 設定 {#setup-and-configuration}
            ...
            + [使用の制限](product-docs/demand-generation/dynamic-chat/setup-and-configuration/usage-limits.md)
      ...
      + イベント {#events}
         ...
         + インタラクティブウェビナー {#interactive-webinars}
            ...
            + [インタラクティブなウェビナーの配信](product-docs/demand-generation/events/interactive-webinars/deliver-an-interactive-webinar.md)
            ...
            + [部屋の管理](product-docs/demand-generation/events/interactive-webinars/room-management.md)
...
+ リリースノート {#release-notes}
   ...
   + 以前のリリース {#previous-releases}
      + 2024年 {#2024}
         ...
         + [リリースノート：2024 年 6 月](release-notes/previous-releases/2024/release-notes-june-24.md)
      + 2023年 {#2023}
