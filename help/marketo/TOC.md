...
+ 製品ドキュメント{#product-docs}
   ...
   + 管理 {#administration}
      ...
      + 追加の統合{#additional-integrations}
         ...
         + [Google AdWords を LaunchPoint サービスとして追加する](product-docs/administration/additional-integrations/add-google-adwords-as-a-launchpoint-service.md)
      ...
      + AdobeID {#marketo-with-adobe-identity}を持つMarketo
   ...
   + Marketo の中心概念 {#core-marketo-concepts}
      ...
      + スマートリストと静的リスト{#smart-lists-and-static-lists}
         ...
         + スマートリストの作成{#creating-a-smart-list}
            ...
            + [スマートリストフィルターを定義する](product-docs/core-marketo-concepts/smart-lists-and-static-lists/creating-a-smart-list/define-smart-list-filters.md)
            + [フィルターを検索してスマートリストに追加する](product-docs/core-marketo-concepts/smart-lists-and-static-lists/creating-a-smart-list/find-and-add-filters-to-a-smart-list.md)
   ...
   + 需要生成{#demand-generation}
      ...
      + イベント {#events}
         ...
         + イベント{#create-an-event}の作成
            ...
            + Marketo ON24 アダプターを使用したイベントの作成 {#create-an-event-with-the-marketo-on24-adapter}
               ...
               + [ウェビナープログラムステータスについて](product-docs/demand-generation/events/create-an-event/create-an-event-with-the-marketo-on24-adapter/understanding-webinar-program-statuses.md)
      + Facebook {#facebook}
      ...
      + フォーム {#forms}
         ...
         + フォームデザイン{#form-design}
            ...
            + [フォームテーマの CSS を編集する](product-docs/demand-generation/forms/form-design/edit-the-css-of-a-form-theme.md)
      ...
      + ランディングページ {#landing-pages}
         ...
         + フリーフォームのランディングページ{#free-form-landing-pages}
            ...
            + [フリーフォームランディングページに新しいフォームを追加する](product-docs/demand-generation/landing-pages/free-form-landing-pages/add-a-new-form-to-a-free-form-landing-page.md)
            ...
            + [フリーフォームランディングページデザインのガイドを使用する](product-docs/demand-generation/landing-pages/free-form-landing-pages/use-guides-for-free-form-landing-page-design.md)
         + ガイド付きランディングページ{#guided-landing-pages}
            + [ガイド付きランディングページにフォームを追加する](product-docs/demand-generation/landing-pages/guided-landing-pages/add-a-form-to-a-guided-landing-page.md)
         ...
         + ランディングページのアクション {#landing-page-actions}
            ...
            + [ランディングページの効果レポートをフィルターする](product-docs/demand-generation/landing-pages/landing-page-actions/filter-a-landing-page-performance-report.md)
            ...
            + [ランディングページをプレビューする](product-docs/demand-generation/landing-pages/landing-page-actions/preview-a-landing-page.md)
         ...
         + ランディングページ テンプレート {#landing-page-templates}
            + [フリーフォームランディングページテンプレートを作成する](product-docs/demand-generation/landing-pages/landing-page-templates/create-a-free-form-landing-page-template.md)
            + [ガイド付きランディングページテンプレートを作成する](product-docs/demand-generation/landing-pages/landing-page-templates/create-a-guided-landing-page-template.md)
            ...
            + ガイド付きランディングページテンプレート{#guided-landing-page-templates}
               + [テンプレート 1-A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-1-a.md)
               + [テンプレート 1-B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-1-b.md)
               + [テンプレート 1-C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-1-c.md)
               + [テンプレート 1-D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-1-d.md)
               + [テンプレート 1-E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-1-e.md)
               + [テンプレート 1-F](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-1-f.md)
               + [テンプレート 2-A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-2-a.md)
               + [テンプレート 2-B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-2-b.md)
               + [テンプレート 2-C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-2-c.md)
               + [テンプレート 2-D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-2-d.md)
               + [テンプレート 3-A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-3-a.md)
               + [テンプレート 3-B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-3-b.md)
               + [テンプレート 3-C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-3-c.md)
               + [テンプレート 3-D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-3-d.md)
               + [テンプレート 4-A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-4-a.md)
               + [テンプレート 4-B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-4-b.md)
               + [テンプレート 4-C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-4-c.md)
               + [テンプレート 5-A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-5-a.md)
               + [テンプレート 5-B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-5-b.md)
               + [テンプレート 5-C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-5-c.md)
               + [テンプレート 5-D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-5-d.md)
               + [テンプレート 5-E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-5-e.md)
               + [テンプレート 6-A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-6-a.md)
               + [テンプレート 6-B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-6-b.md)
               + [テンプレート 6-C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-6-c.md)
               + [テンプレート 6-D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-6-d.md)
               + [テンプレート 6-E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-6-e.md)
               + [テンプレート 7-A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-7-a.md)
               + [テンプレート 7-B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-7-b.md)
               + [テンプレート 7-C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-7-c.md)
               + [テンプレート 7-D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-7-d.md)
               + [テンプレート 7-E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-7-e.md)
               + [テンプレート 7-F](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-7-f.md)
               + [テンプレート 8-A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-8-a.md)
               + [テンプレート 8-B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-8-b.md)
               + [テンプレート 8-C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-8-c.md)
               + [テンプレート 8-D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-8-d.md)
               + [テンプレート 8-E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-8-e.md)
               + [テンプレート 8-F](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-8-f.md)
               ...
               + [テンプレート 9-A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-9-a.md)
               + [テンプレート 9-B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-9-b.md)
               + [テンプレート 9-C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-9-c.md)
               + [テンプレート 9-D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-9-d.md)
               + [テンプレート 9-E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-9-e.md)
               + [テンプレート 9-F](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-9-f.md)
               + [テンプレート 10-A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-10-a.md)
               + [テンプレート 10-B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-10-b.md)
               + [テンプレート 10-C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-10-c.md)
               + [テンプレート 10-D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-10-d.md)
               + [テンプレート 10-E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-10-e.md)
               + [テンプレート 10-F](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-10-f.md)
               + [テンプレート 11-A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-11-a.md)
               + [テンプレート 11-B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-11-b.md)
               + [テンプレート 11-C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-11-c.md)
               + [テンプレート 11-D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-11-d.md)
               + [テンプレート 11-E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-11-e.md)
               + [テンプレート 11-F](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-11-f.md)
               + [テンプレート 12-A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-12-a.md)
               + [テンプレート 12-B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-12-b.md)
               + [テンプレート 12-C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-12-c.md)
               + [テンプレート 12-D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-12-d.md)
               + [テンプレート 12-E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-12-e.md)
               + [テンプレート 12-F](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-12-f.md)
               + [テンプレート 13-A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-13-a.md)
               + [テンプレート 13-B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-13-b.md)
               + [テンプレート 13-C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-13-c.md)
               + [テンプレート 13-D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-13-d.md)
               + [テンプレート 13-E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-13-e.md)
               + [テンプレート 14-A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-14-a.md)
               + [テンプレート 14-B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-14-b.md)
               + [テンプレート 14-C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-14-c.md)
               + [テンプレート 14-D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-14-d.md)
               + [テンプレート 14-E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-14-e.md)
               + [テンプレート 15-A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-15-a.md)
               + [テンプレート 15-B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-15-b.md)
               + [テンプレート 15-C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-15-c.md)
               + [テンプレート 15-D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-15-d.md)
               + [テンプレート 15-E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-15-e.md)
               + [テンプレート 16-A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-16-a.md)
               + [テンプレート 16-B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-16-b.md)
               + [テンプレート 16-C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-16-c.md)
               + [テンプレート 16-D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-16-d.md)
               + [テンプレート 16-E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-16-e.md)
               + [テンプレート 17-A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-17-a.md)
               + [テンプレート 17-B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-17-b.md)
               + [テンプレート 17-C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-17-c.md)
               + [テンプレート 17-D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-17-d.md)
               + [テンプレート 17-E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-17-e.md)
               + [テンプレート 18-A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-18-a.md)
               + [テンプレート 18-B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-18-b.md)
               + [テンプレート 18-C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-18-c.md)
               + [テンプレート 18-D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-18-d.md)
               + [テンプレート 18-E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-18-e.md)
               + [テンプレート 19-A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-19-a.md)
               + [テンプレート 19-B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-19-b.md)
               + [テンプレート 19-C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-19-c.md)
               + [テンプレート 19-D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-19-d.md)
               + [テンプレート 19-E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-19-e.md)
               + [テンプレート 20-A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-20-a.md)
               + [テンプレート 20-B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-20-b.md)
               + [テンプレート 20-C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-20-c.md)
               + [テンプレート 20-D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-20-d.md)
               + [テンプレート 20-E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-20-e.md)
         + ランディングページのパーソナライズ{#personalizing-landing-pages}
            ...
            + [ランディングページにカレンダーイベントの ICS ファイルを追加する](product-docs/demand-generation/landing-pages/personalizing-landing-pages/include-a-calendar-event-ics-file-in-a-landing-page.md)
      ...
      + ソーシャル {#social}
         ...
         + ソーシャル機能{#social-functions}
            ...
            + [LinkedIn のオーディエンスセグメントとして Marketo リストまたはスマートリストを使用する。](product-docs/demand-generation/social/social-functions/use-a-marketo-list-or-smart-list-as-a-linkedin-audience-segment.md)
   ...
   + メールマーケティング {#email-marketing}
      ...
      + 一般 {#general}
         ...
         + エディタの機能{#functions-in-the-editor}
            ...
            + [メールにカレンダーイベント（.ics）を追加する](product-docs/email-marketing/general/functions-in-the-editor/include-a-calendar-event-ics-in-an-email.md)
   ...
   + Marketoセールスインサイト {#marketo-sales-insight}
      ...
      + Salesforce用MSI {#msi-for-salesforce}
         + インストール {#installation}
            + [Salesforce AppExchange の Marketo Sales Insight パッケージのインストール](product-docs/marketo-sales-insight/msi-for-salesforce/installation/install-marketo-sales-insight-package-in-salesforce-appexchange.md)
         + 構成 {#configuration}
         ...
         + 機能 {#features}
            ...
            + MSIパネルの操作{#actions-in-the-msi-panel}
               ...
               + [Sales Insight への電子メールの公開](product-docs/marketo-sales-insight/msi-for-salesforce/features/actions-in-the-msi-panel/send-marketo-email/publish-an-email-to-sales-insight.md)
            ...
            + MSIパネルのタブ{#tabs-in-the-msi-panel}
               ...
               + 注目のアクション {#interesting-moments}
                  + [注目のアクション概要](product-docs/marketo-sales-insight/msi-for-salesforce/features/tabs-in-the-msi-panel/interesting-moments/interesting-moments-overview.md)
   ...
   + パーソナライゼーション {#personalization}
      + セグメント化とスニペット{#segmentation-and-snippets}
         + セグメント化 {#segmentation}
            ...
            + [セグメント化を編集する](product-docs/personalization/segmentation-and-snippets/segmentation/edit-a-segmentation.md)
         ...
         + スニペット {#snippets}
            ...
            + [ドラフトなしのスニペットを承認する](product-docs/personalization/segmentation-and-snippets/snippets/approve-a-snippet-with-no-draft.md)
            + [スニペットの承認](product-docs/personalization/segmentation-and-snippets/snippets/approve-a-snippet.md)
            + [スニペットを複製する](product-docs/personalization/segmentation-and-snippets/snippets/clone-a-snippet.md)
            ...
            + [ダイナミックコンテンツでスニペットを編集する](product-docs/personalization/segmentation-and-snippets/snippets/edit-snippets-with-dynamic-content.md)
            + [スニペットのプレビュー](product-docs/personalization/segmentation-and-snippets/snippets/preview-a-snippet.md)
            + [スニペットの承認を取り消す](product-docs/personalization/segmentation-and-snippets/snippets/unapprove-a-snippet.md)
   ...
   + レポート {#reporting}
      + 基本レポート{#basic-reporting}
         ...
         + レポートの編集{#editing-reports}
            + [リードレポートにカスタム列を追加する](product-docs/reporting/basic-reporting/editing-reports/add-custom-columns-to-a-person-report.md)
            + [リード・レポートへの商談列の追加](product-docs/reporting/basic-reporting/editing-reports/add-opportunity-columns-to-a-lead-report.md)
            + [レポートのタイムフレームを変更する](product-docs/reporting/basic-reporting/editing-reports/change-a-report-time-frame.md)
            + [レポートのサイズを設定する](product-docs/reporting/basic-reporting/editing-reports/configure-report-size.md)
            + [スマートリストを使ってレポートでリードをフィルターする](product-docs/reporting/basic-reporting/editing-reports/filter-people-in-a-report-with-a-smart-list.md)
         ...
         + レポートアクティビティ{#report-activity}
            + [モバイルプラットフォームの列があるリード効果レポートを作成する](product-docs/reporting/basic-reporting/report-activity/build-a-people-performance-report-with-mobile-platform-columns.md)
            ...
            + [レポートを複製する](product-docs/reporting/basic-reporting/report-activity/clone-a-report.md)
            + [レポートを削除する](product-docs/reporting/basic-reporting/report-activity/delete-a-report.md)
            ...
            + [キャンペーンアクティビティレポートをフィルターする](product-docs/reporting/basic-reporting/report-activity/filter-a-campaign-activity-report.md)
            ...
            + [リードレポートを属性別にグループ化する](product-docs/reporting/basic-reporting/report-activity/group-person-reports-by-attribute.md)
         ...
         + 購読{#report-subscriptions}のレポート
            ...
            + [基本レポートを配信登録する](product-docs/reporting/basic-reporting/report-subscriptions/subscribe-to-a-basic-report.md)
         ...
         + レポートのタイプ {#report-types}
            ...
            + [メールの効果レポート](product-docs/reporting/basic-reporting/report-types/campaign-email-performance-report.md)
      ...
      + メールインサイト {#email-insights}
         ...
         + [メールインサイトにおけるフィルター](product-docs/reporting/email-insights/filtering-in-email-insights.md)
      ...
      + 売上高サイクル分析 {#revenue-cycle-analytics}
         ...
         + 収益サイクルモデル {#revenue-cycle-models}
            + [売上高モデルを承認／承認解除する](product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/approve-unapprove-a-revenue-model.md)
            ...
            + [ステージの名前を変更する](product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/changing-the-name-of-a-stage.md)
            ...
            + [新規売上高モデルを作成する](product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/create-a-new-revenue-model.md)
            ...
            + [売上高モデルで Google AdWords コンバージョンを設定する](product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/set-google-adwords-conversions-in-the-revenue-model.md)
            ...
            + [売上高モデルのトランジションを使用する](product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/using-revenue-model-transitions.md)
   ...
   + Web パーソナライゼーション {#web-personalization}
      ...
      + 開始方法 {#getting-started}
         ...
         + [地域を編集する](product-docs/web-personalization/getting-started/edit-regions.md)
      ...
      + RTPタグ実装{#rtp-tag-implementation}
         + [RTP JavaScript をデプロイする](product-docs/web-personalization/rtp-tag-implementation/deploy-the-rtp-javascript.md)
      ...
      + Webパーソナライゼーションのレポート{#reporting-for-web-personalization}
         ...
         + Web分析統合{#web-analytics-integrations}
            ...
            + [RTP を Google Analytics に連携する](product-docs/web-personalization/reporting-for-web-personalization/web-analytics-integrations/integrate-rtp-with-google-analytics.md)
            + [RTP を Google ユニバーサルアナリティクスに連携する](product-docs/web-personalization/reporting-for-web-personalization/web-analytics-integrations/integrate-rtp-with-google-universal-analytics.md)
      ...
      + Webセグメントの使用{#using-web-segments}
         ...
         + [既知のリードデータを使用してセグメントを作成する](product-docs/web-personalization/using-web-segments/create-a-segment-using-known-person-data.md)
      ...
      + Webキャンペーンの操作{#working-with-web-campaigns}
         ...
         + [Web キャンペーンにフォームを埋め込む](product-docs/web-personalization/working-with-web-campaigns/embed-a-form-into-a-web-campaign.md)
         + [Web キャンペーンデータをエクスポートする](product-docs/web-personalization/working-with-web-campaigns/export-web-campaign-data.md)
         ...
         + [Web キャンペーンを起動／一時停止する](product-docs/web-personalization/working-with-web-campaigns/launch-pause-a-web-campaign.md)
         ...
         + [Web パーソナライゼーションリッチテキストエディターを使用する](product-docs/web-personalization/working-with-web-campaigns/using-the-web-personalization-rich-text-editor.md)
