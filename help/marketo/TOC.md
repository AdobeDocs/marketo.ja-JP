...
+ 製品ドキュメント {#product-docs}
   ...
   + 管理 {#administration}
      ...
      + 設定 {#settings}
         ...
         + [ランディングページヘッダー](product-docs/administration/settings/landing-page-headers.md)
   ...
   + Marketo の中心概念 {#core-marketo-concepts}
      + スマートキャンペーン {#smart-campaigns}
         ...
         + フローアクション {#flow-actions}
            ...
            + [リードの詳細ページからの単一フローアクション](product-docs/core-marketo-concepts/smart-campaigns/flow-actions/single-flow-actions-from-person-detail-page.md)
      ...
      + Predictive Audiences {#predictive-audiences}
         + [Predictive Audiences の使用の手引き](product-docs/core-marketo-concepts/predictive-audiences/getting-started-with-predictive-audiences.md)
         ...
         + [目標追跡と推定登録について](product-docs/core-marketo-concepts/predictive-audiences/understanding-goal-tracking-and-projected-registrations.md)
   + CRM 同期 {#crm-sync}
   ...
   + 需要創出 {#demand-generation}
      ...
      + フォーム {#forms}
         ...
         + CAPTCHA の使用 {#using-captcha}
            ...
            + [Marketo Formsでの CAPTCHA の有効化](product-docs/demand-generation/forms/using-captcha/enable-captcha-in-marketo-forms.md)
   ...
   + Marketo セールスの連携 {#marketo-sales-connect}
      ...
      + CRM {#crm}
         ...
         + Salesforce の連携 {#salesforce-integration}
            + [Salesforce アクティビティ詳細のカスタマイズ設定](product-docs/marketo-sales-connect/crm/salesforce-integration/configure-salesforce-activity-detail-customization.md)
   ...
   + Marketo Sales Insight {#marketo-sales-insight}
      + アクション {#actions}
         ...
         + CRM {#crm}
            ...
            + Salesforce の連携 {#salesforce-integration}
               ...
               + [Sales Insight アクションアカウントを Salesforce に接続](product-docs/marketo-sales-insight/actions/crm/salesforce-integration/connect-your-sales-insight-actions-account-to-salesforce.md)
               ...
               + [応答ログ](product-docs/marketo-sales-insight/actions/crm/salesforce-integration/reply-logging.md)
         ...
         + メール {#email}
            ...
            + メール配信 {#email-delivery}
               ...
               + [チーム向けのカスタム配信チャネルの設定](product-docs/marketo-sales-insight/actions/email/email-delivery/set-up-a-custom-delivery-channel-for-your-team.md)
            + 配信停止 {#unsubscribes}
         ...
         + Marketo {#marketo}
            ...
            + [Sales Insight アクションの注目のアクション](product-docs/marketo-sales-insight/actions/marketo/interesting-moments-in-sales-insight-actions.md)
            ...
            + [Sales Insight アクションアクティビティの用語集](product-docs/marketo-sales-insight/actions/marketo/sales-insight-actions-activity-glossary.md)
      ...
      + [非ネイティブ MS Dynamics 統合に関する Sales Insight](product-docs/marketo-sales-insight/sales-insight-for-non-native-ms-dynamics-integrations.md)
