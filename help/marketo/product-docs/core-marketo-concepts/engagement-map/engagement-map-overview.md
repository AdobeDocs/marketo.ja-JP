...
エンゲージメントマップに 2 つのタブが表示されます。 [エンゲージメントマップ](/help/marketo/product-docs/core-marketo-concepts/engagement-map/engagement-map-tab.md){target="_blank"} and [Settings](/help/marketo/product-docs/core-marketo-concepts/engagement-map/engagement-map-tab.md){target="_blank"}.
...
いいえ。エンゲージメントマップの素晴らしい点は、両方の世界の最高の部分をあなたに与えることです。キャンペーンの現在の作成方法を補完するものです。 既存の UI を使用するか、新しい UI でビルド/ビジュアライゼーションを使用するかを選択できます。 すべてのユーザーは、ビジュアル作成ツールでMarketo Engageの強力な機能セットを引き続き入手できます。
