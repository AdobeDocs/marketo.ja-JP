...
ご覧の通り、Marketo には多くの力があります。 ここでは基本的な内容について説明しますが、[Marketo Engageのエキスパート &#x200B;](https://business.adobe.com/products/marketo/services-support.html){target="_blank"}による追加のサービスを検討して、調整を行い、成功に向けて準備を整えましょう。
