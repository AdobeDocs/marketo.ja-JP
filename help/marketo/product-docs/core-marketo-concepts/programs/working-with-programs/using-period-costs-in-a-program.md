...
期 [間コスト](understanding-period-costs.md) とは、プログラムに費やした金額を指します。 1か月以上の期間に対応し、レポートのROIに使用されます。

>[!NOTE]
>
>**ディープダイブ**
>
> Analyticsの [売上高サイクルについて詳しくは](http://docs.marketo.com/display/docs/revenue+cycle+analytics)、

## 期追加間原価  {#add-a-period-cost}

1. プログラムの「 **セットアップ** 」タブに移動します。

   ![](assets/image2014-9-18-12-3a9-3a46.png)

1. 「 **期間コスト** 」をキャンバスにドラッグ&amp;ドロップします。
...
1. 「 **期間原価** 」を入力します（小数またはコンマは使用できません）。 「 **保存**」をクリックします。
