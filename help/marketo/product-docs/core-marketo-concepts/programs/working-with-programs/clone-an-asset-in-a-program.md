...
description: プログラム内でアセットを複製する方法を説明します。 メール、ランディングページ、その他のローカルアセットのコピーを作成します。
...
プログラムを複製すると、_すべて_&#x200B;複製されます。 場合によっては、アセットを1つ複製するだけです。 手順は以下のとおりです。
