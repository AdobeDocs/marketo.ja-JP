...
description: 支出を追跡するためのプログラムの期間コストについて説明します。 レポートとROI用のプログラム期間にコストを割り当てます。
title: 期間原価について
...
>**例**
>
>7 月にローンチされる [!DNL eBook] のためにイラストレーターを雇うのに 1000 ドルを支払ったとします。この場合、この [!DNL eBook] プログラムの 7 月の期間原価は 1000 ドルとなります。
>
>また [!DNL Google Adwords] に 1 か月あたり 200 ドル支払っている場合、この [!DNL Google Adwords] プログラムの期間原価は&#x200B;_毎月_ 200 ドルとなります。
