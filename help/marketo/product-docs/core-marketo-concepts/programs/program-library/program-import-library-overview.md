---
description: プログラムインポートライブラリとテンプレートプログラムについて説明します。 テンプレートを使用して、ベストプラクティスからプログラムをすばやく作成できます。
...
* [EM-YYYY-MM-DD-シングルメール送信](/help/marketo/product-docs/core-marketo-concepts/programs/program-library/em-yyyy-mm-dd-single-email-send.md){target="_blank"}
...
* [EV-YYYY-MM-DD-イベントプログラム](/help/marketo/product-docs/core-marketo-concepts/programs/program-library/ev-yyyy-mm-dd-event-program.md){target="_blank"}

* [TS-YYYY-MM-DD-展示会プログラム](/help/marketo/product-docs/core-marketo-concepts/programs/program-library/ts-yyyy-mm-dd-tradeshow-program.md){target="_blank"}
...
* [NUR-YYYY-MM-高度な育成](/help/marketo/product-docs/core-marketo-concepts/programs/program-library/nur-yyyy-mm-advanced-nurture.md){target="_blank"}
...
* [OA-YYYY-MM-オンライン広告 Marketo ランディングページ](/help/marketo/product-docs/core-marketo-concepts/programs/program-library/oa-yyyy-mm-online-advertising-marketo-landing-page.md){target="_blank"}
