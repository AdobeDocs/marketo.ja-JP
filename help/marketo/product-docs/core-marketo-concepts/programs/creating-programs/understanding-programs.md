...
description: キャンペーンとアセットを整理するためのMarketoのプログラムについて説明します。 プログラムを使用して、メール、ランディングページ、スマートキャンペーンをグループ化します。
title: プログラムについて
...
プログラムは、単一のマーケティング施策を表します。 これは、ローカルアセットと呼ばれ、**ランディングページ**、**メール**、**スマートキャンペーン**&#x200B;などを含む、プログラムの動作に必要なすべての要素を含むコンテナと考えることができます。 プログラムは多くの作業を伴いますが、容易に始められます。
