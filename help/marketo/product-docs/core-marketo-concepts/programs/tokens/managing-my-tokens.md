...
1. プログラムまたは「キャンペーン」フォルダーを選択します。「**[!UICONTROL マイトークン]**」をクリックします。

   ![](assets/image2014-9-18-12-3a4-3a27.png)

1. **[!UICONTROL マイトークン]**&#x200B;のタイプを選択します。キャンバスにドラッグ&amp;ドロップします。
...
1. **[!UICONTROL マイトークン]**&#x200B;をダブルクリックして変更を行います。「**保存**」をクリックします。
...
1. **[!UICONTROL マイトークン]**&#x200B;を右クリックします。「**[!UICONTROL トークンを削除]**」を選択します。
