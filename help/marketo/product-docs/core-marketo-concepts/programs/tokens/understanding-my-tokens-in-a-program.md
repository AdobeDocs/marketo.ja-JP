...
description: プログラム内のマイトークンについて —Marketoドキュメント — 製品ドキュメント
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td>このトークンを使用して、電子メールやランディングページにカレンダーイベントファイル(.i</a><a href="/help/marketo/product-docs/email-marketing/general/functions-in-the-editor/create-a-calendar-event-ics-file.md">cs)</a>を追加します。<a href="/help/marketo/product-docs/email-marketing/general/functions-in-the-editor/create-a-calendar-event-ics-file.md"></a></td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td>このトークンを使用して、電子メールでVelocityスクリプトを実行します。 詳細<a href="https://developers.marketo.com/documentation/email-scripting/" title="リンク先を表示" rel="nofollow">こちら</a>。 </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td>リッチ テキスト <img alt="—" src="assets/image2014-9-25-16-3a46-3a22.png" data-linked-resource-id="3083234" data-linked-resource-type="attachment" data-base-url="https://docs.marketo.com" data-linked-resource-container-id="1147114"></td> 
  ...
  <tr> 
   ...
   <td>このトークンは、<a href="/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/flow-actions/use-tokens-in-flow-steps.md">変更スコアフロー手順</a>で使用します。 </td> 
  </tr> 
  <tr> 
   ...
   <td colspan="1">このトークンを使用すると、Marketoプログラムの一部となるリードを、SFDCキャンペーンが追加されたものにも追加できます。</td> 
  </tr> 
  <tr> 
