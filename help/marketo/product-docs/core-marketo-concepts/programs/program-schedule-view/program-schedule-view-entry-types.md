...
# プログラムスケジュール表示の入力タイプ {#program-schedule-view-entry-types}

プログラムスケジュール表示に表示され、使用できる組み込みエントリの種類は8種類あります。 「管理者」セクションでカスタムエントリタイプを [作成することもできます](create-custom-entry-types.md) 。
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colspan="1" rowspan="1">「電子メールの送信」フロー手順がないスケジュール済みスマートキャンペーン。</td> 
  </tr> 
  <tr> 
   <td colspan="1" rowspan="1">電子メール付きスマートキャンペーン <img alt="--" src="assets/image2014-9-24-10-3a5-3a14.png" data-linked-resource-id="3082717" data-linked-resource-type="attachment" data-base-url="https://docs.marketo.com" data-linked-resource-container-id="1147243"></td> 
   <td colspan="1" rowspan="1"><p>スケジュールされたスマートキャンペーンで、電子メールの送信フロー手順が少なくとも1つある。</p></td> 
  </tr> 
  <tr> 
   <td colspan="1" rowspan="1">電子メールプログラム <img alt="--" src="assets/image2014-9-24-10-3a5-3a27.png" data-linked-resource-id="3082718" data-linked-resource-type="attachment" data-base-url="https://docs.marketo.com" data-linked-resource-container-id="1147243"></td> 
  ...
  <tr> 
   <td colspan="1" rowspan="1">メインイベント <img alt="--" src="assets/image2014-9-24-10-3a6-3a15.png" data-linked-resource-id="3082722" data-linked-resource-type="attachment" data-base-url="https://docs.marketo.com" data-linked-resource-container-id="1147243"></td> 
   <td colspan="1" rowspan="1">イベントプログラムの主なイベント日が、サポートされているウェビナープロバイダーに接続されていません。</td> 
  </tr> 
 </tbody> 
</table>
