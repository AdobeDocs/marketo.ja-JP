...
1. 一番下の2つのドットは、このスマートキャンペーンに接続されたメールが2つあることを示しています。 他のメールの結果を表示するには、画面を左にスワイプします。 2 番目のメールの結果は次のとおりです。
...
メールが配信される前に、確認しておくことをお勧めします。 または、別の人にサンプルを送って、別の目で確認してもらいましょう。
