...
# タブレットからイベントにユーザーをチェックイン {#check-people-into-your-event-from-your-tablet}
...
>[!TIP]
>
>ユーザーが招待されても登録されていない場合は、「検索」ボックスの下にある「サーバーで **検索**」をクリックして名前を検索できます。 招待のステータスが、イベントの「 **出席** 」に変わります。
...
1. 基本情報のフィールドにできるだけ入力し、「 **完了**」をタップします。
...
誤ってユーザーをチェックインした場合は、Marketoと同期する *前に*、「出席」ステータスを反転できます。
...
## アプリとマーケティングツールの同期 {#sync-the-app-with-marketo}
