...
description: タブレット —Marketoドキュメント — 製品ドキュメントからイベントにユーザーをチェックインします。
...
1. 「**ログイン**」をタップして、Marketoイベントアプリを起動します。

   ![](assets/1.jpg)

1. Marketoのユーザ名とパスワードを入力し、[**ログイン**]をクリックします。
...
1. 基本情報のフィールドをできるだけ入力し、「**完了**」をタップします。
...
間違って人をチェックインした場合は、_Marketo_&#x200B;と同期する前に、出席ステータスを反転できます。
...
## アプリをMarketoと同期{#sync-the-app-with-marketo}
