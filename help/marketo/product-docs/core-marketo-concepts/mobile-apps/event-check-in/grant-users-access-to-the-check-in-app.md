...
# チェックインアプリへのアクセス権をユーザーに付与 {#grant-users-access-to-the-check-in-app}
...
1. 「 **ロール** 」タブをクリックし、「 **新規ロール**」をクリックします。

   ![](assets/image2015-6-2-11-3a3-3a23.png)

1. 新しいロールの名前と、オプションで説明を入力します。 「 **Access Mobile Application** 」ボックスを選択し、「 **作成**」をクリックします。
