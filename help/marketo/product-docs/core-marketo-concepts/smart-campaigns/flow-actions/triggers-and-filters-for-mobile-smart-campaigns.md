...
ほとんどのアクティビティには、トリガー、フィルター、無操作フィルターがあります。 プッシュ通知をタップした場合など、*が発生しなかったアクションを追跡するには、無操作フィルターを使用します。*
...
右側のパネルで&#x200B;**モバイルアプリ**&#x200B;を検索して、すべてのモバイルアプリトリガーとフィルターをリストします。
...
これらは、カスタムモバイルアクティビティを追跡する強力な方法を提供します。 Android](http://developers.marketo.com/documentation/mobile/installation-instructions-on-android)用に[を設定し、iOS](http://developers.marketo.com/documentation/mobile/installation-instructions-on-ios)用に[を設定するには、開発者と協力する必要があります。
