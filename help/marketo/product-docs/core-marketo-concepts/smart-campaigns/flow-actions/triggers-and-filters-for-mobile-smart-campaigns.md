...
description: モバイルスマートキャンペーンのトリガーとフィルターについて説明します。 アプリのイベントと属性を使用して、キャンペーンをトリガーします。
...
>[!TIP]
>
>プッシュ通知を受け取る必要がある人のスマートリストを定義する際に、「モバイルアプリの有無= true」および「プッシュが有効になっています= true」を指定し、モバイルアプリの名前を指定することをお勧めします。
