...
description: モバイルスマートキャンペーンのトリガーとフィルター-Marketoドキュメント — 製品ドキュメント
...
>[!NOTE]
>
>Marketoはアプリのアンインストールを追跡しないので、フィルターでは現在のインストールと以前のインストールの両方が見つかります。
