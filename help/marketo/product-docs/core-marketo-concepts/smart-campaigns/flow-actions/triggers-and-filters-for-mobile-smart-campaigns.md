...
ほとんどのアクティビティには、トリガー、フィルター、非アクティブフィルターがあります。無操作状態のフィルターを使用して、プッシュ通知のタップなど、操作を追跡します。 *didn&#39;t* 起こる。
...
>[!TIP]
>
>プッシュ通知を受信するユーザーのスマートリストを定義する際には、「モバイルアプリを使用」を「true」に、「プッシュを有効にする」を「true」に、「モバイルアプリを使用」を「true」に指定することをお勧めします。
...
>[!TIP]
>
>「未タップのプッシュ通知」非アクティブフィルターを使用して、最近送信したプッシュ通知をタップしなかった人を検索し、E メールでフォローアップできます。
