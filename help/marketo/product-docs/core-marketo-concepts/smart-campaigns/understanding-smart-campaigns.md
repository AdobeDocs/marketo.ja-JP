...
description: Marketoのスマートキャンペーンと自動化機能について詳しく見る。 トリガーとフローステップを使用して、リードナーチャリングとアクションを自動化する。
...
Marketo Engage が車なら、スマートキャンペーンはそのエンジンです。 スマートキャンペーンは、思う以上に多くの機能を備えており、その活用は簡単に始められます。
