...
description: スマートキャンペーンを中止する方法を説明します。 実行中のバッチキャンペーンを停止し、それ以上のユーザーがエントリするのを防ぎます。
title: スマートキャンペーンの中止
...
スマートキャンペーンを開始してすぐに、間違っていたことに気付く場合があります。 スマートキャンペーンのミッドランを停止するには、次の手順に従います。
...
1. 「**[!UICONTROL 中止]**」をクリックして確認します。
   ...
   >[!NOTE]
   >
   >中断すると、既に完了したステップは取り消されず、より多くのステップが発生しなくなります（例：メールを配信停止できない）。
...
仕事は必ず再確認しますが、この緊急ブレーキは役に立つかもしれません。
