...
Marketoは、アクティビティを取得しなくなったトリガー済みスマートキャンペーンを非アクティブ化する、優れた無料のサービスを提供します。 これにより、システム全体のパフォーマンスが向上するとともに、該当するキャンペーンを探して無効化する時間を節約できます。

## どのような処理が行われますか？ {#what-happens}

四半期に 1 回、Marketoは、6 ヶ月以上休止（人がいない）状態のスマートキャンペーンを見つけ、それらを非アクティブ化します。
...
心配しない — スマートキャンペーンの時計は次の方法でリセットできます。
