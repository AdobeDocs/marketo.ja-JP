...
# 定期バッチキャンペーンの実行の取消 {#cancel-a-scheduled-recurring-batch-campaign-run}
...
1. [ **スケジュール****の繰り返し**]をクリックします。

   ![](assets/image2014-9-22-16-3a44-3a55.png)

   >[!TIP]
   >
   >1回の実行をキャンセルするには、その横にある「 ![— 」をクリック](assets/image2014-9-22-16-3a45-3a42.png) します。 スケジュールされたバッチキャンペーンの実行を [キャンセルする方法を説明します](cancel-a-scheduled-batch-campaign-run.md)。

1. 「スケジュール」を「 **なし** 」に設定し、「 **保存**」を選択します。
