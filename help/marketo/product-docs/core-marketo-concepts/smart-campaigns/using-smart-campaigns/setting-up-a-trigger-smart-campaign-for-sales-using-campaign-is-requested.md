...
description: Campaign リクエストを使用して営業用のトリガースマートキャンペーンを設定する方法を説明します。 CRM からのリードに対するセールス要求キャンペーンを許可します。
...
1. 選択肢には、優先するリクエストの種類が示されます。Salesforce機能については、必ず「Insightのセールス **[!UICONTROL を選択し]** ください。
   ...
   >
   >「セールスインサイト」を選択すると、セールスのボックスに自動的に表示されることを&#x200B;_覚えておいてください_。過剰は禁物です。多すぎると無視されてしまいます。
...
>[!TIP]
>
>スマートキャンペーンには明確な名前を付けてください。 セールスインサイトでは、付けた名前がそのまま表示されます。
