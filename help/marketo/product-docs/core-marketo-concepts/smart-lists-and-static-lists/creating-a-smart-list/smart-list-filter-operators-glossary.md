...
description: スマートリストのフィルター演算子に関するヘルプを参照してください。 フィルターを作成するための等号、を含む、およびその他の演算子を理解します。
...
>**例**
>
>過去や将来のイベントを処理する際に、日付フィールドが煩雑になる可能性があります。 以下に 2 つの例を示します。
>
>**[!UICONTROL 次より過去]**
>
...
ご覧のとおり、これらのオペレーターはMarketo語を流暢に話すことができます。
