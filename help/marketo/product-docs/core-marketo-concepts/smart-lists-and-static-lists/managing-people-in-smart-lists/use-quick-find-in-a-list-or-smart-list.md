...
1. 検索するスマートリストを選択し、「 **人** 」タブをクリックします。

   ![](assets/smartlistpeople.png)

## 個人情報を使用して人を検索 {#find-people-using-personal-info}

1. 画面の下部にある[ **クイック検索****]ボックスに、キーワード(**&#x200B;個人名 **、電子メールアドレス**、または ****&#x200B;職名)を入力します。

   ![](assets/searchpeople.png)

1. Enterキーを押すか、検索アイコンをクリックすると完了です。

## 会社名を使用した人の検索 {#find-people-using-a-company-name}
