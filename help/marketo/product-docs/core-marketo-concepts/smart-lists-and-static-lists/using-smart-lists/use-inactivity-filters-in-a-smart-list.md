...
description: スマートリストで非アクティビティフィルターを使用する方法を説明します。 一定期間、何もしていない人を探します。
...
非アクティビティフィルターを使用して、スマートリスト内の何もしないユーザーを検索します。
...
1. 選択した非アクティブフィルターを見つけて、キャンバスにドラッグします。 例えば、この例では、どのページにもアクセスしたことがないユーザーを見つけます。
