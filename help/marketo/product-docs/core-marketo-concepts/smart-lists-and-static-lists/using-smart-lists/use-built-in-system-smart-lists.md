...
description: 組み込みのスマートリストとシステムのスマートリストの使用方法を説明します。 キャンペーンでは、「すべての人」や「すべての登録解除」など、事前定義済みのリストを使用できます。
...
# 組み込みのシステムスマートリストの使用 {#use-built-in-system-smart-lists}

Marketo Engageには、一般的なセグメンテーション作業に役立つスマートリストが組み込まれています。
...
>[!NOTE]
>
>システム スマート リストは削除できません。 「重複の可能性」リストを除き、編集することもできません。
