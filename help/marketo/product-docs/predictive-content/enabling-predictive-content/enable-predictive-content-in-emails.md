...
description: タイトルが承認され、編集された後にContentAIを使用してメール画像を予測する方法を説明します。 電子メール 2.0 エディターを開き、各画像を有効にし、カテゴリを選択し、プレビューして最終調整します。
...
1. 電子メールのプレビューが完了したら、**[!UICONTROL アクションのプレビュー]** ドロップダウンをクリックし、**[!UICONTROL 承認して閉じる]**&#x200B;を選択します。 まだ編集が必要な場合は、右側にある「**[!UICONTROL ドラフトを編集]**」をクリックします。
