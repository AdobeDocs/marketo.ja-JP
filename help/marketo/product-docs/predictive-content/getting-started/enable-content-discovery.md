...
description: コンテンツ検出を有効にして、予測コンテンツがサイトからコンテンツを自動検出してタグ付けする方法を説明します。 PDFや動画などの閲覧履歴を追跡して、レコメンデーションを獲得。
title: コンテンツ検出を有効にする
...
コンテンツ発見機能は、既に存在するコンテンツ（ケーススタディ、ブログ投稿、動画、プレスリリースなど）を自動的に発見し、タグ付けします。 ビュー数を追跡することもできます。  予測コンテンツは、検出されたコンテンツを使用し、予測分析を使用して、パフォーマンスの最も高いコンテンツを判断し、最適な人に的確なコンテンツをレコメンデーションします。
