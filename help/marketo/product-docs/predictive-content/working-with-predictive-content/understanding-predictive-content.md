...
予測コンテンツのタイトルを [承認した後は](//help/marketo/product-docs/predictive-content/working-with-all-content/approve-a-title-for-predictive-content.md)、ここで作業します。 予測コンテンツページには、予測コンテンツに対して承認したすべてのタイトルが表示されます。
...
作成したカテゴリでコンテンツをフィルタリングできます。 フィルターアイコンをクリックし、「 **カテゴリ**」で1つ以上のコンテンツカテゴリを選択します。
...
表では、左から右へ、どのソースから予測コンテンツが有効になっているかを表示できます。レコメンデーションバー、電子メールおよびリッチメディアを参照してください。 有効なソースは緑色で表示されます。 コンテンツを [編集する際に、これらを有効にします](http://docs.marketo.com/display/docs/edit+predictive+content)。
