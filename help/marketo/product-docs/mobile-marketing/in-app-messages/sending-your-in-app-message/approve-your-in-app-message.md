...
description: アプリ内メッセージを承認して起動する方法について説明します。 アプリ内ダッシュボードで、プログラムを一時停止、再開、停止して、パフォーマンスを監視します。
title: アプリ内メッセージの承認
...
1. 問題がない場合は、**[!UICONTROL 承認して起動]**&#x200B;します。
   ...
   >[!NOTE]
   >
   >例えば、送信プロセスのいずれかの部分が不完全な場合、アプリ内メッセージが承認されない場合、注意が必要な領域を示す警告メッセージが表示されます。 修正をおこなうと、手順 2 のメッセージが表示されます。
