...
アプリ内メッセージを作成したら、[ここ](/help/marketo/product-docs/mobile-marketing/in-app-messages/sending-your-in-app-message/send-your-in-app-message.md)に移動して、送信方法を確認します。
...
1. プログラムを右クリックし、「**新しいローカルアセット**」を選択します。
