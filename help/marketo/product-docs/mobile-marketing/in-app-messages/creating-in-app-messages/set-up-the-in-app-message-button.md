...
1. 編集するには、ボタンをクリックして、「[!UICONTROL スタイル]」タブを開きます。
...
1. ボタンに独自の画像を使用する場合は、「**[!UICONTROL 画像]**」ボタンをクリックし、「**[!UICONTROL 画像を選択]**」をクリックします。
...
>* [[!UICONTROL アプリ内メッセージのレイアウトの選択]](/help/marketo/product-docs/mobile-marketing/in-app-messages/creating-in-app-messages/choose-a-layout-for-your-in-app-message.md)
