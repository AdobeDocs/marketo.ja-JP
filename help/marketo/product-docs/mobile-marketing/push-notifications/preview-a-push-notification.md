...
description: AndroidとiOSでプッシュ通知をプレビューする方法について説明します。 ホーム画面、ロック画面、通知センターでの見た目を確認します。
title: プッシュ通知のプレビュー
...
最後に、エディタで、通知の作業中に右上の「**[!UICONTROL ドラフトをプレビュー]**」タブをクリックできます。
