...
description: 電子メールインサイトで頻繁に使用されるチャート表示のサムネールとしてクイックチャートを作成および保存する方法を説明します。 最大20個のカスタムチャートを保存し、クイックチャートアイコンからすばやくアクセスできます。
...
1. 新しいクイックチャートが他のチャートと共に表示されるようになります。
   ...
   >[!TIP]
   >
   >クイックチャートを移動するには、クリックして目的の位置にドラッグします。

## クイックチャートの削除 {#delete-a-quick-chart}

クイックチャートは削除するのも 簡単です！
