...
description: 承認済みモデルの編集など、Marketo Engageでの承認済みモデルの編集について説明します。 このガイドを使用して、次のステップを完了してください。
title: 承認済みモデルの編集
...
1. モデルの変更が完了したら、**[!UICONTROL モデルアクション]** メニューで&#x200B;**[!UICONTROL モデルドラフトを承認]**&#x200B;を選択して、モデルを再承認します。
