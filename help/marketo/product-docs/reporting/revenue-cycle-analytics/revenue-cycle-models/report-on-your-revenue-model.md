...
# 売上高モデルのレポート {#report-on-your-revenue-model}
...
1. 「 **売上高ステージ別のリード」をクリックします**。

   ![](assets/image2015-4-29-16-3a15-3a3.png)

1. 「 **設定** 」タブをクリックし、フィルターセクションの下の「重複」で「 **売上高サイクルモデル**」をクリックします。
...
1. 「 **レポート** 」タブをクリックして、売上高サイクルモデルの各ステージにあるリード数を表示します。
