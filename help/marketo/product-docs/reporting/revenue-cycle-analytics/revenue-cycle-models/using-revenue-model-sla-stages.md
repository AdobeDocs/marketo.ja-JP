...
description: Marketo Engageで収益モデルのSLA ステージを使用して、収益モデルのSLA ステージを使用する方法を説明します。 このガイドを使用して、次のステップを完了してください。
...
SLAは「service level agreement」を表します。 これらのステージは、リードを評価または処理してプロセスを進めたり、離脱したりする必要がある、定義された最大時間がある場合に使用されます。
