...
<table> 
 <tbody> 
  ...
  <tr> 
   <td>作成されたオポチュニティ</td> 
   <td>オポチュニティの作成に影響を与えるプログラムのクレジットの部分。 複数のリードが関係している場合は、分数になる場合があります。</td> 
  </tr> 
  <tr> 
   <td>獲得したオポチュニティ</td> 
  ...
  <tr> 
   ...
   <td>プログラムがオポチュニティの作成に影響を与えるために受け取ったクレジットの部分（金額）。 複数のリードが関係している場合は、分数になる場合があります。</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td>投資収益</td> 
   <td>ウォンの機会に影響を与えるためにプログラムが受けた信用の割合（金額）とプログラムの費用の割合。</td> 
  </tr> 
  <tr> 
   <td>獲得した売上高</td> 
   <td>プログラムがウォンの機会に影響を与えるために受け取ったクレジットの部分（金額）。 複数のリードが関係している場合は、分数になる場合があります。</td> 
  </tr> 
 </tbody> 
</table>
