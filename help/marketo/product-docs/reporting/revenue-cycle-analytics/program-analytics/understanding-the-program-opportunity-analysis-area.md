...
description: の理解を含め、Marketo Engageのプログラム商談分析領域について説明します。 このガイドを使用して、次の手順を完了します。
...
_&#42;（FT） = ファーストタッチ アトリビューション（リード獲得の測定に使用）、（MT） = マルチタッチ アトリビューション（リード成功の測定に使用）_
...
_&#42;プログラムに任意のタイプのアトリビューションクレジットを付与したすべての機会。 商談は、1 つ以上のリードと 1 つ以上のプログラムの影響を受けることができます。_
