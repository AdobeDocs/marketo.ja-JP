...
>[!IMPORTANT]
>
>収益サイクルエクスプローラーのごみ箱フォルダーは、技術的な問題により、一時的に非表示になっています。 現在、修正を行っており、ファイルは安全です。 復元が必要なファイルがある場合は ](https://nation.marketo.com/t5/support/ct-p/Support)[Adobeサポートにお問い合わせください。
