...
以下に、収益サイクルエクスプローラー分析レポートで使用できるすべての指標とディメンションを示します。

>[!TIP]
>
>表のいずれかが狭すぎると思われる場合は、このページの上部に向かって左（![](assets/icon-left-arrow.png)）と右（![](assets/icon-right-arrow.png)）の矢印をクリックし、左右のサイドバーを折りたたむことで、ビューを展開できます。
