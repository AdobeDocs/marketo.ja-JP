---
description: Adobe Marketo Engageのデータに関する豊富なビジュアライゼーションと迅速なパフォーマンスを実現する、柔軟性に優れたレポートインターフェイスである高度なBI分析について解説します。 インタラクティブなダッシュボードと書き出しオプションを使用して、カスタムレポートを作成。
title: 高度な BI 分析の概要
feature: Reporting
