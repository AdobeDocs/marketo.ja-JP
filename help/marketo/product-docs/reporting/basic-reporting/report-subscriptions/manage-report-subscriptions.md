...
1. 「**購読**」タブをクリックします。
   ...
   >[!TIP]
   >
   >また、個々のレポートの購読は&#x200B;**マーケティング活動**&#x200B;でも管理できます。レポートを選択して、「**購読**」タブをクリックします。

   レポートのメール送信頻度を変更するには、「頻度」フィールドをクリックして、ドロップダウンメニューから新しいオプションを選択します。

   ![](assets/image2014-9-16-10-3a36-3a4.png)

1. 購読のメールアドレスを変更するには、「**メール受信者**」フィールドに入力し、メールアドレスを編集します。
   ...
   * 「**アクティブ**」チェックボックスをオフにして、購読を無効にする。
   * 「**概要**」フィールドをクリックして編集し、メールに表示されるプレビュー行の数を変更する。
   * 「**Excel**」チェックボックスをオフにして、スプレッドシートの添付ファイルなしでレポートの概要を送信する。
   * 「**送信**」ボタンをクリックして、レポートのメールを直ちに送信する。

1. 購読を完全に削除するには、行を選択して「**購読を削除**」をクリックする。
