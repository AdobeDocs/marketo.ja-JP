...
1. 「 **設定** 」タブをクリックし、フィルターの上にドラッグします。
   ...
   * **Design Studio電子メール**:グローバルアセット。Design Studioで管理します。
   * **マーケティングアクティビティ電子メール**:「マーケティングアクティビティ」タブのプログラム内のローカルアセット。
   * **アーカイブ済み電子メール**:非アクティブで古い電子メール。

1. レポートに含めるフォルダーと特定の電子メールを選択します。
