...
description: 企業別にグループ化されたweb サイトにアクセスしている企業を示す企業Web アクティビティレポートについて説明します。 既知または匿名の訪問者を表示し、ページビュー、人物、位置情報を追跡できます。
...
1. レポートをレビューして、サイトを訪問している会社を確認します。
...
<table>
 ...
 <tbody>
  <tr>
   <td>企業</td>
   <td>訪問者の会社。<br> <strong>太字の名前</strong>は、少なくとも1人のユーザーによって会社名であることが確認されています。</td>
  </tr>
  <tr>
   <td>推測される会社あるいは ISP</td>
   <td>訪問者のIP アドレスから推測される会社。<br> <strong>太字で表示された名前</strong>は、これが ISP ではなく会社であることを示します。 </td>
  </tr>
  <tr>
   <td>ページ表示</td>
