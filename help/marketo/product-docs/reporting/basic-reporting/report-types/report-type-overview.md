...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td><strong>  <a href="../../../../product-docs/email-marketing/email-programs/email-program-data/email-link-performance-report.md">電子メールリンクのパフォーマンス</a>  </strong></td> 
   <td>電子メール内の個々のリンクの統計。</td> 
  </tr> 
  <tr> 
   <td><strong>  <a href="../../../../product-docs/email-marketing/email-programs/email-program-data/email-performance-report.md">電子メールのパフォーマンス</a>  </strong></td> 
   <td>電子メールとのインタラクションの確認：配信またはバウンス、開く、クリック、購読解除など</td> 
  </tr> 
  <tr> 
   <td><strong>  <a href="../../../../product-docs/marketo-sales-insight/msi-for-salesforce/features/performance-reports/sales-insight-email-performance-report.md">Sales Insight電子メールのパフォーマンス</a>  </strong></td> 
   <td>Salesforce、Microsoft Dynamics、OutlookおよびGmailプラグインのMarketo Sales Insightを通じて送信された電子メールとのやりとりを確認します。</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td><strong>  <a href="web-page-activity-report.md">Webページアクティビティ</a>  </strong></td> 
   <td>Webアクティビティに関するレポートをランディングページおよび公開Webサイトに送信します。</td> 
  </tr> 
  <tr> 
   <td><strong>社会的影響</strong></td> 
