...
description: Salesforce Professional エディションにMarketo フィールドを追加する方法について説明します。 リードおよび取引先責任者オブジェクトのスコア、獲得プログラム、獲得日を作成します。
...
1. 「**[!UICONTROL 保存して新規作成]**」をクリックして戻り、他の 2 つのカスタムフィールドのそれぞれを作成します。 **[!UICONTROL Save]**&#x200B;をクリックすると、3つすべてで完了です。
