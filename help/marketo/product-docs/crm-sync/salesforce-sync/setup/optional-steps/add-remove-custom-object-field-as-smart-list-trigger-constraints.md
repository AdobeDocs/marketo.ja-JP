...
1. クリック **[!UICONTROL 管理者]** その後 **[!UICONTROL Salesforce オブジェクト同期]**.
...
1. 「**[!UICONTROL 表示可能なフィールドを編集]**」をクリックします。
   ...
   >[!TIP]
   >
   >次の場合、 **[!UICONTROL 表示可能なフィールドを編集]** ボタンが灰色表示になっている場合は、オブジェクトは現在スマートリストまたはスマートキャンペーンで使用されています。 続行するには、すべての関連付けを削除します。
