---
description: Marketo Engage sync用Veeva CRM ユーザーの作成方法を説明します。 ページレイアウトを設定し、同期ユーザーを作成して、フィールド更新に対する権限を割り当てます。
...
Marketo Engage が [!DNL Veeva] CRM に接続するために使用できるアカウントが作成されました。
