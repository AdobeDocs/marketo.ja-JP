---
description: Marketo Engageと Veeva CRM の人物アカウント同期に関するお問い合わせ。 人物アカウントが会社および人物としてどのように同期されるかを説明し、人物アカウントフィルターを使用します。
title: 個人取引先の同期 FAQ
...
[!DNL Veeva] CRM を優先させます。しかし、このようなデータの競合が発生することは、ほとんどありません。
