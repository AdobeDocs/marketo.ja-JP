...
# 手順2/3:Dynamics (2011 On-Premises)でMarketo Syncユーザーを設定 {#step-of-set-up-marketo-sync-user-in-dynamics-on-premises}
...
1. ここでは、ユーザーのリストが表示されます。 ユーザーを同期する専用のマーケティングツールを選択するか、 [Active Directoryフェデレーションサービス(AFDS)](https://msdn.microsoft.com/en-us/library/bb897402.aspx) 管理者に連絡して、Marketor専用の新しいユーザーを作成してください。 「ロール **の管理**」をクリックします。
...
1. 「 **設定**」を選択します。 次に、ツリーで「**Marketto Config **」を選択します。
   ...
   >[!NOTE]
   >
   >Marketor Configがない場合は、ページを更新してみてください。 問題が解決しない場合は、Marketorソリューションを [再度公開するか](step-1-of-3-install.md) 、ログアウトしてから再度ログインします。

1. 「 **デフォルト**」をクリックします。

   ![](assets/image2015-4-2-14-3a27-3a30.png)

1. クリックして ![](assets/image2015-4-2-14-3a29-3a1.png)
