...
1. Dynamics CRM にログインします。 クリック **設定**&#x200B;を選択し、次に **カスタマイズ**.
...
1. Dynamics CRM に移動します。 クリック **設定**&#x200B;を、 **プロセス**.
