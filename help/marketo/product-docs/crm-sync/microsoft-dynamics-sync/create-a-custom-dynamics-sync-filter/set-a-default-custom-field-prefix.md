...
description: Microsoft Dynamicsでデフォルトのカスタムフィールドの接頭辞を新規に設定する方法を説明します。 Marketo独自のフィールドが正しく同期されるように、設定とカスタマイズを使用します。
...
カスタムフィールドのデフォルトの [!DNL Microsoft Dynamics] 接頭辞は、Marketo 独自のフィールドを正しく同期させるために、**new** である必要があります。
