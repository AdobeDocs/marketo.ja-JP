...
1. プログラムを作成するプログラムを選択し、 **新規** ドロップダウンをクリックし、「 **新規フォルダ**」を選択します。

   ![](assets/two.png)

1. 「名前」を入力し、「 **プログラムタイプ** 」として「電子メール **」を選択して、「**&#x200B;作成」をクリックします。

   ![](assets/three.png)

   >[!NOTE]
   >
   >「 **電子メール** 」を「プログラムタイプ」として選択すると、チャネルは自動的に「 **電子メール送信**」に設定されます。 必要に応じて変更できます。
