...
<tbody>
  ...
  <tr>
    ...
    <td>メール内でセクション/モジュールを上下に移動する機能。</td>
    <td>対応可能</td>
    <td>対応可能</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>これは、既存のAEM Assets Cloud Service統合とは別に、AEM Assets Managed Servicesとの追加の統合です。 AEM Cloud Services を通じてコンテンツを使用する機能を提供します。</td>
