...
product: Marketo
title: ブランドの管理
description: E メール Designerでブランドガイドラインを作成および管理する方法について説明します。 メールのブランド設定を設定および更新します。
role: User
...
**[!UICONTROL の]** ブランド [!DNL Adobe Marketo Engage] メニューにアクセスするには、ユーザーに関連する権限を付与する必要があります。
...
ブランドガイドラインに、AI アシスタントメニューの&#x200B;**[!UICONTROL ブランド]** ドロップダウンからアクセスできるようになりました。これにより、仕様に沿ったコンテンツとアセットを生成できます。
