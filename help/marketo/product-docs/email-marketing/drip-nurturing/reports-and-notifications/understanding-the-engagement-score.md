...
エンゲージメントスコアを使用すると、エンゲージメントプログラム内のコンテンツの効果を簡単に確認できます。 スコアは0 ～ 100です。 エンゲージメ [ントダッシュボードを調べて](the-engagement-dashboard.md) 、コンテンツのパフォーマンスを追跡する方法を確認します。
...
>[!NOTE]
>
>プログラムがストリームのコンテンツとして使用される場合、エンゲージメントスコアはプログラムのメンバーシップと成功ステータスに基づき、電子メールの操作(クリック数、開く数、購読解除数 **** )に基づきません。
