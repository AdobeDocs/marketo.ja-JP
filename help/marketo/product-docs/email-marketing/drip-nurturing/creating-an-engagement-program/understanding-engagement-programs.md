...
description: Marketoのエンゲージメントプログラム、ストリーム、コンテンツ、キャスト、ケイデンスについて説明します。 ナーチャリングプログラムにおけるコンテンツの体系的な表示を理解：
...
**ユーザーケイデンス**&#x200B;は、エンゲージメントプログラムからコンテンツを受け取る機能を定義するステータスです。 **[!UICONTROL エンゲージメントプログラムケイデンスを変更]**&#x200B;フローステップを使用して、「[!UICONTROL 一時停止]」または「[!UICONTROL 通常]」に変更します。

![](assets/image2014-9-15-15-3a25-3a55.png)

## 消費済み {#exhausted}

ユーザーがストリーム内のすべてのコンテンツを受け取ると、そのユーザーは&#x200B;**疲れ**&#x200B;と呼ばれます。
