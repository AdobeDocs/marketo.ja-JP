...
あれ...この人たちはどうやってメンバーになったのでしょうか。**プログラムステータスを変更**&#x200B;フローステップでメンバーを削除できます。
...
1. **プログラムステータスを変更**&#x200B;フローステップをドラッグします。

   ![](assets/image2014-9-15-18-3a15-3a57.png)

   「**プログラムに含まれていない**」ステータスを選択します。
...
エンゲージメントプログラム内のユーザーを削除せずに一時停止したい場合があります。これは、**エンゲージメントプログラムケイデンスを変更**&#x200B;でおこなうことができます。
