...
1. 次に、1 週間ごとにケイデンスを実行するか間隔をそれ以上空けるかを選択します。 2週間ごとに選択してください。

   ![](assets/image2017-12-5-14-3a10-3a56.png)

1. 曜日を決定します。 この場合は、火曜日、水曜日、木曜日を選択します。
...
1. ケイデンスの上にマウスポインターを置きます。 将来のキャストの日が表示されます。
   ...
   >[!NOTE]
   >
   >この例では、木曜日にメールが送信されます。 翌週はスキップされ、その後の週の火曜日、水曜日、木曜日にメールが再度送信されます。 この後、このサイクルが繰り返されます。
...
1. 毎月以上の間隔を空けるかどうかを選択します。 4か月ごとに選択してください。
