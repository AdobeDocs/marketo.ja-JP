...
1. スライダーをドラッグして、チャンピオンの送信者アドレスを持つメールを受信するユーザーと挑戦者の送信元アドレスを持つメールを受信するユーザーの割合を決定します。
   ...
   >**例**
   >
   >上に示した配分では、スマートリストに指定された合計オーディエンスの 15%が、挑戦者の差出人アドレスを持つ E メールの 1 つを取得し、85%がチャンピオンの差出人アドレスを持つ E メールを受信します。 挑戦者のメール送信者アドレスが複数ある場合は、15% を均等に共有します。テストが完了したら、勝者を手動で発表できます。それ以降は、今後のすべてのユーザーに、パフォーマンスの高いコンテンツが提供されます。 トリガーキャンペーンでは、配分が選択した割合に正確に一致しない場合があるので、適合率が選択した割合と異なる場合があります。 この問題は、あるバリアントが多数の購読解除済みの人を処理する場合、または 1 つのバリアントが運用上の E メールである場合、他のバリアントが配信停止の E メールである場合に発生する可能性があります。
