---
description: 新しい電子メールDesignerの電子メールテンプレートについて説明します。 Marketo Engageでテンプレートを作成、再利用して、メール作成を高速化。
title: メールテンプレート
hide: true
...
>[!NOTE]
>
>新しい電子メールデザイナーの電子メールテンプレートは、新しい電子メールデザイナーの電子メールの作成にのみ使用できます。 古いメールエディターでは参照できません。
