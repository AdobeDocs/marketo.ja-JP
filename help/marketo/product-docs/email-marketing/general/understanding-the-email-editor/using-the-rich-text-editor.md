...
リッチテキストエディター(RTE)は、マーケティング全体に表示され、コンテンツを追加または編集する場合にいつでも使用できます。 ランディングページ、プログラム、電子メール、フォーム、スニペットで、 「ドラフトを **編集**」をクリックすると、表示されて表示されます。
...
1. [テキストエディタの **設定を編集**]をクリックします。

   ![](assets/three.png)

1. 「 **電子メール/スニペットエディタ** 」ドロップダウンで、「 <div> または「なし」をクリックし、「 **保存**」をクリックします。 <div> は、この例で使用されています。
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td><p>&lt;div class="mktEditable"&gt;<br>&lt;p&gt;テキストをここに移動&lt;/p&gt;<br>&lt;/div&gt;</p></td> 
   <td><p>&lt;div class="mktEditable"&gt;<br>&lt;div&gt;テキストをここに移動&lt;/div&gt;<br>&lt;/div&gt;</p></td> 
   <td><p>&lt;div class="mktEditable"&gt;<br>テキストをここに移動<br>&lt;/div&gt;</p></td> 
  </tr> 
 </tbody> 
</table>
...
>[!TIP]
>
>同じ手順に従ってランディングページエディタのルートブロック要素を変更することもできますが、電子メール/スニペットエディタの代わりに手順4で **ランディングページエディタ** (Email/Snippet Editor)ドロップダウンをクリックします。
...
| ![--](assets/image2015-7-9-10-3a47-3a36.png) | 下付き文字 | (O`<sub>2</sub>`)低い文字。 |
...
>[!TIP]
>
>HTMLとテキストは別の画面で編集します。 必ず「 **テキスト** 」タブの「HTMLから **コピー** 」をクリックし、テキストがHTMLと一致するように「 **保存** 」をクリックしてください。
...
1. 「 **ランディングページエディタ** 」ドロップダウンで、「 <p> または「なし」をクリックし、「 **保存**」をクリックします。 <p> は、この例で使用されています。
