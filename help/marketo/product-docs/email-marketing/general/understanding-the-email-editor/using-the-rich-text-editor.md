...
1. **[!UICONTROL メール]／[!UICONTROL スニペットエディター]**&#x200B;ドロップダウンで、「`<div>`」または「[!UICONTROL なし]」を選択して、「**[!UICONTROL 保存]**」をクリックします。 この例では `<div>` が使用されています。
...
>[!TIP]
>
>ランディングページエディターのルートブロック要素を変更することもできます。これには、同じ手順に従い、手順 4 で&#x200B;**[!UICONTROL ランディングページエディター]**&#x200B;ドロップダウン（[!UICONTROL メール]／[!UICONTROL スニペットエディター]の代わりに）をクリックします。
...
| ![--](assets/image2015-7-9-10-3a25-3a52.png) | [!UICONTROL テキストカラー] | 黒、赤、または何でも好きなもの。 |
...
| ![--](assets/image2015-7-9-10-3a45-3a1.png) | [!UICONTROL アンカーを挿入] | 錨を下ろします。 |
| ![--](assets/image2015-7-9-10-3a45-3a48.png) | [!UICONTROL 水平線] | 多くの用途があり、セクションを分割するのに最適です。 |
| ![--](assets/image2015-10-6-12-3a12-3a17.png) | [!UICONTROL HTML を編集] | HTML ソースエディターがポップアップ表示され、コードを編集できます。 |
| ![--](assets/image2015-7-9-10-3a47-3a36.png) | [!UICONTROL 下付き文字] | （O`<sub>2</sub>` のように）低く垂れ下がる文字。 |
...
1. **[!UICONTROL ランディングページエディター]**&#x200B;ドロップダウンで、「`<p>`」または「[!UICONTROL なし]」を選択して、「**[!UICONTROL 保存]**」をクリックします。 この例では `<p>` が使用されています。
