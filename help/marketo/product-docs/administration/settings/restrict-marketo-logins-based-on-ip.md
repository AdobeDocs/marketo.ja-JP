...
description: IP アドレスでMarketoへのログインを許可またはブロックする方法について説明します。
...
>
>2027 年第 1 四半期以降、Marketo Engageの IP 制限は廃止されます。 IP ベースのアクセスは AAC でのみ管理され、ログイン制限を適用するように設定する必要があります。 最終移行日は後日発表されます。
