...
1. 「**パーソナライズされたURLを有効にする**」ボックスをオンにし、「**S***ave**」をクリックします。

   ![](assets/image2014-9-24-11-3a39-3a41.png)

素晴らしい仕事！ アカウントでPURLを有効にしたので、[個々のランディングページ](../../../product-docs/demand-generation/landing-pages/personalizing-landing-pages/enable-personalized-urls-for-a-landing-page.md)に対してPURLを有効にできます。
