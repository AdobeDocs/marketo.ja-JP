...
# Workspaces追加を使用した追加のブランドドメイン {#add-an-additional-branding-domain-with-workspaces}

ワークスペースがある場合は、ブランディングドメインを追加できます。

>[!PREREQUISITES]
>
>最初に、デフォルトのブランドドメインを [編集する必要があります](edit-your-default-branding-domain.md) 。
>
>ブランディングドメインを追加する前に、まず汎用トラッキングリンク [](edit-your-default-branding-domain-with-workspaces.md) をブランディングドメインに置き換える必要があります。
