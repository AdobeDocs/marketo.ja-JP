...
[ユーザの削除](/help/marketo/product-docs/administration/users-and-roles/add-or-remove-a-user.md#remove-a-user){target="_blank"}

## Marketo Engage の API 専用ユーザ {#api-only-user-in-marketo-engage}

Marketo Engage API 専用ユーザは Marketo Engage で作成および管理する必要があります。

[Adobe IMS が有効のサブスクリプション用 API 専用ユーザの追加](/help/marketo/product-docs/administration/users-and-roles/create-api-only-user.md){target="_blank"}
