---
description: Adobe Admin ConsoleでMarketo Engage ユーザーを追加または削除するには、製品プロファイルを選択し、「ユーザー」タブを管理します。
title: ユーザーの追加または削除
...
>[!NOTE]
>
>ユーザーがAdobe Admin Consoleを介してMarketo Engageに追加されると、サブスクリプションのデフォルトワークスペース内で「標準ユーザー」ロールが付与されます。 ワークスペース内でのユーザーの役割を調整する必要がある場合は、この作業はMarketo Engageで行われます（詳細：[こちら](/help/marketo/product-docs/administration/users-and-roles/managing-user-roles-and-permissions.md){target="_blank"}）。
