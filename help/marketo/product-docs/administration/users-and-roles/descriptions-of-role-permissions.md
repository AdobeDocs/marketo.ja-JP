...
* CRM にアクセス — ユーザーが CRM にアクセスできるようにします（例： ）。 [!DNL Salesforce] または [!DNL Microsoft Dynamics]、管理
* [[!DNL Data.com]](https://Data.com) へのアクセス - Data.com のフローアクションにアクセスできるようにします
...
* アクセス [!DNL Munchkin]  — ユーザーが [!DNL Munchkin] 管理者で、トラッキングコードの設定、ユーザートラッキング、API 設定の有効化をおこないます。
