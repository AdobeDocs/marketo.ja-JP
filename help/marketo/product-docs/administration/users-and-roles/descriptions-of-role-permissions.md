...
description: Marketoのすべてのロール権限のリスト（アクセス管理者、アクセス API、ロールの作成または編集時に割り当てることができるその他の権限グループを含む）を参照します。
title: ロール権限の説明
...
* 使用権限のないアクションやアセットを表示できる場合があります。 ただし、これらにアクセスしようとすると、アクセス制限に関する警告メッセージが表示されます。
...
* Adobe Experience Managerへのアクセス - Adobe Experience Manager画面へのアクセス権を付与します
* Adobe組織マッピングへのアクセス - Adobe組織マッピング画面へのアクセス権を付与します
* 管理者監査証跡へのアクセス – ユーザーに管理者監査証跡画面へのアクセス権を付与します
* アクセス監査証跡 – アクセス監査証跡へのアクセス権をユーザーに付与します
...
* 新しいエクスペリエンスへのアクセス – 新しいエクスペリエンス画面へのアクセス権をユーザーに付与します
...
* アクセス [!DNL Munchkin] - トラッキングコードの設定、人物のトラッキング、API設定の有効化のために、管理者の[!DNL Munchkin]へのアクセス権をユーザーに付与します
* 予測オーディエンスへのアクセス – ユーザーに予測オーディエンス画面へのアクセス権を付与します
* 収益サイクル分析にアクセス - 管理の収益サイクル分析にアクセスし、同期の概要とアトリビューションを設定できるようにします
* ロールにアクセス - ユーザーではなくロールの管理および編集にアクセスできるようにします
* セールスインサイトへのアクセス - 管理のセールスインサイトを管理して、ステータス、API 設定、人物スコアリングなどの設定を行うことができるようにします
...
* Webhookへのアクセス – ユーザーがAdminでWebhookにアクセスし、詳細と応答マッピングを設定できます
...
* レポートの作成 – Analyticsおよびマーケティングアクティビティでのレポートアセットの作成、複製、読み取り、更新、移動、およびRevenue Cycle Modeler アセットへのアクセス権をユーザーに付与します
...
* メールにアクセス
   * メールの編集 - メールを編集、作成、複製できるようにします
      * 運用メールの作成と編集 – ユーザーに運用メールの作成および/または編集の権限を与えます。 詳しくは、[メールを操作可能にする](/help/marketo/product-docs/email-marketing/general/functions-in-the-editor/make-an-email-operational.md)をご覧ください
