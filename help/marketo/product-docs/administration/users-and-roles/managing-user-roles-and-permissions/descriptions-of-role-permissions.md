...
* 役割がサブ権限（「作成」、「削除」など）にアクセスできるようにするには、その役割がアプリケーションのその部分に対する「アクセス」権限を持っている必要があります。例えば、キャンペーンの編集の権限を付与する場合は、「マーケティング活動」へのアクセス権に関する全体的な権限が必要です。
...
「マーケティング活動」タブ、キャンペーン、キャンペーンフォルダーを表示します。
