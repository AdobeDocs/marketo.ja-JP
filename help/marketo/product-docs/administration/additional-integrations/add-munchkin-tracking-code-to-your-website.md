...
1. Web ページでトラッキングコードを貼り付ける場所は、`<head>` 要素内です。このページにアクセスした新しいリードは、このリードパーティションに割り当てられます。
   ...
   >[!NOTE]
   >
   >Marketoで作成したランディングページには、トラッキングコードが自動的に含まれるので、このコードを配置する必要はありません。
...
1. 次をクリック： **設定** タブ、ダブルクリック **アクティビティソース**.

   ![](assets/add-munchkin-tracking-code-to-your-website-14.png)

1. アクティビティソースをに変更します。 **匿名訪問者（ISP を含む）** をクリックし、 **適用**.
