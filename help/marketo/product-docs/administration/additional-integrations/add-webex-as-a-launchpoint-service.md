...
description: ' [!DNL Webex]  ウェビナーをLaunchPoint サービスとして追加して、Marketoに登録と出席を同期します。'
...
1. Webexが新しいタブで開きます。 Webex 資格情報を使用してログインします。

   ![](assets/add-webex-as-a-launchpoint-service-6.png)

1. ログインが成功すると、タブが閉じ、Marketo Engageの&#x200B;_新サービス_ モーダルに「Webex Webinars アカウントが設定されました」と表示されます。 「**[!UICONTROL 作成]**」をクリックします。
