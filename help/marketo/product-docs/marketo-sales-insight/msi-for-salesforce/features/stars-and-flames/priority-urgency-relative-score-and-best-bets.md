...
description: Marketo Sales Insightの優先度、緊急性、相対スコア、ベストベットについて説明します。 MSI パネルのリードスコアリングについて説明します。
...
星は相対スコアを表します。これは、リードのスコアと他のリードのスコアを比較する指標です。 相対スコアが高い場合は、相対スコアが低い場合に比べて、オーディエンスが自社のオファーに関心を持ち、情報を提供していることを意味します。
