...
[!DNL Marketo Sales Insight] を使用して、Marketo のメールを複数の人に簡単に送信できます。それでは始めましょう。
...
1. リスト表示で、メールを送信するすべてのリード／連絡先を確認し、「**[!UICONTROL Marketo メールの送信（クラシック）]**」をクリックします。
   ...
   >[!NOTE]
   >
   >[!DNL Salesforce Lightning] を使用している場合、ボタンは「**[!UICONTROL Marketo メールの送信（lightning）]**」と表示されます。
