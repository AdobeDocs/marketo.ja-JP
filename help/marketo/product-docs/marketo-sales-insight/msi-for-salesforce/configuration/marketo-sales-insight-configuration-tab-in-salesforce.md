...
description: Salesforceの「Marketo Sales Insight設定」タブについて説明します。 MSI設定を構成し、アクションを有効にします。
...
* Marketo メールの送信：これを有効にすると、すべてのセールスインサイトユーザが、リードパネル、取引先責任者パネル、アカウントパネル、商談パネルおよび「最有望見込客」タブ（一括アクションとインラインエンゲージメント）からメールを送信するアクセス権を付与されます
* Marketo Campaign に追加：これを有効にすると、すべてのセールスインサイトユーザが、リードパネル、取引先責任者パネル、アカウントパネル、商談パネルおよび「最有望見込客」タブ（一括アクションとインラインエンゲージメント）からキャンペーンに追加できるようになります
...
>[!IMPORTANT]
>
>Sales Insights アクション機能を使用していない限り、「MSI アクションを有効にする」チェックボックスを選択しないでください。
