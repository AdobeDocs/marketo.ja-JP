...
1. 使用しているOutlookのバージョンを選択し、**次へ**&#x200B;をクリックします。 この例では、Outlook オンラインを選択しています。
...
1. Outlookにログインしていない場合は、ログイン情報を入力し、**次へ**&#x200B;をクリックします。 接続したいアカウントを選択し、「**次へ**」をクリックします。 この例では、既にログインしています。
...
1. 使用しているOutlookのバージョンを選択し、**次へ**&#x200B;をクリックします。 この例では、Exchange オンプレミスを選択しています。
