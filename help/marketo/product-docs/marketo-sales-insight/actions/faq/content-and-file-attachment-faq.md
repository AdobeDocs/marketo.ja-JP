---
description: セールスメールのコンテンツと添付ファイルに関するよくある質問への回答を示します。 サイズの制限、トラッキング、ベストプラクティスについて説明します。
...
**Content**&#x200B;は、任意のファイル（PPT、PDF、Word ドキュメントなど）を記述するために使用されるものです [!DNL Sales Insight Actions]様に追跡してもらいます。
