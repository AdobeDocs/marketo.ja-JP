...
**コンテンツ**&#x200B;は、Sales Connect でトラックするあらゆるファイル（PPT、PDF、Word doc など）をSales Insight アクションで追跡する

このボタンをクリックすると、既にアップロード済みのファイルを選択するか、新しいファイルをアップロードしてトラックできます。使用するメールまたはテンプレートにリンクが挿入されます。

受信側で、受信者がリンクをクリックすると、コンテンツがブラウザーに入力されます。これにより、各ページビューを追跡し、ライブフィード内の Sales Insight Actions ユーザーにレポートできます。
...
テンプレートを作成できる任意のユーザーが、Sales Insight アクションリポジトリにコンテンツをアップロードできます。 つまり、ユーザーは選択したコンテンツをアップロードできます。
