---
description: メール、電話、InMail、カスタムタスクの各ステップを使用して、セールスキャンペーンを作成する方法を説明します。 アウトリーチの整理、拡大、測定。
title: セールスキャンペーンの作成
...
1. [電子メールの作成が完了したら、**[!UICONTROL 追加]**&#x200B;をクリックします。](/help/marketo/product-docs/marketo-sales-insight/actions/campaigns/sales-campaign-step-types-and-reminder-tasks.md#email){target="_blank"}
