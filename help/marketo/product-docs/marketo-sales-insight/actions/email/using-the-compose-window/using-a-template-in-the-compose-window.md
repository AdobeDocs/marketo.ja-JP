---
description: セールスメールを送信する際に、作成ウィンドウでテンプレートを使用する方法を説明します。 テンプレートを挿入し、素早くアクセスできるようにカテゴリをピン留めします。
...
1. **[!UICONTROL カテゴリをピン留め]**&#x200B;ドロップダウンをクリックし、目的のカテゴリを選択します。
   ...
   >[!TIP]
   >
   >多くの場合、すべてのテンプレートを検索して目的のものを見つける必要があるため、テンプレートライブラリ全体を迅速に検索できるように、「すべて」カテゴリをピン留めすることをお勧めします。 ピン留めされたカテゴリを選択して検索アイコンをクリックすると、デフォルトで、選択されたピン留めカテゴリ内を検索します。
