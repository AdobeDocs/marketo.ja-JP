---
description: コマンドセンターで、メールの列とページレイアウトについて説明します。 表示される列とメールアクティビティの表示方法をカスタマイズします。
...
<table>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>[!UICONTROL Sales Connect] の人物の名前。</td>
  </tr>
  <tr>
   <td><strong>[!UICONTROL アドレス]</td>
   <td>[!UICONTROL Sales Connect] の人物のプライマリメールアドレス。</td>
  </tr>
  <tr>
  ...
  <tr>
   <td><strong>[!UICONTROL メールのステータス]</td>
  ...
  <tr>
   <td><strong>[!UICONTROL フォローアップアクション]</td>
   <td>メール、電話、inMail、タスクによるフォローアップに使用できるクイックアクションボタン。</td>
  </tr>
  <tr>
   <td><strong>[!UICONTROL グループメール]</td>
