---
description: 共有設定を設定して、カテゴリ内でテンプレートを共有できるユーザーを制御する方法について説明します。
title: 設定の共有
...
セールスインサイトアクションアカウントを最初に作成すると、設定の共有が有効になります。これにより、アカウント管理者は、ユーザがチームのカテゴリ内のコンテンツを共有できるようにする前に、テンプレートカテゴリを作成し、整理する機会を得られます。
