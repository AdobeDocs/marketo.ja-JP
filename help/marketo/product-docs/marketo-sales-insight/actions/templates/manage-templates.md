---
description: Sales Insight Actionsでメールテンプレートを管理する方法について説明します。 テンプレートを作成、編集、共有および整理します。
title: テンプレートの管理
...
1. メールテンプレート用に、**[!UICONTROL 名前]**&#x200B;と&#x200B;**[!UICONTROL カテゴリ]**&#x200B;を選択し、「**[!UICONTROL 作成]**」をクリックします。

   ![](assets/manage-templates-3.png)

1. テンプレートエディターで、メールの件名を作成し、必要なメッセージを入力します。 編集ツール（フォント、テキストサイズなど）の使用 アピアランスをカスタマイズします。 「**[!UICONTROL 保存]**」をクリックして、変更を確定します。
...
アドビのチームアカウントをお使いの場合、すべてのテンプレートはデフォルトでプライベートのままです。
...
1. テンプレートを現在のカテゴリに保持するか、別のカテゴリに移動するかを選択できます。 この例では、現在のカテゴリに保持します。 完了したら「**[!UICONTROL 共有]**」をクリックします。
...
「**[!UICONTROL 表示]**」ドロップダウンから、すべてのテンプレート、自分のテンプレート、お気に入りのテンプレート、共有テンプレート、未共有のテンプレート、未使用のテンプレート（過去 90 日間使用されていないテンプレート）の表示を選択できます。
...
1. 「**[!UICONTROL アーカイブ]**」をクリックします。

   ![](assets/manage-templates-15.png)

1. 「**[!UICONTROL アーカイブ]**」をクリックして確定します。
