...
description: Outlook用のMarketo メールアドインライセンスを発行する方法について説明します。 ユーザーがアドインをインストールして使用できるように、ライセンスを付与します。
...
1. 「**[!UICONTROL メールアドイン]**」タブで、**[!UICONTROL ライセンスを発行]**&#x200B;をクリックします。

   ![](assets/image2016-7-22-10-3a20-3a15.png)

1. プラグインの使用を許可する必要がある営業担当者のメールアドレスを入力し、**[!UICONTROL ライセンスの発行]**&#x200B;をクリックします。 複数のメールアドレスを入力するには、コンマで区切ります。

   ![](assets/image2016-8-31-9-3a37-3a8.png)

   >[!NOTE]
   >
   >* プラグインをリモートでインストールするには、「_登録メールを送信_」チェックボックスをオフにして、IT チームに[&#x200B; エンタープライズキー](/help/marketo/product-docs/marketo-sales-insight/msi-outlook-plugin/install-the-marketo-add-in-for-outlook-with-an-enterprise-key.md)を送信します。
   >
   >* 営業担当者が自分のコンピューターに管理者アクセスできる場合は、_登録メールを送信_ チェックボックスをオンにして完了します。 受信者には、有効期限が切れる前にメール内のリンクをクリックする&#x200B;**30日**&#x200B;の期間があります。
