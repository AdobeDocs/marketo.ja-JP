---
description: Dynamicsの「Marketo」タブでweb アクティビティについて説明します。 リードと取引先責任者のweb訪問とエンゲージメントのデータを確認。
title: Web アクティビティ
...
リードの最新の web アクティビティをレビューし、ページ訪問数と各アカウントを参照します。 結果をフィルタリングして、指定したページ数に制限できます。
