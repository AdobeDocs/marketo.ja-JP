...
# Google Universal AnalyticsでのカスタムRTPダッシュボード {#custom-rtp-dashboards-in-google-universal-analytics}
...
1. Google Analyticsにログインします。 上部のメニューで「**レポート**」をクリックします。 「**ダッシュボード**」および「 **+新規カスタムダッシュボード」をクリックします。**

   ![](assets/image2015-3-22-16-3a41-3a29.png)

1. 「 **空白のキャンバス**」を選択し、 **ダッシュボード名を追加して** 「ダッシュボードを **作成**」をクリックします。

1. 「 **追加ウィジェット** 」をクリックして新しいウィジェットを作成します。\
...
「 **RTPエンゲージメントダッシュボード」という新しいダッシュボードを作成し** 、以下のウィジェットを定義します。
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td> 
    <ul> 
     <li>名前： <strong>CTA （エンゲージメント）合計</strong></li> 
     <li>タイプ： <strong>2.1指標 </strong></li> 
     <li>次の指標を表示： <strong>合計イベント数</strong></li> 
     <li>フィルター:<br><strong>[のみ表示]イベントカテゴリ（次を含む）:RTPキャンペーン</strong><br><strong>[only show]イベントアクション（完全に一致）:インプレッション</strong><strong>[表示しない]イベントラベル（含む）:#</strong></li> 
   ...
   <td> 
    <ul> 
     ...
     <li>タイプ： <strong>2.1指標 </strong></li> 
     <li>次の指標を表示： <strong>合計イベント数</strong></li> 
     <li>フィルター:<br><strong>[のみ表示]イベントカテゴリ（次を含む）:RTPキャンペーン</strong><br><strong>[only show]イベントアクション（完全に一致）:クリック数</strong><strong>[表示しない]イベントラベル（含む）:#</strong></li> 
   ...
   <td> 
    <ul> 
     ...
     <li>次の指標を表示： <strong>Pageviews</strong></li> 
  ...
  <tr> 
   <td colspan="1"> 
    <ul> 
     ...
     <li>タイプ： <strong>2.1指標 </strong></li> 
     <li>次の指標を表示： <strong>平均 セッション期間</strong></li> 
     <li>フィルター:<br><strong>[のみ表示]イベントカテゴリ（完全に一致）:RTPキャンペーン</strong><br><strong>[only show]イベントアクション（完全に一致）:impression</strong><strong>[表示しない]イベントラベル（含む）:#</strong></li> 
   ...
   <td colspan="1"> 
    <ul> 
     ...
     <li>タイプ： <strong>2.1指標 </strong></li> 
     <li>次の指標を表示： <strong>平均 セッション期間</strong></li> 
     <li>フィルター:<br><strong>[のみ表示]イベントカテゴリ（完全に一致）:RTPキャンペーン</strong><br><strong>[only show]イベントアクション（完全に一致）:clicks</strong><strong>[don't show]イベントラベル（含む）:#</strong></li> 
   ...
   <td colspan="1"> 
    <ul> 
     <li>名前： <strong>CRE — 推奨コンテンツのトップ</strong></li> 
     <li>タイプ： <strong>表</strong><br></li> 
     <li>次の列を表示します。 <br><strong>ページタイトル |ページビュー</strong><br></li> 
     <li>フィルター:<br>フィルタ： <strong>[only show]ページ（含む）:rcmd</strong></li> 
  ...
  <tr> 
   <td> 
    <ul> 
     <li>名前： <strong>CTA別のインプレッション数</strong></li> 
     <li>タイプ： <strong>表</strong></li> 
   ...
   <td> 
    <ul> 
     ...
     <li>タイプ： <strong>表</strong></li> 
     <li>次の列を表示します。 <strong>イベントラベル |合計イベント数 |ユーザー</strong></li> 
     <li>フィルター:<br><strong>[のみ表示]イベントカテゴリ（完全に一致）:RTPキャンペーン</strong><br><strong>[only show]イベントアクション（完全に一致）:クリック</strong></li> 
