...
description: Marketo Engageでgoogle analyticsとrtpを統合する方法については、こちらをご覧ください。 このガイドを使用して、次のステップを完了してください。
...
1. メール <rtp.ga2@gmail.com>を読み取りおよび分析ユーザーとしてGA アカウントに追加します。 詳細は[こちら](https://support.google.com/analytics/answer/2884495?hl=ja)をご覧ください。
