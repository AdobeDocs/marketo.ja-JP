...
description: Dnl webによるリターゲティングなど、Marketo Engageのweb パーソナライゼーションデータを使用したリターゲティングについて説明します。 このガイドを使用して、次のステップを完了してください。
...
>[!TIP]
>
>業界用や、ドメイン設定で既に送信されているその他のデータ用に、セグメント化オーディエンスを作成する必要はありません。 既知の人物データにもとづくセグメントには、セグメント化されたオーディエンスを使用することをお勧めします。
