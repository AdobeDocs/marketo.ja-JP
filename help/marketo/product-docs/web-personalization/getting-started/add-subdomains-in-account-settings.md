...
1. サブドメインのURLを入力します。 サブドメインのリストを管理するに **は、追加** または **「** 削除 **」をクリックし、完了したら「** OK」をクリックします。
...
1. 新しく追加したサブドメインが表示されます。
   ...
   >[!NOTE]
   >
   >アカウントに *プライマリ* ドメインを追加する場合は、マーケティング担当者にお問い合わせください [](http://docs.marketo.com/cdn-cgi/l/email-protection#5e2d2b2e2e312c2a1e333f2c353b2a31703d3133)。
