...
description: Webセグメント —Marketoドキュメント — 製品ドキュメント
title: Webセグメント
...
### 認識済み担当者 {#known-people}

**データベース**

Web Personalizationは、Marketo・データベースと統合されており、既知の個人属性やデータに基づいてキャンペーンをセグメント化し、パーソナライズできます。
...
>[!TIP]
>
>役職など、Marketoの人からのすべての個人データフィールドに従って、セグメント条件を作成します。スコア；役割；等
>
>例: 「役職がCMOに等しい」および「スコアが50以下」

**Marketo電子メール** キャンペーン訪問者がMarketoの電子メールをクリックしてサイトに到着した際の電子メールの照会によるキャンペーンのセグメント化およびパーソナライズ。Marketo のプログラム名またはキャンペーンによってセグメント化し、メールから Web へのコンバージョンを継続します。「+」を選択して、ドロップダウンからフィールドを追加します。
...
OK！「セグメント」セクションを理解したら、キャンペーンについて学びましょう。
