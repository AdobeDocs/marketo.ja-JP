...
description: ゾーン IDに基づいてweb サイトの要素をパーソナライズされたコンテンツまたはグラフィカルバナーに置き換えるゾーン web キャンペーンを作成します。 ゾーン IDを使用して、web サイトの特定の領域をターゲティングします。
...
1. キャンペーンタイプとして「**[!UICONTROL ゾーン内]**」を選択します。 カスタマイズして、**[!UICONTROL ゾーン ID].**&#x200B;を追加します キャンペーンを&#x200B;**[!UICONTROL スティッキー]**&#x200B;に設定し、クリエイティブをエディターに追加します。 プレビューするページの URL を追加して「**[!UICONTROL プレビュー]**」をクリックし、このキャンペーンがサイトでどう応答するかを確認します。
