...
プログラムのQAでは、Marketoのベストプラクティスに照らし合わせて設定が自動的にチェックされ、ローンチ前に問題が表面化されます。 [&#x200B; プログラムの検証エージェント &#x200B;](/help/marketo/product-docs/marketo-ai/agents/validate-programs.md){target="_blank"}の詳細をご覧ください。
