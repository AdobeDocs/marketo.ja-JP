---
description: Marketo EngageのモダンなUXに加え、強化された使いやすさと新しいルックアンドフィールを備えた更新されたインターフェイスについてご確認ください。
...
>[!TIP]
>
>ツリー内で検索を使用すると、現在のセクション（マーケティングアクティビティなど）の結果のみが得られます。 インスタンス全体を検索する場合は、グローバル検索を使用します。
