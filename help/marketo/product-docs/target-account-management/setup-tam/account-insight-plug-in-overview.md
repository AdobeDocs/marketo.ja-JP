...
>
>* このプラグインは、現時点では [0}Adobe ID 認証 } と互換性がありません。](/help/marketo/product-docs/administration/marketo-with-adobe-identity/adobe-identity-management-overview.md){target="_blank"}
