...
description: 理想的な顧客プロファイルからAIを活用したレコメンデーションを使用して、ターゲットとする新しいアカウントを見つける方法を説明します。 新しいターゲットアカウントを発見してアカウントリストに保存。
title: 新しい顧客の検出
...
>[!TIP]
>
>新しいアカウント検索を実行する前に、**既存アカウントの更新** ボタンを押して、最新のデータを確認することをお勧めします。 この更新には、最大 24 時間かかる場合があります。
