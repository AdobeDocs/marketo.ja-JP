...
description: Sales Connectのコンテンツと添付ファイルに関する質問に対する回答を取得します。 サイズ制限、トラッキング、添付ファイルのオプションについて説明します。
...
**Content**&#x200B;は、任意のファイル（PPT、PDF、Word ドキュメントなど）を記述するために使用されるものです [!DNL Sales Connect]様に追跡してもらいます。
