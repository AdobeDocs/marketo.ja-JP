...
E-book、 [GDPR、The MarketerのMarkettoプラットフォーム内での同意と説明責任に関する広範な情報を提供します](http://www.marketo.com/ebooks/the-gdpr-and-the-marketer/)。 ただし、この記事では、特にMarketo Sales Connectの新機能に焦点を当て、お客様の組織がGDPRルールを遵守する際に役立つようにします。
...
「個人の詳細」表示が開いたら、「準拠カード」で「 **編集** 」をクリックします。
...
「認証タイプ」または「ソース・タイプ」に「その他」を選択した場合は、ソース・タイプを説明するテキストを入力できます。** ![](assets/7.png)
...
## Marketo Sales Connectからの連絡先データのエクスポート {#exporting-contact-data-from-marketo-sales-connect}
...
**Unsubscribe Sync:** ユーザーは、CRM(Salesforce)との間で登録解除を同期して、オプトアウトが最新の状態に保たれます。\
**登録解除履歴：** ユーザーは、個人情報表示に過去のオプトアウトやオプトインを表示できます。\
**登録解除の削除：** 登録解除された連絡先を再度オプトインするには、ユーザーに管理者権限が必要です。また、その連絡先に連絡するための新しい同意が与えられたことを示す必要があります。
...
当社は、規制当局および関連法によって発行された、適用可能なGDPRガイダンスを引き続き詳細にトラッキングする。 更新情報は、 [trust.marketo.comのTrust Centerに投稿されます](http://trust.marketo.com)。
