...
description: コンテンツロックダウンを有効にして、管理者以外のユーザーがテンプレートやキャンペーンを編集するのを制限する方法を説明します。
title: コンテンツのロックダウン
...
1. 「[!UICONTROL コンテンツのロックダウン]」まで下にスクロールします。 どちらかのスライダーをオンにすると、チームメンバーがテンプレートやキャンペーンを作成／編集&#x200B;_できなくなります_。
