...
>[!CAUTION]
>
>次の場合、 [フィルターの使用](https://support.google.com/mail/answer/6579?hl=en#zippy=%2Ccreate-a-filter%2Cedit-or-delete-filters){target=&quot;_blank&quot;} または Gmail アカウントのルールでメールを自動的に既読としてマークすると、返信の追跡で問題が発生する可能性があります。 Gmail で返信追跡を使用する場合に、メールを自動的に既読としてマークするルールを無効にすることをお勧めします。
