...
既に送信済みの電子メールをログに記録できるように機能を変更しようとしています。 それまでの間、電子メールが送信時に自動的にログに記録されなかった場合、または [アクティビティログに失敗したアクティビティが表示された場合は](http://docs.marketo.com/pages/assets/external-link.jspa)、 [Salesforce BCC電子メールアドレスに転送できます](http://docs.marketo.com/x/soLS)。
