...
>[!NOTE]
>
>これは、[!DNL Gmail] または [!DNL Exchange] と統合されており、返信トラッキングが有効になっている顧客のみが利用できます。
...
送信済みフォルダーで、フィルターを「[!UICONTROL  すべて ]」に設定してキャンペーンから削除する連絡先を選択し、キャンペーンを受信したすべてのユーザーを取り込みます。
