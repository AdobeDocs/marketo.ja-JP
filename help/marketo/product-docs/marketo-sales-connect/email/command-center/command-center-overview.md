...
description: セールスコネクトのコマンドセンターについて説明します。 メールタスク、メール送信、フォローアップを1か所で管理できます。
title: コマンドセンターの概要
...
<table>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td title="背景色：グレー"><p>下書きとして保存された電子メール。<br><strong>注意：</strong>下書きとして保存できるのは、1通の電子メールのみです。 一括メール（「メールを選択して送信」と「メールをグループ化」）は下書きとして保存されません。</p></td>
  </tr>
  <tr>
   <td title="背景色：グレー"><br></td>
  ...
  <tr>
   ...
   <td title="背景色：青"><p>受信者によって手動で迷惑メールとしてマークされた電子メール。<br><strong> メモ：</strong>これは、従来のToutApp ユーザーであり、配信チャネルとしてMSC サーバーにアクセスできる場合にのみ検出されます。</p></td>
  </tr>
 </tbody>
</table>
