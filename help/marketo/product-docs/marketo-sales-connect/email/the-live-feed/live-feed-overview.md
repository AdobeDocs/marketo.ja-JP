...
description: セールスコネクトのライブフィードについて説明します。 マーケティング部門と営業部門の協力を得て、電子メールやコンテンツのエンゲージメントをリアルタイムで確認できます。
title: ライブフィードの概要
...
>[!NOTE]
>
>一般的に、場所は IP トラッキングに基づいて可能な限り正確に特定されていますが、 残念ながら、正確な科学ではありません。 受信者の 1 人に対して場所が正しくない場合、その理由に関するいくつかのオプションを次に示します。
>
...
クイックアクションボタンを使用して、通話、メールの送信、リードの [!DNL Linkedin] プロファイルへの移動をすばやく行うことができます。
...
* 上位 50 名のリードが表示されます。
* [!DNL Salesforce] で割り当てられたリードのみが表示されます。
...
>[!NOTE]
>
>誰かがライブフィードでメールを何度も閲覧した場合、その人はそのメールを他の受信者に転送した可能性があります。 表示の場所が変更され始めたことに気付いたら、多くの場合これが理由です。
