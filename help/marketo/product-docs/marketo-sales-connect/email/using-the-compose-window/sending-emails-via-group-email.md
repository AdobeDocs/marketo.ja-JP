...
description: Sales Connect でグループメールを使用してメールを送信する方法を説明します。 1 つのメールをグループに送信し、受信者ごとにエンゲージメントを追跡します。
...
1. 「[!UICONTROL グループアクション]」ボタンをクリックし、「**[!UICONTROL グループにメールを送信]**」を選択します。
