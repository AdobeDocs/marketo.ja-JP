...
description: セールスコネクトの購読解除履歴カードについて説明します。 連絡先が購読解除されたタイミングと方法を個人の詳細ビューで表示します。
title: 登録解除履歴カード
...
>[!NOTE]
>
>ここにアクセスするには、「[!UICONTROL 人物]」タブをクリックし、ユーザを選択します。 人物の詳細ビューの「[!UICONTROL 約]」タブの下部にあります（購読を解除している場合）。
