...
description: Sales Connect をSalesforce サンドボックスに接続する方法について説明します。 サンドボックス環境で統合をテスト用に設定します。
...
1. [!DNL Salesforce] カードで、「**[!UICONTROL さらに詳しく]**」をクリックします。
...
1. ページの下部で、「**[!UICONTROL サンドボックスに接続]**」をクリックします。
   ...
   >[!NOTE]
   >
   >既に [!DNL Salesforce Sandbox] アカウントにログインしている場合は、認証ページが表示され、アクセスを許可する必要があります。まだログインしていない場合は、手順 5 に進みます。

1. [!DNL Salesforce Sandbox] アカウントのユーザ名とパスワードを入力します。
