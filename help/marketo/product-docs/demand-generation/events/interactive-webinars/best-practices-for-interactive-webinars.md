---
description: Marketoのインタラクティブウェビナーのベストプラクティスに関するヘルプを参照してください。 ウェビナーのエンゲージメント、配信、フォローアップを改善する。
...
バーチャルイベントを実施する際には、小規模なオーディエンスであれ大規模なオーディエンスであれ、物事が計画通りに進むことが重要です。 イベントの計画と実行には、準備、プロモーションから、配信、フォローアップに至るまで、様々な手順が必要なので、多くの作業のように感じることがあります。

次のベストプラクティスは、ウェビナーの企画、設計、成功に役立ち、魅力的なウェビナーを生み出すのに役立ちます。 これらのヒントは、Adobe Connectのインタラクティブなウェビナーを最大限に活用するのに役立ちます。
...
>[!TIP]
>
>インタラクティブウェビナーのモバイル web エクスペリエンスはレスポンシブではないので、モバイルデバイスでシームレスなウェビナーエクスペリエンスを実現するには、Adobe Connect アプリを使用することをお勧めします。 Adobe Connect アプリは現在、中国のアプリストアでは利用できません。

* 最初から作成開始することを回避するには、サンプルのインタラクティブウェビナー（IW）を作成し、毎回複製します。

* 後で同じコンテンツを再度配信する場合は、Adobe Connect ルームを再利用します。 ポッドメニューから&#x200B;**ポッドからコンテンツをクリア**&#x200B;に移動して、チャット履歴と、最後のセッションの投票／クイズの結果をクリアします。 これにより、部屋のコンテンツが消去されます。 以前のセッションのすべてのデータは、引き続き Marketo Engage で使用できます。
...
* チームメンバーにロールを割り当てます。 共同主催者およびプレゼンターとして追加します。 主催者とプレゼンターは、参加者より先にルームに入ることができます。 しかし、[共同ホストとプレゼンターを追加する&#x200B;_前_&#x200B;に](/help/marketo/product-docs/demand-generation/events/interactive-webinars/designing-interactive-webinars.md){target="_blank"} インタラクティブウェビナーをデザインします。
...
* 登録済みの招待者にリマインダーメールを送信する場合は、イベント当日のウェビナー&#x200B;_および_&#x200B;の2～3日前に行い、参加者が忘れずに参加できるようにします。
...
* 100人以上の参加者を想定している場合は、開いたダイアログ（チャットポッド）からモデレーションされたダイアログ（Q&amp;A ポッド）に切り替えることを検討してください。 オーディエンスが多い場合、活発なチャットを主催者が監視するのは困難になる可能性があります。
...
* 主催者とプレゼンターの領域を有効にし、関連するポッドで設定します。 この領域は、主催者とプレゼンターにのみ表示され、バックステージでの共同作業に使用できます。 こちらに含めるポッドの一部は次のとおりです。
   * エンゲージメントダッシュボード：参加者のエンゲージメントをリアルタイムで監視します。 エンゲージメントダッシュボードの使用方法に関する短いビデオを見るには、[ここをクリック ](https://www.youtube.com/watch?v=gf5fu0JK9Hk){target="_blank"}します。
...
* カスタムポッドは、Adobe Connect ルームの機能を拡張する際に使用できるサードパーティアプリです。 カスタムポッドは、`apps.adobeconnect.com` から .pod ファイルまたは .zip ファイルとしてダウンロードでき、共有ポッドで共有できます。
   ...
   * カスタムポッドの使用方法に関する短いビデオを見るには、[ここをクリック ](https://www.youtube.com/watch?v=1w5nqJqEHQw){target="_blank"}します。
...
* **チャットパネル**：チャットパネルは、セッション録画の対象外のチャット領域です。 そのため、録画にチャットを表示しない場合は、チャットポッドの代わりにチャットパネルを使用します。 チャットパネルの使用について詳しくは、[ここをクリック ](https://helpx.adobe.com/jp/adobe-connect/using/notes-chat-q-a-polls.html#chat_panel){target="_blank"}してください。
...
* オーディオ/ビデオの設定をテストし、以前に使用したことがない場合はAdobe Connectを知り合うために、いくつかのドライランを実行します。 リハーサルの際には、プレゼンターと共同ホストも参加させましょう。
...
* 画面共有しているプログラムを適切なウィンドウに開き、デモンストレーションする準備をしてください。 画面共有中にプログラムの起動やログインを回避します。

* 参加者は、開始予定時刻の 15 分前からルームに入ることができます。 早めに到着する参加者のために、開始予定時刻の 15 分前にロビーレイアウトに切り替えます。

* プライベートで調整するには、主催者とプレゼンターの領域をバックステージ領域として使用します。 [ここをクリック ](https://www.youtube.com/watch?v=11GkcvIUttY){target="_blank"}して、ホストとプレゼンター領域に関する短いビデオを視聴します。

* 直前の変更をプライベートで行うには、準備モードを使用します。 [準備モードに関する短いビデオを見るには、ここをクリック ](https://www.youtube.com/watch?v=kUya84sx-E4){target="_blank"}してください。
