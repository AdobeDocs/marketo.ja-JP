---
description: インタラクティブウェビナーにウェビナーチームを追加する方法について説明します。 ウェビナーの作成、管理、配信に役立つメンバーをチームメンバーに割り当てます。
title: ウェビナーチームの追加
...
1. 内部ユーザまたは外部ユーザを追加できます。 この例では、外部を選択します。
   ...
   >[!NOTE]
   >
   >**内部インタラクティブウェビナーユーザー**&#x200B;を選択した場合、「**利用可能なホスト**」ドロップダウンをクリックし、Marketo Engageでインタラクティブウェビナーユーザーとして追加されたユーザーのリストから選択する必要があります。 既存の主催者は既に主催者なので、このドロップダウンには表示されません。
