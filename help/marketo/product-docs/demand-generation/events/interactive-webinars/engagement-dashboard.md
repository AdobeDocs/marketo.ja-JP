...
* **オンデマンドセッション**: ライブイベントの録画は、独自のイベントとして利用できます。 新しい招待者は登録して録画を視聴できます。 登録後、彼らはイベント参加リンクを受け取ります。これにより、イベント終了後にイベントの録画に移動します。 ライブイベントに登録された参加者は、同じ参加リンクを使用して録画を表示することもできます。
