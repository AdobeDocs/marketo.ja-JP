...
description: ReadyTalk -Marketoドキュメント — 製品ドキュメントを使用してイベントを作成する
...
最初に、ReadyTalkコンファレンスセンターでイベントをセットアップします。 ヘルプが必要な場合は、[ReadyTalkリソースセンター](https://www.readytalk.com/resources/readytalk)をご覧ください。 登録の種類を選択する場合は、会議&#x200B;**の前に**&#x200B;事前登録を選択します。 _の会議時に_&#x200B;登録を選ぶと、Marketoは&#x200B;****&#x200B;人々の登録ステータスを捕捉しません。また、ウェビナーの終了後は、_出席済み_&#x200B;の個人ステータスのみを引き込みます。
...
これで、イベントをMarketoにリンクする準備が整いました。
