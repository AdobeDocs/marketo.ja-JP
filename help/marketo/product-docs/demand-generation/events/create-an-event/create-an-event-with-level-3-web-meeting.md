...
description: Marketoでレベル 3 の Web 会議のイベントを作成する方法を説明します。 統合を設定し、Web ミーティング登録をMarketoと同期します。
...
まず、[!DNL Level 3] でウェビナーを作成します。ヘルプが必要な場合は、[[!DNL Level 3]  リソースライブラリ](https://www.level3.com/en/resource-library/)をご覧ください。[!DNL BrightTalk] と非常に似ていることがわかります。Marketo は、[!DNL Level 3] フィールドの小さなサブセットを使用します。
...
1. 「**[!UICONTROL 保存]**」をクリックします。
   ...
   最高です。イベントを [!DNL Level 3] に接続しました。
