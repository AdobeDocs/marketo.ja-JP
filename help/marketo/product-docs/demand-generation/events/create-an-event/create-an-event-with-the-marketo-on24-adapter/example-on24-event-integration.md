...
description: ON24 イベントとMarketoの統合例から学びましょう。 ウェビナーの作成から登録の同期に至るまでのサンプルフローを確認しましょう。
title: ON24 イベント統合の例
...
次に、ON24 ウェビナーのキャンペーンを含むサンプルイベントを示します。 イベントを構築する場合は、キャンペーンを実行する前にテストします。
...
* **スマートリスト**
   ...
   * **[!UICONTROL フォームへの記入]**&#x200B;に基づいてキャンペーンをトリガーします。 フォームが複数のランディングページで使用されている場合は、特に&#x200B;**[!UICONTROL 制約を追加]**&#x200B;を使用して、フォームが存在するランディングページを含めます。
...
**メモ**：類似のキャンペーンを使用して、招待されたが登録していないユーザーに&#x200B;*different*&#x200B;のフォローアップメールを送信できます。
