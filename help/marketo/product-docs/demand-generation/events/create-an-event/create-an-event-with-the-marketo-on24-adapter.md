...
* [Marketo Programs](/help/marketo/product-docs/core-marketo-concepts/programs/creating-programs/understanding-programs.md){target=&quot;_blank&quot;} とイベントの違い、およびそれらの違い
...
>[!NOTE]
>
>詳しくは、 [Marketo API ドキュメント](https://developers.marketo.com/documentation/rest/){target=&quot;_blank&quot;} を参照してください。
...
1. [イベントの設定とMarketoとウェビナーの同期](/help/marketo/product-docs/demand-generation/events/create-an-event/create-an-event-with-the-marketo-on24-adapter/configure-event-settings-and-sync-marketo-with-your-webinar.md){target=&quot;_blank&quot;}
