...
>[!NOTE]
>
>を参照してください [Marketo API ドキュメント](https://experienceleague.adobe.com/en/docs/marketo-developer/marketo/rest/rest-api){target="_blank"} Marketo API について詳しくは、こちらを参照してください。
...
1. [イベント設定の指定とMarketoとウェビナーの同期](/help/marketo/product-docs/demand-generation/events/create-an-event/create-an-event-with-the-marketo-on24-adapter/configure-event-settings-and-sync-marketo-with-your-webinar.md){target="_blank"}
