...
>[!NOTE]
>
>現時点 **では、Adobe Connectオンサイトはサポートしていません** 。

1. 新しいイベントのホームページで、「 **イベントの操作**」、「 **イベントの設定**」の順に選択します。

   ![](assets/image2015-1-30-15-3a34-3a28.png)

   >[!NOTE]
   >
   >ドロップダウンに **イベント設定が表示されない場合は、イベントのチャネルで、「適用先」の下で「ウェビナー** 」が選択されていることを確認してください **** 。

1. 「 **イベントパートナー**」で、「 **Adobe Connect**」を選択します。

   ![](assets/event-settings-adobe-connect.png)

1. 「 **ログイン** ID」を選択し、 **イベントを選択します**。
...
1. 「 **保存**」をクリックします。
   ...
   >[!TIP]
   >
   >データがマーケティング担当者に表示されるまで、最大48時間かかる場合があります。 それでも表示されない時間が経過しても、イベントの「概要」タブにある「イベントの操作」メニューから **** 「ウェビナープロバイダーから更新」を選択します。
