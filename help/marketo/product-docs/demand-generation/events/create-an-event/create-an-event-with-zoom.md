...
ウェビナーに関する次の情報を入力すると、アダプターを介して Marketo に取り込まれます。この情報に変更を加えた場合、Marketoで変更内容を確認するには、「イベントアクション」の下の「ウェビナープロバイダーから更新」リンクをクリックする必要があります。
...
1. 「**保存**」をクリックします。
   ...
   >[!TIP]
   >
   >Marketo にデータが表示されるまでには、最大 48 時間かかる場合があります。その間待っても何も表示されない場合は、イベントの **概要** タブにあるイベントアクションメニューから **ウェビナープロバイダーから更新** を選択し、画面の右下にある更新アイコンをクリックします。
