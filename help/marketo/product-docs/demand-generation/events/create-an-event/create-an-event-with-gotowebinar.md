...
Marketorイベントを作成し、GoToWebセミナーを関連付けると、登録情報と出席情報を共有できるようになります。
...
ウェビナーの次の情報を入力すると、アダプタを介してMarketoに取り込まれます。 この情報に変更を加えた場合、変更をマーケターに表示するには、**イベントアクション**&#x200B;の下の「ウェビナープロバイダー&#x200B;**から更新」リンクをクリックする必要があります。**
