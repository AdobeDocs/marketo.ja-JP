...
1. 以下の表を参照して、各Socialアプリで機能するトリガーとフィルターを確認します。
   ...
   | トリガー/フィルター | ソーシャルボタン | 投票 | 動画 | 紹介オファー | 懸賞 |
   |---|---|---|---|---|---|
   | 紹介の目標を達成 |  |  |  | ![（目盛り）](assets/check.svg) |  |
   | コンテンツの共有 | ![（目盛り）](assets/check.svg) | ![（目盛り）](assets/check.svg) | ![（目盛り）](assets/check.svg) | ![（目盛り）](assets/check.svg) | ![（目盛り）](assets/check.svg) |
   | 共有リンクをクリック | ![（目盛り）](assets/check.svg) | ![（目盛り）](assets/check.svg) | ![（目盛り）](assets/check.svg) | ![（目盛り）](assets/check.svg) | ![（目盛り）](assets/check.svg) |
   | 懸賞失格 |  |  |  |  | ![（目盛り）](assets/check.svg) |
   | ソーシャルアプリのエントリ獲得 |  |  |  |  | ![（目盛り）](assets/check.svg) |
   | 懸賞への参加 |  |  |  |  | ![（目盛り）](assets/check.svg) |
   | ソーシャルアプリ参照 |  |  |  | ![（目盛り）](assets/check.svg) | ![（目盛り）](assets/check.svg) |
   | 照会オファーへのサインアップ |  |  |  | ![（目盛り）](assets/check.svg) |  |
   | 投票に参加 |  | ![（目盛り）](assets/check.svg) |  |  |  |
   | 懸賞当選 |  |  |  |  | ![（目盛り）](assets/check.svg) |
