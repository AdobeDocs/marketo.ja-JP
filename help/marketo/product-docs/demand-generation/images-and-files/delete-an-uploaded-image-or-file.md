...
description: Marketoからアップロードした画像またはファイルを削除する方法について説明します。 Design Studioから不要になったアセットを削除します。
...
1. 目的の画像/ファイルを検索して選択します。 **[!UICONTROL 画像とファイルのアクション]** ドロップダウンをクリックし、**[!UICONTROL 削除]**&#x200B;を選択します。
