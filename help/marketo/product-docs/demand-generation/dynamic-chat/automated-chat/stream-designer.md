---
description: チャット会話を構築するためのストリームDesignerとカードについて説明します。 メッセージ、質問、ドキュメントキャプチャ、ミーティングの予約などをダイアログに追加します。
title: ストリームデザイナー
...
1. 目標に名前を付け（または既存の目標を選択）、「**[!UICONTROL 保存]**」をクリックします。会話スコアの割り当てはオプションです。
