---
description: Dynamic ChatでDocument CardにAdobe PDF Embed APIを設定する方法について説明します。 ダイアログにPDFを埋め込み、ドキュメントのエンゲージメントを追跡します。
...
ドキュメントカードを使用すると、ダイアログに PDF ドキュメントを埋め込み、訪問者のドキュメントエンゲージメントアクティビティを追跡できます。 次の手順に従って設定します。
...
1. 資格情報を入力し、利用規約に同意して、「**[!UICONTROL 資格情報を作成]**」をクリックします。
   ...
   >[!IMPORTANT]
   >
   >チャットボットをホスティングするドメインを使用する必要があります（例：mycompany.comでチャットボットをホスティングしている場合は、ステップ 4でそのドメインを入力します）。
...
ダイアログの[Stream Designer](/help/marketo/product-docs/demand-generation/dynamic-chat/automated-chat/stream-designer.md){target="_blank"}でドキュメントカードを使用できるようになりました。
