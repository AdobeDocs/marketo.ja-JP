---
description: Dynamic Chatのアクセス、インストール、データ保持、言語サポートに関するお問い合わせ。 Marketo Engage Dynamic Chatに関するよくある質問への回答を示します。
...
90 日です。制限/パラメーターの完全なリストについては、Marketo Engage[Product Description page](https://helpx.adobe.com/jp/legal/product-descriptions/adobe-marketo-engage---product-description.html){target="_blank"} を参照してください。
