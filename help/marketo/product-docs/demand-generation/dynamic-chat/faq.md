...
**Dynamic Chatを使用していますが、自分のMarketoにDynamic Chat タイルが表示されません。 どうすれば入手できますか？**

experience.adobe.comのアプリメニューからDynamic Chatにアクセスし、**Configuration** > **Integrations**&#x200B;経由でMarketoに接続します。 接続後、タイルが表示されます。
