---
description: Dynamic Chatでのミーティングのルーティングとライブチャットについて説明します。 ラウンドロビンまたはカスタムルールを設定して、特定のエージェントやチームに訪問者を割り当てることができます。
title: ルーティング
...
この例では、CA、OR、およびWAの推測状態からのすべての会議がエージェント Johnにルーティングされます。
...
この例では、Legoのすべての従業員が直接Steven担当者にルーティングされています。
