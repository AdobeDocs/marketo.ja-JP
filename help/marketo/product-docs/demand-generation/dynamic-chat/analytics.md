---
description: エンゲージメントとパフォーマンスを向上させるDynamic Chat analytics ダッシュボードについて説明します。 ダイアログの指標、ミーティング予約、ライブチャットのパフォーマンスを表示し、結果を書き出すことができます。
title: 分析
...
ダイアログ、対話型フロー、またはすべてを表示します。 既知の訪問者、不明な訪問者、またはその両方で並べ替えます。 プリセットまたはカスタムの日付範囲を選択します。 「 」ボタンをクリックして、結果をエクスポートします。
...
ダイアログ、対話型フロー、またはすべてを表示します。 プリセットまたはカスタムの日付範囲を選択します。 「 」ボタンをクリックして、結果をエクスポートします。
...
ダイアログ、対話型フロー、またはすべてを表示します。 プリセットまたはカスタムの日付範囲を選択します。 ボタンをクリックして結果をエクスポートします。
