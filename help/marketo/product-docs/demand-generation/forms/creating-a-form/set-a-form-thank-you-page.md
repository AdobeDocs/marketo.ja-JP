...
# フォーム「ありがとうございます」ページの設定 {#set-a-form-thank-you-page}
...
1. 「 **ありがとうございます********** ページ」セクションまで下にスクロールします。

## ページを維持 {#stay-on-page}

「ページに留まる」オプションを選択すると、フォームが送信された場合に、訪問者は同じページに維持されます。

1. 「 **Stay** On **Page****On****Page** 」を選択します。Follow **Follow** for **** Up  With Up Page
...
1. 「 **Follow Up** 」に対して「 **External** URL **」を選択します。こ** れは「Follow ******** Up」を選択します。
