...
description: Marketoでフォームを削除する方法を説明します。 インスタンスから不要なフォームを削除します。
title: フォームの削除
...
不要で使用されていないフォームがある場合は、 手順は以下のとおりです。
...
1. 「**[!UICONTROL フォームアクション]**」で、「**[!UICONTROL フォームを削除]**」をクリックします。
   ...
   >[!NOTE]
   >
   >フォームは必ず、フォームを使用しているすべてのランディングページから削除してください。 また、フォームが公開web サイトで使用されていないことを確認します。
