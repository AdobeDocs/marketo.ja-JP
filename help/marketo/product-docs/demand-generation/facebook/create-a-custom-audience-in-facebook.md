...
description: MarketoからFacebookでカスタムオーディエンスを作成する方法を説明します。 MarketoのリストをFacebookに送って、ターゲットを絞った広告施策を実施できます。
...
1. 「**[!UICONTROL オーディエンス名]**」を入力します。 「**[!UICONTROL 更新]**」をクリックします。
   ...
   >[!TIP]
   >
   >新しいオーディエンスを、広告セットまたはグループに現在関連付けられている既存のオーディエンスと入れ替えるには、「**[!UICONTROL 既存のオーディエンスを置き換え]**」チェックボックスをオンにします。 これを行っても、置換されるオーディエンスは&#x200B;**削除されません**。

1. 完了すると、ステータスダイアログが更新されます。

   ![](assets/create-a-custom-audience-in-facebook-6.png)

   Facebookでは、**Ads Manager** > **Audiences**&#x200B;に新しいオーディエンスが表示されます。
