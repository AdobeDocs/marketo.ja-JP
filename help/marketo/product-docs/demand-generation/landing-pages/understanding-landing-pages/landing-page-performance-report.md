...
>[!NOTE]
>
>[分析付きソーシャルボタン](/help/marketo/product-docs/demand-generation/landing-pages/free-form-landing-pages/add-a-social-button-to-a-free-form-landing-page.md)によって生成されたアクティビティはここには含まれていません。これらの統計については、[ソーシャルダッシュボード](/help/marketo/product-docs/demand-generation/social/social-functions/view-social-performance.md)を確認してください。
