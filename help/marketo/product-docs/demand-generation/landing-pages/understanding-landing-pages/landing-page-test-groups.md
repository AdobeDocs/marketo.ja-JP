...
description: Marketoのランディングページテストグループについて説明します。 A/B テストや多変量テストを実施して、ランディングページのパフォーマンスを比較。
...
1. Design Studio で「**[!UICONTROL 新規作成]**」をクリックします。 ドロップダウンで、**[!UICONTROL 新規テストグループ]**&#x200B;を選択します。
...
1. 「**[!UICONTROL テストグループアクション]**」ドロップダウンをクリックし、「**[!UICONTROL テストグループを承認]**」を選択します。
   ...
   選択したランディングページの統計情報を比較できるようになりました。

   ![](assets/five.png)

   >[!TIP]
   >
   >テストグループを削除する場合は、**[!UICONTROL テストグループアクション]**&#x200B;をクリックし、**[!UICONTROL テストグループを削除]**&#x200B;を選択します。
