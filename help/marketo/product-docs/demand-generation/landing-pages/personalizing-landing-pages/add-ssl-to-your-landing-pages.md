...
description: Marketo ランディングページにSSLを追加する方法について説明します。 安全なランディングページ URLのHTTPSを有効にします。
...
>[!NOTE]
>
>SSLがREADY状態になるまでに最大3分かかる場合があります。 ページを更新して、変更内容を表示します。

## 既存のドメインのエイリアスへのSSLの編集 {#edit-ssl-existing-domain}

既存のドメインエイリアスのSSLを有効にするには、次の手順に従います。

1. _[!UICONTROL 管理者]_&#x200B;領域から、左側のナビゲーションで&#x200B;**[!UICONTROL 統合]**&#x200B;を展開し、**[!UICONTROL ランディングページ]**&#x200B;を選択します。

1. ページで、上部の「**[!UICONTROL ルール]**」タブを選択します。

1. 編集するドメイン エイリアスの行を選択し、上部の&#x200B;**[!UICONTROL Add SSL]**&#x200B;をクリックします。

   ![管理領域 – 統合/ ランディングページ – ルール タブ – ドメインエイリアスを選択](./assets/admin-landing-pages-rules-add-ssl.png){width="800" zoomable="yes"}
