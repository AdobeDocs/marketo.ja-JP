...
description: Marketo ランディングページにテキストとトークンを追加する方法について説明します。 パーソナライゼーション用に静的テキストと動的トークンを挿入します。
...
ランディングページにテキストを追加する方法を理解したところで、次の節ではトークンの追加について説明します。
...
>[!TIP]
>
>「名」などの値は、個人レコードから取得されます。 その他のトークンは、プログラムの「マイトークン」タブから取得されます。
