...
description: Marketoでフリーフォームのランディングページにソーシャルボタンを追加する方法を説明します。 ページに「共有」ボタンまたは「フォロー」ボタンを追加します。
...
1. **[!UICONTROL ソーシャルボタン（Analytics 使用）]**&#x200B;を選択します。
   ...
   ランディングページがアクティブになると、ソーシャルダッシュボードでソーシャルボタン（Analyticsを使用）によって生成されたアクティビティを表示できます。
...
1. ランディングページ [をFacebook](/help/marketo/product-docs/demand-generation/facebook/publish-landing-pages-to-facebook.md)に公開し、Web サイトにソーシャルボタンを配置します。

ランディングページにソーシャルボタンを追加しました。 準備ができたら、ランディングページを承認しましょう。
