...
description: Marketoでガイドを使用してフリーフォームのランディングページデザインを行う方法について説明します。 要素を整列させ、ガイドとレイアウトの一貫性を保ちます。
...
フリーフォームのランディングページをデザインするときは、ガイドを使用して、ページ上の要素を整列させることができます。
...
1. ガイド線上にオブジェクトをドラッグします。 幅方向で線が二重になったら離すと、オブジェクトがガイド線に沿って配置されます。
   ...
   適切に整列された要素により、よりクリーンでプロフェッショナルなレイアウトが作成されます。
