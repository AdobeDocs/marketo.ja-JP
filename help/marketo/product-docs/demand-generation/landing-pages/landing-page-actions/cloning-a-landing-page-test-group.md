...
description: Marketoでランディングページテストグループを複製する方法について説明します。 テストグループを複製して、類似のテストやバリエーションを実行できます。
...
1. 完了したら、**[!UICONTROL 作成]**&#x200B;をクリックします。

   ![](assets/image2015-4-27-16-3a7-3a50.png)

1. テストグループを起動する準備ができたら、ツリー内のグループを右クリックし、**[!UICONTROL テストグループを承認]**&#x200B;を選択します。
