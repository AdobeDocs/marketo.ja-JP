...
description: テンプレート 10C ガイド付きランディングページテンプレートについて説明します。 ダウンロードして、Marketoランディングページでご利用ください。
title: テンプレート 10C
...
[&#x200B; ダウンロードテンプレート 10C](https://51837-micrositemarketo.adobeio-static.net/lp-templates/template-10c.html)を右クリックし、**リンクを別名で保存…**&#x200B;を選択します
...
* プライマリセクション
  ...
  * ヒーローヘッダー、ヒーローテキスト、ヒーロービデオが含まれます
