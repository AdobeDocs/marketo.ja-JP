...
description: テンプレート10-D -Marketoドキュメント — 製品ドキュメント
title: テンプレート10-D
...
# テンプレート10-D {#template-d}

[テンプレート10-Dをダウンロード](https://docs.marketo.com/download/attachments/8784008/template-10d.html?version=2&amp;modificationdate=1438210947000&amp;api=v2)
...
* 主なセクション
   ...
   * ヒーローヘッダー、ヒーローテキストおよびヒーローポールが含まれます。
