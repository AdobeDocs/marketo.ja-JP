...
# 既存のフリーフォームランディングページテンプレートの[!UICONTROL モバイルとの互換性]の確保 {#make-an-existing-free-form-landing-page-template-mobile-compatible}
...
テンプレートに変更を加える場合は、「[!UICONTROL テンプレートアクション]」をクリックし、「[!UICONTROL モバイルの互換性を検証]」を選択します。
