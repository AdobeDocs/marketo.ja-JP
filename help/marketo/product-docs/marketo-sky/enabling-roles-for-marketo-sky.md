...
description: Marketo Sky の役割を有効にする - Marketo ドキュメント - 製品ドキュメント
title: Marketo Sky の役割を有効にする
hide: true
hidefromtoc: true
...
# Marketo Sky の役割を有効にする {#enabling-roles-for-marketo-sky}

Marketo Sky を利用するには、目的のユーザーの役割を有効にする必要があります。
...
選択した役割は Marketo Sky を使用できるようになります。
