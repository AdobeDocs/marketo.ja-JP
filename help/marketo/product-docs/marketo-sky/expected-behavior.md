---
description: Marketo Skyの予測オーディエンスの期待される動作について説明します。 データプライバシー、アクティベーションのタイミング、フィルターの制限を把握します。
title: 予想される動作
hide: true
...
* AI/マシンラーニングモデルでは、氏名、性別、電子メール、連絡先番号などの特定のリード情報を使用していません。モデルでは、ファーモグラフィックとアクティビティログから得られる一般的な属性のみを使用します。
