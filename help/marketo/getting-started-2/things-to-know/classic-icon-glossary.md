...
以下は、Marketo Classic インターフェイスの古いアイコンです。 現在のアイコンの用語集は次のとおりです。 [こちらにあります](/help/marketo/getting-started-2/things-to-know/icon-glossary.md){target="_blank"}.
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td>別のワークスペースと共有したソースフォルダー</td> 
  </tr> 
  <tr> 
   <td><img width="25" src="assets/share-from.png"> 
    </td> 
   <td>別のワークスペースから共有された宛先フォルダー<br>（南京錠アイコンは編集できないことを示します）</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td>成功しました。 （「プログラムの成功」、「成功した実行」、「アクティブ」として頻繁に表示）</td> 
  </tr> 
  <tr> 
