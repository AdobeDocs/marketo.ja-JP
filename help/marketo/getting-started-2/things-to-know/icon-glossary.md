...
# Marketo Engageアイコンの用語 {#icon-glossary}

以下は、現在のAdobe Marketo Engage インターフェイスのアイコンです。 Marketo Classic アイコンを参照する必要がある場合は、[こちら](/help/marketo/getting-started-2/things-to-know/classic-icon-glossary.md)をご覧ください。
