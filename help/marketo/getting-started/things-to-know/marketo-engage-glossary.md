...
<table>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td colspan="1">Adobe Marketo Engageと他のAdobe Experience Cloud アプリケーション（Adobe Experience Platformなど）間でオーディエンスセグメントを同期し、Adobeのエコシステム全体で一貫性のあるオーディエンスターゲティングを可能にする機能。</td>
  </tr>
 </tbody>
</table>
