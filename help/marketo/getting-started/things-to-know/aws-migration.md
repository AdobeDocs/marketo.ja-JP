...
最新情報は、このページをブックマークしてください。 移行の開始時および完了時にステータスの更新を受け取るには、[それを受け取るには](https://experienceleague.adobe.com/en/docs/marketo/using/getting-started/things-to-know/system-status-notifications){target="_blank"}を購読する必要があります。 https://status.adobe.com/にアクセスすることもできます。
