...
ステータスの更新については、移行の開始時および完了時に[購読して受信することができます](https://experienceleague.adobe.com/en/docs/marketo/using/getting-started/things-to-know/system-status-notifications){target="_blank"}。 移行期間中に[https://status.adobe.com/](https://status.adobe.com/ja){target="_blank"}にアクセスすることもできます。
