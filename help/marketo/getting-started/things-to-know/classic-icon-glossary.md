...
以下は、Marketo Classic インターフェイスの古いアイコンです。 現在のアイコンの用語集は [ こちら ](/help/marketo/getting-started/things-to-know/icon-glossary.md){target="_blank"} にあります。
