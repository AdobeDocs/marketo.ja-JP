...
1. 「 **名前**」を入力し、使用する **テンプレート** (Template **)を選択して、「**&#x200B;作成」をクリックします。
   ...
   >[!NOTE]
   >
   >電子メールエディターが表示されない場合 ブラウザーがウィンドウをブロックした可能性があります。 ブラウザーで [app.marketo.comのポップアップを有効にし](http://app.marketo.com) 、上部のメニューバーで「ドラフト **を編集** 」をクリックします。
...
1. 指定した日時に電子メールを受信します。
   ...
   >
   >
   >エン [ゲージメントプログラムの詳細](http://docs.marketo.com/display/docs/drip+nurturing)。

<br> 

[エンジン5:Leads](import-a-list-of-people.md) [Mission 7のリストのインポート：電子メールのパーソナライズ…](personalize-an-email.md)