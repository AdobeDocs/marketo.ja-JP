...
次に、作成したメールを使用して、エンゲージメントプログラムのコンテンツストリームを作成します。
...
1. 目的のスケジュールに合わせて設定を編集し、「**[!UICONTROL 保存]**」をクリックします。
   ...
   >[!NOTE]
   >
   >テストパーソンとは、顧客に送信する前にエンゲージメントプログラムが正しいことをテストするために、プログラムをチェックする人のことです。
...
[◄ ミッション 5: ユーザーのリストをインポートします](/help/marketo/getting-started/quick-wins/import-a-list-of-people.md)
