...
1. ページ&#x200B;**[!UICONTROL 名]**&#x200B;を入力し、テンプレートを選択して、「**[!UICONTROL 作成]**」をクリックします。
   ...
   >[!NOTE]
   >
   >スクリーンショットとは異なるテンプレートがある場合がありますが、大丈夫です。1つを選んで続行してください。
...
[◄ ミッション 1：電子メールの一斉送信](/help/marketo/getting-started/quick-wins/send-an-email.md)

[ミッション 3: シンプル スコアリング ►](/help/marketo/getting-started/quick-wins/simple-scoring.md)
