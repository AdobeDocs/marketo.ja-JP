---
description: 新しいMarketo Engage インスタンスの「マーケティングアクティビティ」セクションを設定します。
...
<tbody>
  <tr>
    <td>プログラムタイプ</td>
    <td><li><a href="https://experienceleague.adobe.com/ja/docs/marketo/using/product-docs/core-marketo-concepts/programs/creating-programs/understanding-programs" target="_blank">4種類のプログラムを理解する</a>。</li>
    ...
    <li>イベントプログラムを使用して、組み込みのウェビナープラットフォームである<a href="https://experienceleague.adobe.com/ja/docs/marketo/using/product-docs/demand-generation/events/interactive-webinars/create-an-interactive-webinar" target="_blank"> インタラクティブウェビナー</a>を作成し、ルームを<a href="https://experienceleague.adobe.com/ja/docs/marketo/using/product-docs/demand-generation/events/interactive-webinars/designing-interactive-webinars"> インタラクティブウェビナー</a> プログラムに関連付けます。</li>
  ...
  <tr>
    ...
    <li>グローバルフォームを使用するには、スマートキャンペーンを使用してレポート用の新規顧客獲得プログラムを設定し、リファラーの詳細を使用してユーザをプログラム／キャンペーンに適切に割り当てます。</li></td>
  </tr>
  <tr>
    <td>スマートリスト購読</td>
    <td><li>マーケティング活動またはデータベースで<a href="https://experienceleague.adobe.com/docs/marketo/using/product-docs/reporting/basic-reporting/report-subscriptions/edit-a-smart-list-subscription.html?lang=ja" target="_blank"> スマートリストのサブスクリプション </a>を設定して、毎日、毎週、または毎月（メールのパフォーマンス、人物のパフォーマンスなど）受信するレポートを設定します。</li></td>
  </tr>
  <tr>
    <td>レポート購読の管理</td>
    <td><li><a href="https://experienceleague.adobe.com/docs/marketo/using/product-docs/reporting/basic-reporting/report-subscriptions/manage-report-subscriptions.html?lang=ja" target="_blank"> マーケティングアクティビティまたはAnalyticsのレポートサブスクリプション </a>を<a href="https://experienceleague.adobe.com/docs/marketo/using/product-docs/reporting/basic-reporting/report-subscriptions/subscribe-to-a-basic-report.html?lang=ja" target="_blank">基本レポート </a>または<a href="https://experienceleague.adobe.com/docs/marketo/using/product-docs/reporting/revenue-cycle-analytics/revenue-explorer/subscribe-to-a-revenue-explorer-report.html?lang=ja" target="_blank">収益サイクルエクスプローラーレポート </a>に設定します。</li></td>
  </tr>
</tbody>
</table>
...
<tbody>
  ...
  <tr>
    ...
    <td><li>プログラムを作成して、<a href="https://business.adobe.com/resources/ebooks/the-gdpr-and-the-marketer.html" target="_blank">GDPR、CASL、CAN-SPAM、CCPAなどのデータプライバシーおよびスパム法に準拠するようにします。</a></li>
    <p><img src="assets/note-icon.png" alt="メモアイコン"> 注：これらの問題については、常に法務部門に相談することを忘れないでください。 変更を行う前に、コンプライアンスを維持するためのこれまでの取り組みについてチームに確認してください。</td>
  </tr>
  <tr>
    <td>ライフサイクル</td>
  ...
  <tr>
    ...
    <td><li>Marketo セールスインサイトアプリを通じて<a href="https://experienceleague.adobe.com/docs/marketo/using/product-docs/marketo-sales-insight/msi-for-salesforce/features/tabs-in-the-msi-panel/interesting-moments/using-interesting-moments.html?lang=ja#how-do-i-create-an-interesting-moment" target="_blank">関連情報をセールスチームに伝える</a>一元的なスマートキャンペーンを作成します。</li></td>
  </tr>
  <tr>
    <td>購読センター</td>
    <td><li><a href="https://experienceleague.adobe.com/docs/marketo-learn/tutorials/lead-and-data-management/subscription-center-learn.html?lang=ja" target="_blank"> サブスクリプション/プリファレンスセンター</a>を設定するメリットについて説明します。</li>
    <p><img src="assets/tip-icon.png" alt="ヒントアイコン">ヒント：これを設定する方法は1つないため、<a href="https://nation.marketo.com/" target="_blank">Marketing Nation Community</a>にアクセスし、「サブスクリプションセンター」を検索して、同業者が使用しているさまざまな方法を確認し、ニーズに最適なものを選択することをお勧めします。</td></td>
  </tr>
  <tr>
    <td>メール配信品質</td>
