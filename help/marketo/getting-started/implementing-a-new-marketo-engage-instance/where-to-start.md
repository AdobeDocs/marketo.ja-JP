---
description: 新しいMarketo Engage インスタンスを実装する際のベストプラクティスについて説明します。 パフォーマンスを追跡することで、Marketo Engageを最大限に活用し、インスタンスを長期的な健全性と効率性を維持できます。 新しいインスタンスを操作する新しい管理者は、これらのガイドを使用して集中力を維持し、整理してください。
title: 開始する場所
...
以下のベストプラクティスチェックリストを確認する前に、「初期設定」セクションの手順に従っていることを確認してください。
...
* [マーケティング活動](/help/marketo/getting-started/implementing-a-new-marketo-engage-instance/marketing-activities-checklist.md){target="_blank"}

* [分析](/help/marketo/getting-started/implementing-a-new-marketo-engage-instance/analytics-checklist.md){target="_blank"}

* [新しいインスタンス設定を文書化します](/help/marketo/getting-started/implementing-a-new-marketo-engage-instance/document-your-setup.md){target="_blank"}

## 仲間とつながる {#connect-with-your-peers}

[Adobe Marketo Engage Community](https://nation.marketo.com/){target="_blank"} （Marketing Nationとも呼ばれます）にアクセスして、Marketo Engageの従業員や他のユーザーからMarketo Engage インスタンスについて詳しく確認してください。

コミュニティで始める：

1. 「**[!UICONTROL AdobeIDで続行]**」をクリックし、ログインページでプライマリサブスクリプションを選択します。
1. サインインしたら、コミュニティプロファイルを完了します。
1. 情報を送信した後、コミュニティホームページにアクセスし、行ってみてください！
