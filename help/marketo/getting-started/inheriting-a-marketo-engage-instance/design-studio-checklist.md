...
<p><img src="assets/tip-icon.png" alt="ヒントアイコン">ヒント：オープンテキストフィールドの場合は、データが乱雑にならないように、選択リストに切り替えることを検討してください。</td>
  ...
  <tr>
   <td>プライバシーとコンプライアンス</td>
   <td><li>フォームの戦略は、企業のデータプライバシーやオプトイン要件に適合していますか？
...
<table style="table-layout:auto">
 <tbody>
  ...
  <tr>
   <td>プライバシーとコンプライアンス</td>
   <td><li>すべてのメールに適切なフッターがありますか？ コンプライアンスへの影響として、GDPR、CASL、CAN-SPAM、CCPAなどを検討します。</li>
...
<table style="table-layout:auto">
 <tbody>
  ...
  <tr>
   ...
   <p><img src="assets/note-icon.png" alt="メモアイコン"> 注意：あるWorkspaceで行われたアクションによって、別のユーザーが別のWorkspaceでアクセスできないアセットが発生する可能性があるので、この点を把握しておくことが重要です。</td>
  </tr>
 </tbody>
</table>
